...
(CL:DEFVAR SYM-SOAP-SERVER-PLSOAP-QUERY-PATTERN STELLA::NULL)
...
(CL:DEFCLASS |retrieval| (SOAP-COMMAND)
  ((NRESULTS :ALLOCATION :INSTANCE :ACCESSOR %NRESULTS)
   (QUERY-PATTERN :ALLOCATION :INSTANCE :ACCESSOR %QUERY-PATTERN)
   (STELLA::OPTIONS :ALLOCATION :INSTANCE :ACCESSOR STELLA::%OPTIONS)))
...
(CL:DEFUN |new-retrieval| ()
  (CL:LET* ((SELF STELLA::NULL))
   ...
   (CL:SETF (STELLA::|%textContent| SELF) STELLA::NULL-STRING)
   (CL:SETF (STELLA::%OPTIONS SELF) STELLA::NULL)
   (CL:SETF (%QUERY-PATTERN SELF) STELLA::NULL)
...
(CL:DEFUN |access-retrieval-Slot-Value| (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-SOAP-SERVER-PLSOAP-QUERY-PATTERN)
    (CL:IF SETVALUE? (CL:SETF (%QUERY-PATTERN SELF) VALUE)
     (CL:SETQ VALUE (%QUERY-PATTERN SELF))))
   ((CL:EQ SLOTNAME SYM-SOAP-SERVER-STELLA-OPTIONS)
    (CL:IF SETVALUE? (CL:SETF (STELLA::%OPTIONS SELF) VALUE)
     (CL:SETQ VALUE (STELLA::%OPTIONS SELF))))
   (CL:T
        ...
        (CL:PROGN
         (CL:LET*
          ((N-RESULTS (SAFE-GET-CONTENT (%NRESULTS COMMAND-FORM)))
           (QUERY-PATTERN
            (SAFE-GET-CONTENT (%QUERY-PATTERN COMMAND-FORM)))
           (QUERY-OPTIONS
            (SAFE-GET-CONTENT (STELLA::%OPTIONS COMMAND-FORM)))
           (BASE-QUERY-STRING (SAFE-GET-CONTENT COMMAND-FORM))
          ...
          (CL:WHEN
           ...
           (CL:SETQ QUERY-STRING
            (STELLA::CONCATENATE QUERY-STRING " " QUERY-OPTIONS)))
          (CL:LET*
           ((STELLA::*MODULE* STELLA::NULL)
            (STELLA::*CONTEXT* STELLA::NULL))
           (CL:DECLARE (CL:SPECIAL STELLA::*MODULE* STELLA::*CONTEXT*))
           (CL:LET*
            ((TEMP-000 (PLI::GET-MODULE MODULE-NAME STELLA::NULL)))
...
(CL:DEFUN SOAP-ENCODE-RETRIEVAL-ANSWER (QUERY-STRING ITER)
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:SETF (%QUERY-PATTERN RESULT) QUERY-PATTERN)
...
(CL:DEFUN HELP-STARTUP-SOAP-SERVER1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-SOAP-SERVER-PLSOAP-QUERY-PATTERN
    (STELLA::INTERN-RIGID-SYMBOL-WRT-MODULE "QUERY-PATTERN"
     STELLA::NULL 0))
...
not actually be realized in surface syntax.\" :PUBLIC-SLOTS ((TARGET-MODULE :TYPE |module|)))")))
    ...
    (CL:LET*
     ((CLASS
       (STELLA::DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "retrieval"
        "(DEFCLASS |retrieval| (SOAP-COMMAND) :PUBLIC-SLOTS ((TARGET-MODULE :TYPE |module|) (NRESULTS :TYPE |nresults|) (QUERY-PATTERN :TYPE |pattern|) (OPTIONS :TYPE |options|)))")))
     (CL:SETF (STELLA::%CLASS-CONSTRUCTOR-CODE CLASS)
    ...
    (CL:LET*
     ((CLASS
       (STELLA::DEFINE-CLASS-FROM-STRINGIFIED-SOURCE "tuples"
        "(DEFCLASS |tuples| (|XMLObject|) :PUBLIC-SLOTS ((NRESULTS :TYPE |nresults|) (QUERY :TYPE |query|) (QUERY-PATTERN :TYPE |pattern|) (TUPLE :TYPE (LIST OF |tuple|))))")))
     (CL:SETF (STELLA::%CLASS-CONSTRUCTOR-CODE CLASS)
   ...
   (CL:WHEN (STELLA::CURRENT-STARTUP-TIME-PHASE? 9)
    ...
    (STELLA::DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *SOAP-READ-ONLY?* BOOLEAN FALSE)" STELLA::NULL)
