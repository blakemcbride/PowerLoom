    ...
    (CL:UNWIND-PROTECT
     (CL:PROGN (CL:SETQ STREAM (OPEN-OUTPUT-FILE FILE))
      (%%PRINT-STREAM (%NATIVE-STREAM STREAM) EOL
       "Explanation #1 score=" (%MATCH-SCORE JUSTIFICATION) ":" EOL
       EOL)
...
(CL:DEFUN GET-JUSTIFICATION-STRING (JUSTIFICATION)
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:WHEN (CL:NOT (CL:= (%MATCH-SCORE JUSTIFICATION) NULL-FLOAT))
...
(CL:DEFUN STARTUP-EXPLANATIONS ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
    ...
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *PLGUI-EXPLANATION-TRACE-FILE* STRING NULL)" NULL))))
