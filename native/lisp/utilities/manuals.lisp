...
:INFIX-PARAMETER-LISTS.\")" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *TEXINFO-WORD-DELIMITERS* STRING NULL)" NULL)
    (CL:LET*
     ((DELIMITERS
     ...
     (CL:SETQ *TEXINFO-WORD-DELIMITERS*
      (CL:LET ((S DELIMITERS))
       ...
       (CL:THE CL:SIMPLE-STRING S))))
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFSPECIAL *MANUAL-OUTPUT-LANGUAGE* KEYWORD :TEXINFO)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *DOCUMENTED-OBJECTS-REGISTRY* HASH-TABLE (NEW HASH-TABLE))"
     NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFSPECIAL *MANUAL-OUTPUT-STREAM* OUTPUT-STREAM NULL)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *MANUAL-TEMPLATE-COMMAND-PREFIX* STRING \"#$\")" NULL)
