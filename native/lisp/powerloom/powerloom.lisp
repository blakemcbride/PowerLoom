...
(CL:DEFVAR KWD-POWERLOOM-ROOT-DIRECTORY NULL)
...
(CL:DEFUN STARTUP-POWERLOOM ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
    ...
    (CL:SETQ KWD-POWERLOOM-ROOT-DIRECTORY
...
dynamically (not yet in C++).\" :PUBLIC? TRUE)" NULL)
  ...
  Evaluate the STELLA <s-expression> in the PL-USER module.")
     ...
     KWD-POWERLOOM-ERROR-ACTION KWD-POWERLOOM-WARN)
    (CL:WHEN
     (CL:NOT (CL:EQ (GET-SYSTEM-DEFINITION "powerloom" CL:NIL) NULL))
     (%DEFINE-LOGICAL-HOST-PROPERTY "PL" KWD-POWERLOOM-ROOT-DIRECTORY
      (WRAP-STRING
       (FIND-SYSTEM-ROOT-DIRECTORY
        (GET-SYSTEM-DEFINITION "powerloom" CL:T))))))))
