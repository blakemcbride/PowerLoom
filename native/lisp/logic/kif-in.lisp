...
(CL:DEFVAR SYM-KIF-IN-PL-KERNEL-KB-SETOF NULL)
(CL:DEFVAR SYM-KIF-IN-PL-KERNEL-KB-LISTOF NULL)
...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* NIL EOL NULL-CHARACTER))

;;; (DEFUN (SYMBOL-TYPE-CHARACTER CHARACTER) ...)

(CL:DEFUN SYMBOL-TYPE-CHARACTER (SYMBOL)
  (CL:COND
   ((SUBTYPE-OF-SYMBOL? (SAFE-PRIMARY-TYPE SYMBOL))
    (CL:PROGN
     (CL:LET* ((NAME (%SYMBOL-NAME SYMBOL)))
      (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING NAME))
      (CL:WHEN (CL:NOT (STRING-EQL? NAME ""))
       (CL:RETURN-FROM SYMBOL-TYPE-CHARACTER
...
(CL:DEFUN QUESTION-MARK-SYMBOL? (SYMBOL)
  (CL:EQL (SYMBOL-TYPE-CHARACTER SYMBOL) #\?))
...
(CL:DEFUN AUTOMATIC-INSTANCE-SYMBOL? (SYMBOL)
  (CL:EQL (SYMBOL-TYPE-CHARACTER SYMBOL) *AUTOMATIC-INSTANCE-CHARACTER*))
        ...
        ((TERM-KIF-SPECIAL-FORM? OPERATOR)
         (CL:LET* ((TEST-VALUE-000 OPERATOR))
          (CL:COND
           ...
           ((CL:OR (CL:EQ TEST-VALUE-000 SYM-KIF-IN-PL-KERNEL-KB-SETOF)
             (CL:EQ TEST-VALUE-000 SYM-KIF-IN-PL-KERNEL-KB-LISTOF))
            (CHANGE-KIF-EXPRESSIONS-TO-STELLA-EXPRESSIONS (%%REST TREE)
             CL:T)
            TREE)
           (CL:T
  ...
  (CL:PROGN
   ...
   (CL:SETQ SYM-KIF-IN-STELLA-COND
    (INTERN-RIGID-SYMBOL-WRT-MODULE "COND"
     (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-KIF-IN-PL-KERNEL-KB-SETOF
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SETOF"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 0))
   (CL:SETQ SYM-KIF-IN-PL-KERNEL-KB-LISTOF
...
(CL:DEFUN STARTUP-KIF-IN ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
    (DEFINE-FUNCTION-OBJECT "SYMBOL-TYPE-CHARACTER"
     "(DEFUN (SYMBOL-TYPE-CHARACTER CHARACTER) ((SYMBOL OBJECT)))"
     (CL:FUNCTION SYMBOL-TYPE-CHARACTER) NULL)
