...
(CL:DEFUN LEARN-ONE-RULE-BOTTOM-UP (POSITIVE NEGATIVE)
  (CL:LET*
   ...
   (CL:LOOP WHILE (NON-EMPTY? POSITIVE) DO
      ...
      (CL:WHEN (CL:NOT (RULE-COVERS-ANY-EXAMPLE? LGG NEGATIVE))
       ...
       (CL:WHEN (CL:> SCORE MAX)
        ...
        (CL:WHEN (CL:>= (CL:+ COVER SCORE) NUM-POSITIVE)
         (CL:SETQ LGG
          (SIMPLIFY-ANTECEDENT LGG
           (GET-QUOTED-TREE "((?Y) \"/LOGIC\")" "/LOGIC") POSITIVE
           NEGATIVE))
    ...
    (CL:SETQ BEST-LGG
     (SIMPLIFY-ANTECEDENT BEST-LGG
      (GET-QUOTED-TREE "((?Y) \"/LOGIC\")" "/LOGIC") POSITIVE
      NEGATIVE))
    (CL:SETQ RULE BEST-LGG)
    (CL:WHEN (CL:OR (CL:= MAX 0) (CL:EQ RULE NIL)) (CL:RETURN)))
  ...
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
    ...
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *RULE-INDUCTION-STRATEGY* KEYWORD :TOP-DOWN :DEMON-PROPERTY \"powerloom.learning.ruleInductionStrategy\" :PUBLIC? TRUE)"
     NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *SIGNATURE-STRATEGY* KEYWORD :TOP-DOWN :DEMON-PROPERTY \"powerloom.learning.ruleInductionSignatureStrategy\" :PUBLIC? TRUE)"
     NULL)
    ...
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *ENABLE-USER-THING* BOOLEAN TRUE)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *OPTIMIZE-INDUCED-QUERIES* BOOLEAN TRUE)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
...
TRUE if we want to have final rules as general as possible.\" :PUBLIC? TRUE)"
     NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *TRACE-ID3* BOOLEAN FALSE)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *TRACE-FOIL* BOOLEAN FALSE)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *INDUCE-RULES-FROM-SIGNATURES* BOOLEAN TRUE :DEMON-PROPERTY \"powerloom.learning.induceRulesFromSignatures\" :PUBLIC? TRUE)"
     NULL)
    (REGISTER-NATIVE-NAME SYM-RULE-INDUCTION-LOGIC-SET-SIGNATURE-RULES
     KWD-RULE-INDUCTION-COMMON-LISP KWD-RULE-INDUCTION-FUNCTION)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *NUM-LGGS* INTEGER 2000)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *ENFORCE-LINKED-VARIABLES* BOOLEAN FALSE)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *LOG-INDUCED-RULES* BOOLEAN FALSE)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *ALLOW-RECURSIVE-DECISION-NODES* BOOLEAN TRUE)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *LOG-DECISION-RULE-CONSTRUCTION* BOOLEAN FALSE)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT "(DEFGLOBAL LOG_2 FLOAT 0.6931472)"
     NULL)
    (REGISTER-NATIVE-NAME
    ...
    (REGISTER-NATIVE-NAME
     ...
     KWD-RULE-INDUCTION-COMMON-LISP KWD-RULE-INDUCTION-FUNCTION)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *INDUCED-DECISION-RULES* (LIST OF CONS) NULL)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *INDUCED-RULE-COUNTER* INTEGER 0)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *CANDIDATE-CLAUSES* (VECTOR OF CONS) NULL)" NULL)
    (REGISTER-NATIVE-NAME
    ...
    (REGISTER-NATIVE-NAME
     ...
     KWD-RULE-INDUCTION-COMMON-LISP KWD-RULE-INDUCTION-FUNCTION)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFSPECIAL *BOTTOM-UP-VARIABLE-COUNTER* INTEGER -1)" NULL)
    (REGISTER-NATIVE-NAME
