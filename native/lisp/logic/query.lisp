...
(CL:DEFVAR SGT-QUERY-LOGIC-ASSERTED-COLLECTION-MEMBERS-ITERATOR NULL)
(CL:DEFVAR SYM-QUERY-STELLA-COLLECTION NULL)
(CL:DEFVAR SYM-QUERY-LOGIC-SPECIALIZE? NULL)
(CL:DEFVAR SYM-QUERY-LOGIC-KIND NULL)
(CL:DEFVAR SYM-QUERY-STELLA-BASE-ITERATOR NULL)
(CL:DEFVAR SYM-QUERY-LOGIC-NESTED-BASE-ITERATOR NULL)
(CL:DEFVAR SYM-QUERY-LOGIC-OBSERVED-CARDINALITY NULL)
(CL:DEFVAR SGT-QUERY-LOGIC-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS-ITERATOR NULL)
(CL:DEFVAR SYM-QUERY-LOGIC-MEMBER NULL)
(CL:DEFVAR SGT-QUERY-PL-KERNEL-KB-COLLECTIONOF NULL)
(CL:DEFVAR KWD-QUERY-COLLECTION NULL)
(CL:DEFVAR KWD-QUERY-NAMED-DESCRIPTION NULL)
(CL:DEFVAR KWD-QUERY-ENUMERATION NULL)
(CL:DEFVAR KWD-QUERY-SKOLEM NULL)
(CL:DEFVAR SGT-QUERY-PL-KERNEL-KB-MEMBER-OF NULL)
(CL:DEFVAR KWD-QUERY-LOGIC-OBJECT NULL)
(CL:DEFVAR SGT-QUERY-STELLA-COLLECTION NULL)
(CL:DEFVAR SGT-QUERY-LOGIC-SKOLEM NULL)
(CL:DEFVAR KWD-QUERY-UNDEFINED NULL)
(CL:DEFVAR SGT-QUERY-LOGIC-F-ALL-ASSERTED-COLLECTION-MEMBERS.NEXT?-MEMO-TABLE-000 NULL)
...
(CL:DEFVAR KWD-QUERY-VALUE-FORMAT NULL)
(CL:DEFVAR KWD-QUERY-READABLE NULL)
(CL:DEFVAR KWD-QUERY-BARE NULL)
...
(CL:DEFVAR KWD-QUERY-PRINT NULL)
(CL:DEFVAR KWD-QUERY-SUMMARY NULL)
(CL:DEFVAR KWD-QUERY-ASSERT-TRUE NULL)
(CL:DEFVAR KWD-QUERY-STATISTICS NULL)
(CL:DEFVAR KWD-QUERY-STATS NULL)
...
(CL:DEFVAR KWD-QUERY-RESULT NULL)
(CL:DEFVAR SGT-QUERY-STELLA-KEYWORD NULL)
...
(CL:DECLAIM
  ...
  *MOST-RECENT-QUERY* FALSE-TRUTH-VALUE INCONSISTENT-TRUTH-VALUE
  *PRINTLENGTH* *POWERLOOM-KB-FILE-EXTENSIONS* *PRINTREADABLY?*
  *DEBUG-PRINT-MODE?* NULL-STRING-WRAPPER TRUE-PROPOSITION
...
;;; (DEFCLASS ASSERTED-COLLECTION-MEMBERS-ITERATOR ...)

(CL:DEFCLASS ASSERTED-COLLECTION-MEMBERS-ITERATOR (ITERATOR)
  ((COLLECTION :ALLOCATION :INSTANCE :ACCESSOR %COLLECTION)
   (SPECIALIZE? :ALLOCATION :INSTANCE :ACCESSOR %SPECIALIZE?)
   (KIND :ALLOCATION :INSTANCE :ACCESSOR %KIND)
   (BASE-ITERATOR :ALLOCATION :INSTANCE :ACCESSOR %BASE-ITERATOR)
   (NESTED-BASE-ITERATOR :ALLOCATION :INSTANCE :ACCESSOR
    %NESTED-BASE-ITERATOR)
   (PROPOSITION :ALLOCATION :INSTANCE :ACCESSOR %PROPOSITION)
   (OBSERVED-CARDINALITY :TYPE CL:FIXNUM :INITFORM NULL-INTEGER
    :ALLOCATION :INSTANCE :ACCESSOR %OBSERVED-CARDINALITY))
  (:DOCUMENTATION
...
(CL:DEFUN NEW-ASSERTED-COLLECTION-MEMBERS-ITERATOR ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-INSTANCE (CL:QUOTE ASSERTED-COLLECTION-MEMBERS-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL)
   (CL:SETF (%OBSERVED-CARDINALITY SELF) 0)
   (CL:SETF (%PROPOSITION SELF) NULL)
   (CL:SETF (%NESTED-BASE-ITERATOR SELF) NULL)
   (CL:SETF (%BASE-ITERATOR SELF) NULL) (CL:SETF (%KIND SELF) NULL)
   (CL:SETF (%SPECIALIZE? SELF) CL:NIL)
   (CL:SETF (%COLLECTION SELF) NULL) SELF))

(CL:DEFMETHOD PRIMARY-TYPE ((SELF ASSERTED-COLLECTION-MEMBERS-ITERATOR))
  SGT-QUERY-LOGIC-ASSERTED-COLLECTION-MEMBERS-ITERATOR)

(CL:DEFUN ACCESS-ASSERTED-COLLECTION-MEMBERS-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-QUERY-STELLA-COLLECTION)
    (CL:IF SETVALUE? (CL:SETF (%COLLECTION SELF) VALUE)
     (CL:SETQ VALUE (%COLLECTION SELF))))
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-SPECIALIZE?)
    (CL:IF SETVALUE?
     (CL:SETF (%SPECIALIZE? SELF)
      (COERCE-WRAPPED-BOOLEAN-TO-BOOLEAN VALUE))
     (CL:SETQ VALUE
      (CL:IF (%SPECIALIZE? SELF) TRUE-WRAPPER FALSE-WRAPPER))))
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-KIND)
    (CL:IF SETVALUE? (CL:SETF (%KIND SELF) VALUE)
     (CL:SETQ VALUE (%KIND SELF))))
   ((CL:EQ SLOTNAME SYM-QUERY-STELLA-BASE-ITERATOR)
    (CL:IF SETVALUE? (CL:SETF (%BASE-ITERATOR SELF) VALUE)
     (CL:SETQ VALUE (%BASE-ITERATOR SELF))))
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-NESTED-BASE-ITERATOR)
    (CL:IF SETVALUE? (CL:SETF (%NESTED-BASE-ITERATOR SELF) VALUE)
     (CL:SETQ VALUE (%NESTED-BASE-ITERATOR SELF))))
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-PROPOSITION)
    (CL:IF SETVALUE? (CL:SETF (%PROPOSITION SELF) VALUE)
     (CL:SETQ VALUE (%PROPOSITION SELF))))
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-OBSERVED-CARDINALITY)
    (CL:IF SETVALUE?
     (CL:SETF (%OBSERVED-CARDINALITY SELF) (%WRAPPER-VALUE VALUE))
     (CL:SETQ VALUE (WRAP-INTEGER (%OBSERVED-CARDINALITY SELF)))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME
      "' is not a valid case option")
...
;;; (DEFCLASS ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS-ITERATOR ...)

(CL:DEFCLASS ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS-ITERATOR (ASSERTED-COLLECTION-MEMBERS-ITERATOR)
  ((MEMBER :ALLOCATION :INSTANCE :ACCESSOR %MEMBER))
  (:DOCUMENTATION "Iterator reimplementation of `member-of-collection?'.
...
(CL:DEFUN NEW-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS-ITERATOR ()
  (CL:LET* ((SELF NULL))
   (CL:SETQ SELF
    (CL:MAKE-INSTANCE
     (CL:QUOTE ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS-ITERATOR)))
   (CL:SETF (%FIRST-ITERATION? SELF) CL:T) (CL:SETF (%VALUE SELF) NULL)
   (CL:SETF (%OBSERVED-CARDINALITY SELF) 0)
   (CL:SETF (%PROPOSITION SELF) NULL)
   (CL:SETF (%NESTED-BASE-ITERATOR SELF) NULL)
   (CL:SETF (%BASE-ITERATOR SELF) NULL) (CL:SETF (%KIND SELF) NULL)
   (CL:SETF (%SPECIALIZE? SELF) CL:NIL)
   (CL:SETF (%COLLECTION SELF) NULL) (CL:SETF (%MEMBER SELF) NULL) SELF))

(CL:DEFMETHOD PRIMARY-TYPE ((SELF ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS-ITERATOR))
  SGT-QUERY-LOGIC-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS-ITERATOR)

(CL:DEFUN ACCESS-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS-ITERATOR-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ((CL:EQ SLOTNAME SYM-QUERY-LOGIC-MEMBER)
    (CL:IF SETVALUE? (CL:SETF (%MEMBER SELF) VALUE)
     (CL:SETQ VALUE (%MEMBER SELF))))
   (CL:T
    (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
     (%%PRINT-STREAM (%NATIVE-STREAM STREAM-000) "`" SLOTNAME
      "' is not a valid case option")
...
;;; (DEFUN (ALL-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS-ITERATOR) ...)

(CL:DEFUN ALL-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS (MEMBER COLLECTION)
...
supporting proposition and truth value.  We set it up this way to be in mostly equivalent to `asserted-collection-members'."
  (CL:LET*
   ((SELF-000 (NEW-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS-ITERATOR)))
   (CL:SETF (%COLLECTION SELF-000) COLLECTION)
   (CL:SETF (%MEMBER SELF-000) MEMBER)
   (CL:SETF (%SPECIALIZE? SELF-000) CL:T)
       ...
       (CL:PROGN
        (CL:LET* ((FOUND?-000 CL:NIL))
         (CL:LET* ((M NULL) (ITER-000 (ALLOCATE-ITERATOR COLLECTION)))
          (CL:LOOP WHILE (NEXT? ITER-000) DO
           (CL:SETQ M (%VALUE ITER-000))
           (CL:WHEN (EQL? (VALUE-OF M) MEMBER)
            (CL:SETQ FOUND?-000 CL:T) (CL:RETURN))))
         (CL:LET* ((MEMBER? FOUND?-000))
          (CL:WHEN *REVERSEPOLARITY?*
           (CL:SETQ MEMBER? (CL:NOT MEMBER?)))
          (CL:SETF (%KIND ITERATOR) KWD-QUERY-COLLECTION)
          (CL:SETF (%BASE-ITERATOR ITERATOR)
           (ALLOCATE-ITERATOR
            (CL:IF MEMBER? (CONS MEMBER NIL) NIL)))))))
      ((SUBTYPE-OF? TEST-VALUE-000 SGT-QUERY-LOGIC-NAMED-DESCRIPTION)
       (CL:PROGN (CL:SETF (%KIND ITERATOR) KWD-QUERY-NAMED-DESCRIPTION)
        (CL:SETF (%BASE-ITERATOR ITERATOR)
         (ALL-TRUE-DEPENDENT-PROPOSITIONS MEMBER
          (%SURROGATE-VALUE-INVERSE COLLECTION) CL:T))))
      ((SUBTYPE-OF? TEST-VALUE-000 SGT-QUERY-LOGIC-DESCRIPTION)
       (CL:PROGN (CL:SETF (%KIND ITERATOR) KWD-QUERY-DESCRIPTION)))
        ...
        (CL:LET*
         ...
         (CL:COND
          ((CL:NOT (CL:EQ ENUMERATEDCOLLECTIONS NIL))
           (CL:SETF (%KIND ITERATOR) KWD-QUERY-ENUMERATION)
           (CL:SETF (%PROPOSITION ITERATOR)
            (%%VALUE ENUMERATEDCOLLECTIONS))
           (CL:SETF (%BASE-ITERATOR ITERATOR)
            (ALLOCATE-ITERATOR (%%REST ENUMERATEDCOLLECTIONS)))
           (CL:SETF (%NESTED-BASE-ITERATOR ITERATOR)
            (ALLOCATE-ITERATOR (%ARGUMENTS (%PROPOSITION ITERATOR)))))
          (CL:T (CL:SETF (%KIND ITERATOR) KWD-QUERY-SKOLEM)
           (CL:SETF (%BASE-ITERATOR ITERATOR)
            (ALL-TRUE-DEPENDENT-PROPOSITIONS MEMBER
      ...
      ((SUBTYPE-OF? TEST-VALUE-000 SGT-QUERY-LOGIC-LOGIC-OBJECT)
       (CL:PROGN
        (CL:LET*
         ...
         (CL:SETF (%KIND ITERATOR) KWD-QUERY-LOGIC-OBJECT)
         (CL:WHEN (CL:NOT (CL:EQ EQUIVALENTSKOLEM NULL))
          (CL:RETURN-FROM ALL-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS
           (ALL-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS MEMBER
            EQUIVALENTSKOLEM))))))
      (CL:T
       (CL:WARN
        "all-asserted-member-of-collection-supports: unhandled collection type: `~A'"
        COLLECTION)
       (CL:SETF (%KIND ITERATOR) KWD-QUERY-UNDEFINED))))
    ITERATOR)))

;;; (DEFUN (ALL-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS.NEXT? BOOLEAN) ...)

(CL:DEFUN ALL-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS.NEXT? (SELF)
  (CL:LET*
   ((MEMBER (%MEMBER SELF)) (BASEITERATOR (%BASE-ITERATOR SELF)))
   (CL:LET* ((TEST-VALUE-000 (%KIND SELF)))
    (CL:COND
     ((CL:EQ TEST-VALUE-000 KWD-QUERY-COLLECTION)
      (CL:WHEN (NEXT? BASEITERATOR)
       (CL:SETF (%PROPOSITION SELF) TRUE-PROPOSITION)
       (CL:SETF (%VALUE SELF) MEMBER)
       (CL:RETURN-FROM ALL-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS.NEXT?
        CL:T)))
     ((CL:EQ TEST-VALUE-000 KWD-QUERY-NAMED-DESCRIPTION)
      (CL:WHEN (NEXT? BASEITERATOR)
       (CL:SETF (%PROPOSITION SELF) (%VALUE BASEITERATOR))
       (CL:SETF (%VALUE SELF) MEMBER)
       (CL:RETURN-FROM ALL-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS.NEXT?
        CL:T)))
     ((CL:EQ TEST-VALUE-000 KWD-QUERY-ENUMERATION)
      (CL:LET* ((NESTEDBASEITERATOR (%NESTED-BASE-ITERATOR SELF)))
       (CL:LOOP
        (CL:LET* ((ARG NULL) (ITER-000 NESTEDBASEITERATOR))
         (CL:LOOP WHILE (NEXT? ITER-000) DO
           ...
           (CL:AND (EQL? (VALUE-OF ARG) MEMBER)
            (CL:NOT
             (EQL? ARG
              (CL:AREF
               (CL:THE CL:SIMPLE-VECTOR
                (%THE-ARRAY (%ARGUMENTS (%PROPOSITION SELF))))
               (CL:THE CL:FIXNUM
                (CL:1- (LENGTH (%ARGUMENTS (%PROPOSITION SELF)))))))))
           (CL:SETF (%VALUE SELF) MEMBER)
           (CL:COND
            (*REVERSEPOLARITY?* (CL:SETF (%VALUE SELF) NULL)
             (CL:RETURN-FROM
              ALL-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS.NEXT? CL:NIL))
            (CL:T (CL:SETF (%VALUE SELF) MEMBER)
             (CL:RETURN-FROM
              ALL-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS.NEXT?
              CL:T))))))
        (CL:COND
         ((NEXT? BASEITERATOR)
          (CL:SETF (%PROPOSITION SELF) (%VALUE BASEITERATOR))
          (CL:SETQ NESTEDBASEITERATOR
           (ALLOCATE-ITERATOR (%ARGUMENTS (%PROPOSITION SELF))))
          (CL:SETF (%NESTED-BASE-ITERATOR SELF) NESTEDBASEITERATOR))
         (CL:T (CL:RETURN))))
       (CL:WHEN (CL:AND *REVERSEPOLARITY?* (CL:EQ (%VALUE SELF) NULL))
        (CL:SETF (%VALUE SELF) MEMBER)
        (CL:RETURN-FROM
         ALL-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS.NEXT? CL:T))))
     ((CL:EQ TEST-VALUE-000 KWD-QUERY-SKOLEM)
      (CL:LET* ((COLLECTION (%COLLECTION SELF)) (SUBCOLLECTION NULL))
       (CL:LET* ((P NULL) (ITER-001 BASEITERATOR))
        (CL:LOOP WHILE (NEXT? ITER-001) DO
         (CL:SETQ P (%VALUE ITER-001))
         ...
         (CL:WHEN
          ...
          (CL:SETF (%PROPOSITION SELF) P)
          (CL:SETF (%VALUE SELF) MEMBER)
          (CL:RETURN-FROM
           ALL-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS.NEXT? CL:T))))))
     ((CL:OR (CL:EQ TEST-VALUE-000 KWD-QUERY-DESCRIPTION)
       (CL:EQ TEST-VALUE-000 KWD-QUERY-LOGIC-OBJECT)
       (CL:EQ TEST-VALUE-000 KWD-QUERY-UNDEFINED)))
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
...
(CL:DEFMETHOD NEXT? ((SELF ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS-ITERATOR))
  (ALL-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS.NEXT? SELF))

;;; (DEFUN (MEMBER-OF-COLLECTION? BOOLEAN) ...)

(CL:DEFUN MEMBER-OF-COLLECTION? (MEMBER COLLECTION)
  (NEXT? (ALL-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS MEMBER COLLECTION)))

;;; (DEFUN (ALL-ASSERTED-COLLECTION-MEMBERS ASSERTED-COLLECTION-MEMBERS-ITERATOR) ...)

(CL:DEFUN ALL-ASSERTED-COLLECTION-MEMBERS (SELF DIRECT?)
...
of `asserted-collection-members' (which see)."
  (CL:LET* ((SELF-000 (NEW-ASSERTED-COLLECTION-MEMBERS-ITERATOR)))
   (CL:SETF (%COLLECTION SELF-000) SELF)
   (CL:SETF (%SPECIALIZE? SELF-000) (CL:NOT DIRECT?))
   (CL:LET* ((ITERATOR SELF-000))
    (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE SELF)))
     (CL:COND
      ((SUBTYPE-OF? TEST-VALUE-000 SGT-QUERY-STELLA-COLLECTION)
       (CL:PROGN (CL:SETF (%KIND ITERATOR) KWD-QUERY-COLLECTION)
        (CL:SETF (%BASE-ITERATOR ITERATOR) (ALLOCATE-ITERATOR SELF))))
      ((SUBTYPE-OF? TEST-VALUE-000 SGT-QUERY-LOGIC-NAMED-DESCRIPTION)
       (CL:PROGN (CL:SETF (%KIND ITERATOR) KWD-QUERY-NAMED-DESCRIPTION)
        (CL:SETF (%BASE-ITERATOR ITERATOR)
         (ALL-TRUE-EXTENSION-MEMBERS SELF (CL:NOT DIRECT?)))))
      ((SUBTYPE-OF? TEST-VALUE-000 SGT-QUERY-LOGIC-DESCRIPTION)
       (CL:PROGN (CL:SETF (%KIND ITERATOR) KWD-QUERY-DESCRIPTION)))
      ((SUBTYPE-OF? TEST-VALUE-000 SGT-QUERY-LOGIC-SKOLEM)
       (CL:PROGN
      ...
      ((SUBTYPE-OF? TEST-VALUE-000 SGT-QUERY-LOGIC-LOGIC-OBJECT)
       (CL:PROGN
        (CL:LET*
         ...
         (CL:SETF (%KIND ITERATOR) KWD-QUERY-LOGIC-OBJECT)
         (CL:WHEN (CL:NOT (CL:EQ EQUIVALENTSKOLEM NULL))
          (CL:RETURN-FROM ALL-ASSERTED-COLLECTION-MEMBERS
           (ALL-ASSERTED-COLLECTION-MEMBERS EQUIVALENTSKOLEM
            DIRECT?))))))
      (CL:T
       (CL:WARN
        "all-asserted-collection-members: unhandled collection type: `~A'"
        SELF)
       (CL:SETF (%KIND ITERATOR) KWD-QUERY-UNDEFINED))))
    ITERATOR)))

;;; (DEFUN (ALL-ASSERTED-COLLECTION-MEMBERS.NEXT? BOOLEAN) ...)

(CL:DEFUN ALL-ASSERTED-COLLECTION-MEMBERS.NEXT? (SELF)
  (CL:LET* ((BASEITERATOR (%BASE-ITERATOR SELF)))
   (CL:LET* ((TEST-VALUE-000 (%KIND SELF)))
    (CL:COND
     ((CL:EQ TEST-VALUE-000 KWD-QUERY-COLLECTION)
      (CL:WHEN (NEXT? BASEITERATOR)
       (CL:SETF (%PROPOSITION SELF) TRUE-PROPOSITION)
       (CL:SETF (%VALUE SELF) (%VALUE BASEITERATOR))
       (CL:RETURN-FROM ALL-ASSERTED-COLLECTION-MEMBERS.NEXT? CL:T)))
     ((CL:EQ TEST-VALUE-000 KWD-QUERY-NAMED-DESCRIPTION)
      (CL:WHEN (NEXT? BASEITERATOR)
       (CL:SETF (%PROPOSITION SELF) (%VALUE BASEITERATOR))
       (CL:SETF (%VALUE SELF)
        (CL:AREF
         (CL:THE CL:SIMPLE-VECTOR
          (%THE-ARRAY (%ARGUMENTS (%PROPOSITION SELF))))
         0))
       (CL:WHEN (%SPECIALIZE? SELF)
        (CL:SETF (%OBSERVED-CARDINALITY SELF)
         (CL:1+ (%OBSERVED-CARDINALITY SELF))))
       (CL:RETURN-FROM ALL-ASSERTED-COLLECTION-MEMBERS.NEXT? CL:T)))
     ((CL:EQ TEST-VALUE-000 KWD-QUERY-ENUMERATION)
      (CL:LET* ((NESTEDBASEITERATOR (%NESTED-BASE-ITERATOR SELF)))
       (CL:LOOP
        (CL:COND
         ((NEXT? NESTEDBASEITERATOR)
          (CL:WHEN
           (CL:NOT
            (EQL? (%VALUE NESTEDBASEITERATOR)
             (CL:AREF
              (CL:THE CL:SIMPLE-VECTOR
               (%THE-ARRAY (%ARGUMENTS (%PROPOSITION SELF))))
              (CL:THE CL:FIXNUM
               (CL:1- (LENGTH (%ARGUMENTS (%PROPOSITION SELF))))))))
           (CL:SETF (%VALUE SELF) (%VALUE NESTEDBASEITERATOR))
           (CL:RETURN-FROM ALL-ASSERTED-COLLECTION-MEMBERS.NEXT?
            CL:T)))
         ((NEXT? BASEITERATOR)
          (CL:SETF (%PROPOSITION SELF) (%VALUE BASEITERATOR))
          (CL:SETQ NESTEDBASEITERATOR
     ...
     ((CL:EQ TEST-VALUE-000 KWD-QUERY-SKOLEM)
      (CL:LET*
       ((COLLECTION (%COLLECTION SELF))
        (DIRECT? (CL:NOT (%SPECIALIZE? SELF))))
       (CL:LET* ((P NULL) (ITER-000 BASEITERATOR))
        (CL:LOOP WHILE (NEXT? ITER-000) DO
     ...
     (CL:T
      (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
       ...
       (CL:ERROR
        (NEW-STELLA-EXCEPTION (THE-STRING-READER STREAM-000)))))))
   (CL:WHEN
    (CL:AND (CL:EQ (%KIND SELF) KWD-QUERY-NAMED-DESCRIPTION)
     (%SPECIALIZE? SELF))
    (CL:LET*
     ((MEMO-TABLE-000 NULL) (MEMOIZED-ENTRY-000 NULL)
      (MEMOIZED-VALUE-000 NULL))
     (CL:WHEN *MEMOIZATION-ENABLED?*
      (CL:SETQ MEMO-TABLE-000
       (%SURROGATE-VALUE
        SGT-QUERY-LOGIC-F-ALL-ASSERTED-COLLECTION-MEMBERS.NEXT?-MEMO-TABLE-000))
      (CL:WHEN (CL:EQ MEMO-TABLE-000 NULL)
       (INITIALIZE-MEMOIZATION-TABLE
        SGT-QUERY-LOGIC-F-ALL-ASSERTED-COLLECTION-MEMBERS.NEXT?-MEMO-TABLE-000
        "(:MAX-VALUES 100)")
       (CL:SETQ MEMO-TABLE-000
        (%SURROGATE-VALUE
         SGT-QUERY-LOGIC-F-ALL-ASSERTED-COLLECTION-MEMBERS.NEXT?-MEMO-TABLE-000)))
      (CL:SETQ MEMOIZED-ENTRY-000
       (LOOKUP-MRU-MEMOIZED-VALUE MEMO-TABLE-000 (%COLLECTION SELF)
        *MODULE* (WRAP-INTEGER (%OBSERVED-CARDINALITY SELF))
        MEMOIZED-NULL-VALUE 2))
      (CL:SETQ MEMOIZED-VALUE-000 (%%VALUE MEMOIZED-ENTRY-000)))
     (CL:COND
      ((CL:NOT (CL:EQ MEMOIZED-VALUE-000 NULL))
       (CL:WHEN (CL:EQ MEMOIZED-VALUE-000 MEMOIZED-NULL-VALUE)
        (CL:SETQ MEMOIZED-VALUE-000 NULL)))
      (CL:T (CL:SETQ MEMOIZED-VALUE-000 SELF)
       (CL:WHEN *MEMOIZATION-ENABLED?*
        (CL:SETF (%%VALUE MEMOIZED-ENTRY-000)
         (CL:IF (CL:EQ MEMOIZED-VALUE-000 NULL) MEMOIZED-NULL-VALUE
          MEMOIZED-VALUE-000)))))
     (CL:LET* ((MEMOIZEDVALUE MEMOIZED-VALUE-000))
      (CL:WHEN (CL:EQ MEMOIZEDVALUE SELF)
       (UPDATE-OBSERVED-CARDINALITY (%COLLECTION SELF)
        (%OBSERVED-CARDINALITY SELF))))))
   (CL:SETF (%VALUE SELF) NULL) CL:NIL))

;;; (DEFMETHOD (NEXT? BOOLEAN) ...)

(CL:DEFMETHOD NEXT? ((SELF ASSERTED-COLLECTION-MEMBERS-ITERATOR))
  (ALL-ASSERTED-COLLECTION-MEMBERS.NEXT? SELF))
...
return NULL.  If direct?, don't look down isa hierarchies."
  (CL:LET*
   ((ITER (ALL-ASSERTED-COLLECTION-MEMBERS SELF DIRECT?))
    (MEMBERS (LISTIFY ITER)))
   (CL:WHEN (EMPTY? MEMBERS)
    (CL:LET* ((TEST-VALUE-000 (%KIND ITER)))
     (CL:COND
      ((CL:OR (CL:EQ TEST-VALUE-000 KWD-QUERY-DESCRIPTION)
        (CL:EQ TEST-VALUE-000 KWD-QUERY-UNDEFINED))
       (CL:RETURN-FROM ASSERTED-COLLECTION-MEMBERS NULL))
      (CL:T))))
   MEMBERS))
...
(CL:DEFUN PRINT-QUERY-ITERATOR-SOLUTION-ORNATELY (SELF SOLUTION SOLUTIONNUMBER STREAM)
  ...
  (CL:LET*
   ((NSOLUTIONS (LENGTH (%SOLUTIONS SELF)))
    (VERTICAL?
     (TEST-QUERY-OPTION-VALUE? SELF KWD-QUERY-FORMAT
      KWD-QUERY-VERTICAL))
    (MAXDIGITS (INTEGER-LENGTH10 (CL:TRUNCATE NSOLUTIONS)))
    (SOLNUMBERDIGITS 0))
   (CL:DECLARE
   ...
   (CL:SETQ SOLNUMBERDIGITS
    (INTEGER-LENGTH10 (CL:TRUNCATE SOLUTIONNUMBER)))
   (CL:LET* ((*PRINTREADABLY?* CL:T))
    (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
...
(CL:DEFUN PRINT-QUERY-ITERATOR-TAB-SEPARATED (SELF STREAM)
  (CL:LET*
   ((SOLUTIONS (%SOLUTIONS SELF)) (SEPARATOR #\Tab)
    (BARE?
     (CL:EQ
      (LOOKUP-QUERY-OPTION-WITH-DEFAULT SELF KWD-QUERY-VALUE-FORMAT
       KWD-QUERY-READABLE)
      KWD-QUERY-BARE)))
   (CL:LET* ((*PRINTREADABLY?* CL:T))
    (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     ...
     (CL:LOOP WHILE
      ...
      (CL:LET*
       ...
       (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
        ...
        (CL:IF (CL:AND BARE? (STRING? VALUE))
         (%%PRINT-STREAM STREAM (UNWRAP-STRING VALUE))
          ...
          (CL:SETF (%MATCH-SCORE SOLUTION)
           (CL:IF
            (CL:AND
             ...
             (CL:NOT
              (CL:= (%MATCH-SCORE (%PARTIAL-MATCH-FRAME BASEFRAME))
               NULL-FLOAT)))
            (%MATCH-SCORE (%PARTIAL-MATCH-FRAME BASEFRAME))
            (%WRAPPER-VALUE
             (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS SELF)
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:LET* ((TEST-VALUE-000 KEY))
      (CL:COND
       ...
       ((CL:EQ TEST-VALUE-000 KWD-QUERY-VALUE-FORMAT)
        (CL:COND
         ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE VALUE)
           SGT-QUERY-STELLA-GENERALIZED-SYMBOL)
          (CL:PROGN
           (CL:COND
            ((STRING-EQL? (%SYMBOL-NAME VALUE) "BARE")
             (INSERT-AT THEOPTIONS KEY KWD-QUERY-BARE))
            ((STRING-EQL? (%SYMBOL-NAME VALUE) "READABLE")
             (INSERT-AT THEOPTIONS KEY KWD-QUERY-READABLE))
            (CL:T
             (CL:LET* ((STREAM-009 (NEW-OUTPUT-STRING-STREAM)))
              (CL:LET* ((*PRINTREADABLY?* CL:T))
               (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
               (%%PRINT-STREAM (%NATIVE-STREAM STREAM-009)
                "PARSING ERROR: Illegal :VALUE-FORMAT value: `" VALUE
                "'." EOL)
       ...
       ((CL:EQ TEST-VALUE-000 KWD-QUERY-MINIMUM-SCORE)
        (CL:LET* ((TEST-VALUE-008 (SAFE-PRIMARY-TYPE VALUE)))
         (CL:COND
          ...
          (CL:T
           (CL:LET* ((STREAM-013 (NEW-OUTPUT-STRING-STREAM)))
            (CL:LET* ((*PRINTREADABLY?* CL:T))
             (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
             (%%PRINT-STREAM (%NATIVE-STREAM STREAM-013)
              "PARSING ERROR: Illegal :MINIMUM-SCORE value: `" VALUE
              "'." EOL)
             (HELP-SIGNAL-PROPOSITION-ERROR STREAM-013
              KWD-QUERY-ERROR))
            (CL:ERROR
             (NEW-PARSING-ERROR (THE-STRING-READER STREAM-013))))))))
       ...
       ((CL:EQ TEST-VALUE-000 KWD-QUERY-MAXIMUM-UNKNOWNS)
        (CL:LET* ((TEST-VALUE-009 (SAFE-PRIMARY-TYPE VALUE)))
         (CL:COND ((SUBTYPE-OF-INTEGER? TEST-VALUE-009) (CL:PROGN))
          ...
          (CL:T
           (CL:LET* ((STREAM-014 (NEW-OUTPUT-STRING-STREAM)))
            (CL:LET* ((*PRINTREADABLY?* CL:T))
             (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
             (%%PRINT-STREAM (%NATIVE-STREAM STREAM-014)
              "PARSING ERROR: Illegal :MAXIMUM-UNKNOWNS value: `" VALUE
              "'." EOL)
             (HELP-SIGNAL-PROPOSITION-ERROR STREAM-014
              KWD-QUERY-ERROR))
            (CL:ERROR
             (NEW-PARSING-ERROR (THE-STRING-READER STREAM-014))))))))
       (CL:T
...
(CL:DEFUN MAKE-CACHED-QUERY (VARIABLES QUERY INPUTBINDINGS OPTIONS CACHEID)
...
or NULL.  Called by 'apply-cached-retrieve' and 'apply-cached-ask'."
  (CL:LET*
   ((QUERYITERATOR NULL) (CURSOR INPUTBINDINGS)
    (CHANGEDBINDINGPATTERN? CL:NIL))
   (CL:COND
    ((SUBTYPE-OF? (SAFE-PRIMARY-TYPE QUERY)
      SGT-QUERY-LOGIC-QUERY-ITERATOR)
     (CL:PROGN (CL:SETQ QUERYITERATOR QUERY)))
    (CL:T
     (CL:WHEN (CL:NOT (CL:EQ CACHEID NULL))
      (CL:SETQ QUERYITERATOR (FIND-CACHED-QUERY CACHEID)))))
   ...
   (CL:WHEN (CL:AND (CL:EQ QUERYITERATOR NULL) (CONS? QUERY))
    (CL:HANDLER-CASE
     (CL:SETQ QUERYITERATOR
      (MAKE-QUERY (COPY-CONS-LIST VARIABLES) (COPY-CONS-TREE QUERY)
   ...
   (CL:WHEN (CL:EQ QUERYITERATOR NULL)
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR)
     "make-cached-query: unable to find or construct cached query")
    (CL:RETURN-FROM MAKE-CACHED-QUERY NULL))
   (CL:WHEN
    (CL:NOT
     (CL:= (LENGTH (%IO-VARIABLES (QUERY-DESCRIPTION QUERYITERATOR)))
      (LENGTH INPUTBINDINGS)))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-ERROR)
     "make-cached-query: number of IO variables does not equal number of input bindings.")
    (CL:RETURN-FROM MAKE-CACHED-QUERY NULL))
   (CL:WHEN (CL:NOT (CL:EQ INPUTBINDINGS NIL))
    (CL:LET*
     ((NEWB NULL) (ITER-000 INPUTBINDINGS) (OLDB NULL)
      (VECTOR-000
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS QUERYITERATOR)
        SYM-QUERY-LOGIC-INITIAL-BINDINGS NULL))
      (INDEX-000 0) (LENGTH-000 (LENGTH VECTOR-000)) (I NULL-INTEGER)
     ...
     (CL:LOOP WHILE
      ...
      DO (CL:SETQ NEWB (%%VALUE ITER-000))
      (CL:SETQ OLDB
       (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000))
        INDEX-000))
      (CL:SETQ I ITER-001)
      ...
      (CL:WHEN
       (CL:NOT
        (CL:EQ (CL:NOT (CL:EQ OLDB NULL)) (CL:NOT (CL:EQ NEWB NULL))))
       (CL:SETQ CHANGEDBINDINGPATTERN? CL:T))
      (CL:SETQ ITER-000 (%%REST ITER-000))
      (CL:SETQ INDEX-000 (CL:1+ INDEX-000))
      (CL:SETQ ITER-001 (CL:1+ ITER-001)))))
   (CL:WHEN CHANGEDBINDINGPATTERN?
    (CL:SETF
     (%BOOLEAN-VECTOR
      (%PATTERN-RECORD (%BASE-CONTROL-FRAME QUERYITERATOR)))
   ...
   (RESET QUERYITERATOR)
   (CL:WHEN
    (CL:AND (CL:NOT (CL:EQ OPTIONS NULL)) (CL:NOT (CL:EQ OPTIONS NIL)))
    (PROCESS-QUERY-OPTIONS QUERYITERATOR OPTIONS))
   QUERYITERATOR))

;;; (DEFUN (CONSIFY-CACHED-QUERY-SOLUTIONS CONS CONS CONS) ...)

(CL:DEFUN CONSIFY-CACHED-QUERY-SOLUTIONS (QUERYITERATOR TRUTHVALUES? JUSTIFICATIONS?)
...
otherwise).  Despite the name, this will also work for regular, non-cached queries."
  (CL:WHEN (EMPTY? (%SOLUTIONS QUERYITERATOR))
   (CL:RETURN-FROM CONSIFY-CACHED-QUERY-SOLUTIONS
    (CL:VALUES NIL NIL NIL)))
  (CL:LET*
   ((OPTIONS (%OPTIONS QUERYITERATOR)) (ATOMICSINGLETONS? CL:T)
    (NUNBOUND 0)
    (INPUTBINDINGS
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS QUERYITERATOR)
      SYM-QUERY-LOGIC-INITIAL-BINDINGS NULL))
    (OUTPUTBINDINGS NIL) (TRUTHVALUES NIL) (JUSTIFICATIONS NIL)
    (TUPLE NIL))
   (CL:DECLARE (CL:TYPE CL:FIXNUM NUNBOUND))
   (CL:COND
    ((CL:NOT (CL:EQ INPUTBINDINGS NULL))
     (CL:LET*
      ((B NULL) (VECTOR-000 INPUTBINDINGS) (INDEX-000 0)
       (LENGTH-000 (LENGTH VECTOR-000)))
      (CL:DECLARE (CL:TYPE CL:FIXNUM INDEX-000 LENGTH-000))
      (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
       (CL:SETQ B
        (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY VECTOR-000))
         INDEX-000))
       (CL:WHEN (CL:EQ B NULL) (CL:SETQ NUNBOUND (CL:1+ NUNBOUND)))
       (CL:SETQ INDEX-000 (CL:1+ INDEX-000)))))
    (CL:T
     (CL:SETQ NUNBOUND (LENGTH (%EXTERNAL-VARIABLES QUERYITERATOR)))))
   (CL:WHEN
    (CL:OR (CL:NOT (CL:= NUNBOUND 1))
     (EQL? (LOOKUP OPTIONS KWD-QUERY-ATOMIC-SINGLETONS?) FALSE-WRAPPER)
     (EQL? (LOOKUP OPTIONS KWD-QUERY-SINGLETONS?) FALSE-WRAPPER))
    (CL:SETQ ATOMICSINGLETONS? CL:NIL))
   (CL:WHEN (CL:AND JUSTIFICATIONS? (CL:NOT *RECORD-JUSTIFICATIONS?*))
    (CL:SETQ JUSTIFICATIONS? CL:NIL))
   (CL:LET*
    ((S NULL)
    ...
    (CL:LOOP WHILE (NEXT? ITER-000) DO (CL:SETQ S (%VALUE ITER-000))
     ...
     (CL:LET*
      ...
      (CL:LOOP WHILE (CL:< INDEX-001 LENGTH-001) DO
       ...
       (CL:SETQ I ITER-001)
       (CL:WHEN
        (CL:OR (CL:EQ INPUTBINDINGS NULL)
         (CL:EQ
          (CL:AREF (CL:THE CL:SIMPLE-VECTOR (%THE-ARRAY INPUTBINDINGS))
           I)
          NULL))
        (CL:WHEN ATOMICSINGLETONS?
         (CL:SETQ OUTPUTBINDINGS (CONS V OUTPUTBINDINGS)) (CL:RETURN))
        (CL:IF (CL:EQ COLLECT-000 NULL)
         (CL:PROGN (CL:SETQ COLLECT-000 (CONS V NIL))
          (CL:IF (CL:EQ TUPLE NIL) (CL:SETQ TUPLE COLLECT-000)
           (ADD-CONS-TO-END-OF-CONS-LIST TUPLE COLLECT-000)))
         (CL:PROGN (CL:SETF (%%REST COLLECT-000) (CONS V NIL))
          (CL:SETQ COLLECT-000 (%%REST COLLECT-000)))))
       (CL:SETQ INDEX-001 (CL:1+ INDEX-001))
       (CL:SETQ ITER-001 (CL:1+ ITER-001))))
     (CL:WHEN (CL:NOT ATOMICSINGLETONS?)
      (CL:SETQ OUTPUTBINDINGS (CONS TUPLE OUTPUTBINDINGS)))
     (CL:WHEN TRUTHVALUES?
      (CL:SETQ TRUTHVALUES (CONS (%TRUTH-VALUE S) TRUTHVALUES)))
     (CL:WHEN JUSTIFICATIONS?
      (CL:SETQ JUSTIFICATIONS
       (CONS (%JUSTIFICATION S) JUSTIFICATIONS)))))
   (CL:VALUES (REVERSE OUTPUTBINDINGS)
    (CL:IF TRUTHVALUES? (REVERSE TRUTHVALUES) NIL)
    (CL:IF JUSTIFICATIONS? (REVERSE JUSTIFICATIONS) NIL))))
...
(CL:DEFUN APPLY-CACHED-RETRIEVE (VARIABLES QUERYBODY INPUTBINDINGS OPTIONS CACHEID)
  (CL:LET*
   ...
   (CL:LET* ((BINDINGS NULL) (TRUTHVALUES NULL) (JUSTIFICATIONS NULL))
    (CL:MULTIPLE-VALUE-SETQ (BINDINGS TRUTHVALUES JUSTIFICATIONS)
     (CONSIFY-CACHED-QUERY-SOLUTIONS QUERYITERATOR CL:T CL:T))
    (FREE-CACHED-QUERY QUERYITERATOR CACHEID)
    (CL:VALUES BINDINGS TRUTHVALUES JUSTIFICATIONS))))
...
(CL:DEFUN UPDATE-PROPOSITIONS-FROM-QUERY (QUERY DESCRIPTION MODULE UPDATEMODE RECORDJUSTIFICATIONS?)
  ...
  (CL:LET*
   ((QUERYDESCRIPTION (QUERY-DESCRIPTION QUERY))
    ...
    (RETRACT? (CL:EQ UPDATEMODE KWD-QUERY-RETRACT-TRUE))
    (SOLUTIONS (%SOLUTIONS QUERY)) (MAPPING (NEW-KEY-VALUE-MAP))
    (DONTCHECKDUPLICATES? CL:NIL) (PROPOSITION NULL) (PROPOSITIONS NIL)
    (TENTHOUSANDS 0) (TERMINATELINE? CL:NIL))
         ...
         (CL:WHEN
          ...
          (CL:LET* ((SELF-007 (NEW-FORWARD-JUSTIFICATION)))
           ...
           (CL:LET* ((RESULTJUSTIFICATION SELF-007))
            (ADD-FORWARD-JUSTIFICATION PROP RESULTJUSTIFICATION))))
...
;;; (DEFUN (HANDLE-UPDATE-PROPOSITIONS-RESULT (CONS OF PROPOSITION)) ...)

(CL:DEFUN HANDLE-UPDATE-PROPOSITIONS-RESULT (RESULT RESULTMODE UPDATEMODE QUERY MODULE)
  (CL:WHEN (CL:EQ RESULT NULL)
   (CL:RETURN-FROM HANDLE-UPDATE-PROPOSITIONS-RESULT NULL))
  (CL:WHEN (CL:EQ RESULTMODE NULL) (CL:SETQ RESULTMODE KWD-QUERY-NONE))
  (CL:WHEN (CL:EQ MODULE NULL) (CL:SETQ MODULE *MODULE*))
  (CL:COND ((CL:EQ RESULTMODE KWD-QUERY-LIST) RESULT)
   ((CL:EQ RESULTMODE KWD-QUERY-NONE) NULL)
   ((CL:OR (CL:EQ RESULTMODE KWD-QUERY-PRINT)
     (CL:EQ RESULTMODE KWD-QUERY-SUMMARY))
    (CL:WHEN (CL:EQ RESULTMODE KWD-QUERY-PRINT)
     (CL:LET* ((*PRINTREADABLY?* CL:NIL) (*MODULE* MODULE))
      (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?* *MODULE*))
      (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT) QUERY)))
    (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
     (CL:IF (CL:EQ UPDATEMODE KWD-QUERY-ASSERT-TRUE) "Asserted "
      "Retracted ")
     (LENGTH (%SOLUTIONS QUERY)) " solution(s), " (LENGTH RESULT)
     " proposition(s)" EOL)
    NULL)
   ((CL:OR (CL:EQ RESULTMODE KWD-QUERY-STATISTICS)
     (CL:EQ RESULTMODE KWD-QUERY-STATS))
    (CL:LET* ((*PRINTREADABLY?* CL:T))
     (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING)
      "WARNING: :stats option not yet implemented" EOL)
   ...
   (CL:T
    (CL:LET* ((*PRINTREADABLY?* CL:T))
     (CL:DECLARE (CL:SPECIAL *PRINTREADABLY?*))
     (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-WARNING)
      "WARNING: Invalid result mode: " RESULTMODE EOL)
     (HELP-SIGNAL-PROPOSITION-ERROR STANDARD-WARNING
      KWD-QUERY-WARNING))
    RESULT)))
    ...
    ((THEOPTIONS
      (PARSE-LOGIC-COMMAND-OPTIONS OPTIONS
       (LIST* KWD-QUERY-MODULE SGT-QUERY-STELLA-MODULE
        ...
        SGT-QUERY-STELLA-BOOLEAN KWD-QUERY-RESULT
        SGT-QUERY-STELLA-KEYWORD NIL)
       CL:T CL:NIL))
     (PATTERN NULL)
     (RECORDJUSTIFICATIONS?
      (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-QUERY-RECORD-JUSTIFICATIONS?
       FALSE-WRAPPER))
     (RESULTMODE
      (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-QUERY-RESULT
       KWD-QUERY-LIST)))
    (CL:WHEN
    ...
    (CL:LET*
     ...
     (CL:LET*
      ((QUERYITERATOR (GET-QUERY-ITERATOR-FROM-COMMAND QUERY))
       (MODULE
        (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-QUERY-MODULE *MODULE*))
       (UPDATEMODE KWD-QUERY-ASSERT-TRUE)
       (RESULT
      ...
      (CL:RETURN-FROM %ASSERT-FROM-QUERY
       (HANDLE-UPDATE-PROPOSITIONS-RESULT RESULT RESULTMODE UPDATEMODE
   ...
   (CL:LET*
    ((THEOPTIONS
      (PARSE-LOGIC-COMMAND-OPTIONS OPTIONS
       (LIST* KWD-QUERY-MODULE SGT-QUERY-STELLA-MODULE
        KWD-QUERY-RELATION SGT-QUERY-STELLA-SYMBOL KWD-QUERY-PATTERN
        SGT-QUERY-STELLA-CONS KWD-QUERY-RESULT SGT-QUERY-STELLA-KEYWORD
        NIL)
       CL:T CL:NIL))
     (QUERYITERATOR (GET-QUERY-ITERATOR-FROM-COMMAND QUERY))
     (MODULE
      (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-QUERY-MODULE *MODULE*))
     (RESULTMODE
      (LOOKUP-WITH-DEFAULT THEOPTIONS KWD-QUERY-RESULT KWD-QUERY-LIST))
     (PATTERN NULL) (UPDATEMODE KWD-QUERY-RETRACT-TRUE))
    (CL:WHEN
     (CL:NOT (CL:EQ (LOOKUP THEOPTIONS KWD-QUERY-PATTERN) NULL))
     (CL:SETQ PATTERN
      (CONCEIVE-TERM (LOOKUP THEOPTIONS KWD-QUERY-PATTERN))))
...
(CL:DEFUN HELP-STARTUP-QUERY4 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-QUERY-LOGIC-ASSERTED-COLLECTION-MEMBERS-ITERATOR
    (INTERN-RIGID-SYMBOL-WRT-MODULE
     "ASSERTED-COLLECTION-MEMBERS-ITERATOR" NULL 1))
   (CL:SETQ SYM-QUERY-STELLA-COLLECTION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "COLLECTION"
     (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-QUERY-LOGIC-SPECIALIZE?
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SPECIALIZE?" NULL 0))
   (CL:SETQ SYM-QUERY-LOGIC-KIND
    (INTERN-RIGID-SYMBOL-WRT-MODULE "KIND" NULL 0))
   (CL:SETQ SYM-QUERY-STELLA-BASE-ITERATOR
    (INTERN-RIGID-SYMBOL-WRT-MODULE "BASE-ITERATOR"
     (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ SYM-QUERY-LOGIC-NESTED-BASE-ITERATOR
    (INTERN-RIGID-SYMBOL-WRT-MODULE "NESTED-BASE-ITERATOR" NULL 0))
   (CL:SETQ SYM-QUERY-LOGIC-OBSERVED-CARDINALITY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "OBSERVED-CARDINALITY" NULL 0))
   (CL:SETQ
    SGT-QUERY-LOGIC-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS-ITERATOR
    (INTERN-RIGID-SYMBOL-WRT-MODULE
     "ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS-ITERATOR" NULL 1))
   (CL:SETQ SYM-QUERY-LOGIC-MEMBER
   ...
   (CL:SETQ SGT-QUERY-PL-KERNEL-KB-COLLECTIONOF
    (INTERN-RIGID-SYMBOL-WRT-MODULE "COLLECTIONOF"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 1))
   (CL:SETQ KWD-QUERY-COLLECTION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "COLLECTION" NULL 2))
   (CL:SETQ KWD-QUERY-NAMED-DESCRIPTION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "NAMED-DESCRIPTION" NULL 2))
   (CL:SETQ KWD-QUERY-ENUMERATION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ENUMERATION" NULL 2))
   (CL:SETQ KWD-QUERY-SKOLEM
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SKOLEM" NULL 2))
   (CL:SETQ SGT-QUERY-PL-KERNEL-KB-MEMBER-OF
    (INTERN-RIGID-SYMBOL-WRT-MODULE "MEMBER-OF"
     (GET-STELLA-MODULE "/PL-KERNEL-KB" CL:T) 1))
   (CL:SETQ KWD-QUERY-LOGIC-OBJECT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "LOGIC-OBJECT" NULL 2))
   (CL:SETQ SGT-QUERY-STELLA-COLLECTION
    (INTERN-RIGID-SYMBOL-WRT-MODULE "COLLECTION"
     (GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ SGT-QUERY-LOGIC-SKOLEM
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SKOLEM" NULL 1))
   (CL:SETQ KWD-QUERY-UNDEFINED
    (INTERN-RIGID-SYMBOL-WRT-MODULE "UNDEFINED" NULL 2))
   (CL:SETQ
    SGT-QUERY-LOGIC-F-ALL-ASSERTED-COLLECTION-MEMBERS.NEXT?-MEMO-TABLE-000
    (INTERN-RIGID-SYMBOL-WRT-MODULE
     "F-ALL-ASSERTED-COLLECTION-MEMBERS.NEXT?-MEMO-TABLE-000" NULL 1))
...
(CL:DEFUN HELP-STARTUP-QUERY5 ()
  (CL:PROGN
   ...
   (CL:SETQ KWD-QUERY-VALUE-FORMAT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "VALUE-FORMAT" NULL 2))
   (CL:SETQ KWD-QUERY-READABLE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "READABLE" NULL 2))
   (CL:SETQ KWD-QUERY-BARE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "BARE" NULL 2))
...
(CL:DEFUN HELP-STARTUP-QUERY6 ()
  (CL:PROGN
   ...
   (CL:SETQ KWD-QUERY-PRINT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "PRINT" NULL 2))
   (CL:SETQ KWD-QUERY-SUMMARY
    (INTERN-RIGID-SYMBOL-WRT-MODULE "SUMMARY" NULL 2))
   (CL:SETQ KWD-QUERY-ASSERT-TRUE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "ASSERT-TRUE" NULL 2))
   (CL:SETQ KWD-QUERY-STATISTICS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "STATISTICS" NULL 2))
   (CL:SETQ KWD-QUERY-STATS
    (INTERN-RIGID-SYMBOL-WRT-MODULE "STATS" NULL 2))
   ...
   (CL:SETQ SGT-QUERY-STELLA-BOOLEAN
    (INTERN-RIGID-SYMBOL-WRT-MODULE "BOOLEAN"
     (GET-STELLA-MODULE "/STELLA" CL:T) 1))
   (CL:SETQ KWD-QUERY-RESULT
    (INTERN-RIGID-SYMBOL-WRT-MODULE "RESULT" NULL 2))
   (CL:SETQ SGT-QUERY-STELLA-KEYWORD
    (INTERN-RIGID-SYMBOL-WRT-MODULE "KEYWORD"
     (GET-STELLA-MODULE "/STELLA" CL:T) 1))
...
(CL:DEFUN HELP-STARTUP-QUERY7 ()
  (CL:PROGN
   (CL:LET* ((SELF-031 (NEW-NORMAL-INFERENCE-LEVEL)))
    (CL:SETF (%KEYWORD SELF-031) KWD-QUERY-NORMAL)
    (CL:SETQ NORMAL-INFERENCE SELF-031))
   (CL:LET* ((SELF-032 (NEW-BACKTRACKING-INFERENCE-LEVEL)))
    (CL:SETF (%KEYWORD SELF-032) KWD-QUERY-BACKTRACKING)
    (CL:SETQ BACKTRACKING-INFERENCE SELF-032))
   (CL:LET* ((SELF-033 (NEW-SUBSUMPTION-INFERENCE-LEVEL)))
    (CL:SETF (%KEYWORD SELF-033) KWD-QUERY-SUBSUMPTION)
    (CL:SETQ SUBSUMPTION-INFERENCE SELF-033))
   (CL:LET* ((SELF-034 (NEW-SHALLOW-INFERENCE-LEVEL)))
    (CL:SETF (%KEYWORD SELF-034) KWD-QUERY-SHALLOW)
    (CL:SETQ SHALLOW-INFERENCE SELF-034))
   (CL:LET* ((SELF-035 (NEW-ASSERTION-INFERENCE-LEVEL)))
    (CL:SETF (%KEYWORD SELF-035) KWD-QUERY-ASSERTION)
    (CL:SETQ ASSERTION-INFERENCE SELF-035))
   (CL:LET* ((SELF-036 (NEW-REFUTATION-INFERENCE-LEVEL)))
    (CL:SETF (%KEYWORD SELF-036) KWD-QUERY-REFUTATION)
    (CL:SETQ REFUTATION-INFERENCE SELF-036))
   ...
   (CL:LET* ((SELF-037 (NEW-PROPERTY-LIST)))
    (CL:SETF (%THE-PLIST SELF-037)
    ...
    (CL:SETQ *THINKING-DOT-TABLE* SELF-037))
   (CL:LET* ((SELF-038 (NEW-BOOLEAN-VECTOR-INDEX-NODE)))
    (CL:SETF (%THE-VECTOR SELF-038) (NEW-BOOLEAN-VECTOR 0))
    (CL:SETQ *BOOLEAN-VECTOR-INDEX* SELF-038))
...
the processing of a description.\" :SLOTS ((CONTROL-FRAME :TYPE CONTROL-FRAME) (VARIABLE-BINDINGS :TYPE (VECTOR OF OBJECT)) (UNBINDING-STACK :TYPE INTEGER-VECTOR) (TOP-UNBINDING-STACK-OFFSET :TYPE INTEGER) (DESCRIPTION :TYPE DESCRIPTION) (EXTERNAL-ARGUMENTS :TYPE ARGUMENTS-VECTOR) (BOOLEAN-VECTOR :TYPE BOOLEAN-VECTOR) (OPTIMAL-PATTERN :TYPE DESCRIPTION) (COLLECTION-LIST :TYPE LIST)) :TERMINATOR TERMINATE-PATTERN-RECORD?)")))
   ...
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE
       "ASSERTED-COLLECTION-MEMBERS-ITERATOR"
       "(DEFCLASS ASSERTED-COLLECTION-MEMBERS-ITERATOR (ITERATOR) :DOCUMENTATION \"Iterator reimplementation of `asserted-collection-members'.
Generates asserted members of a collection as well as the supporting propositions
with their truth values and justifications (if applicable).\" :PARAMETERS ((ANY-VALUE :TYPE OBJECT)) :SLOTS ((COLLECTION :TYPE OBJECT) (SPECIALIZE? :TYPE BOOLEAN) (KIND :TYPE KEYWORD) (BASE-ITERATOR :TYPE ITERATOR) (NESTED-BASE-ITERATOR :TYPE ITERATOR) (PROPOSITION :TYPE PROPOSITION) (OBSERVED-CARDINALITY :TYPE INTEGER :INITIALLY 0)))")))
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS)
     (CL:FUNCTION NEW-ASSERTED-COLLECTION-MEMBERS-ITERATOR))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS)
     (CL:FUNCTION
      ACCESS-ASSERTED-COLLECTION-MEMBERS-ITERATOR-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE
       "ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS-ITERATOR"
       "(DEFCLASS ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS-ITERATOR (ASSERTED-COLLECTION-MEMBERS-ITERATOR) :DOCUMENTATION \"Iterator reimplementation of `member-of-collection?'.
Generates proposition supports that prove that the bound self.member is or is not
an asserted member of the specified collection (handles reverse polarity).\" :SLOTS ((MEMBER :TYPE OBJECT)))")))
    (CL:SETF (%CLASS-CONSTRUCTOR-CODE CLASS)
     (CL:FUNCTION NEW-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS-ITERATOR))
    (CL:SETF (%CLASS-SLOT-ACCESSOR-CODE CLASS)
     (CL:FUNCTION
      ACCESS-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS-ITERATOR-SLOT-VALUE)))
   (CL:LET*
    ((CLASS
      (DEFINE-CLASS-FROM-STRINGIFIED-SOURCE
...
level of the current query iterator.  Otherwise, set the level globally.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-INLINE-METHOD-CODE SGT-QUERY-LOGIC-CONTROL-FRAME
    SYM-QUERY-LOGIC-HOLDS-BY-DEFAULT?
    (WRAP-METHOD-CODE (CL:FUNCTION HOLDS-BY-DEFAULT?)) NULL)
...
(CL:DEFUN HELP-STARTUP-QUERY10 ()
  (CL:PROGN
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION CLUSTERED-CONJUNCTION?)) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "ALL-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS"
    "(DEFUN (ALL-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS-ITERATOR) ((MEMBER OBJECT) (COLLECTION OBJECT)) :DOCUMENTATION \"Allocate an iterator that generates all propositions that support that `member' is in `collection'.
Finding one such support is enough for the original `member-of-collection?' semantics (which see), however, we
generalized it to allow us to handle all-proofs situations where we want to find all supports.  This function
generates the iterator which in each iteration produces the same `member' value but a potentially different
supporting proposition and truth value.  We set it up this way to be in mostly equivalent to `asserted-collection-members'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION ALL-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS) NULL)
   (DEFINE-FUNCTION-OBJECT
    "ALL-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS.NEXT?"
    "(DEFUN (ALL-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS.NEXT? BOOLEAN) ((SELF ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS-ITERATOR)))"
    (CL:FUNCTION ALL-ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS.NEXT?)
    NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (NEXT? BOOLEAN) ((SELF ASSERTED-MEMBER-OF-COLLECTION-SUPPORTS-ITERATOR)))"
   ...
   (DEFINE-FUNCTION-OBJECT "ALL-ASSERTED-COLLECTION-MEMBERS"
    "(DEFUN (ALL-ASSERTED-COLLECTION-MEMBERS ASSERTED-COLLECTION-MEMBERS-ITERATOR) ((SELF OBJECT) (DIRECT? BOOLEAN)) :DOCUMENTATION \"Return an iterator generating all asserted members of the collection `self'.
If `direct?' is true, do not consider sub-collections.  This is an iterator reimplementation
of `asserted-collection-members' (which see).\" :PUBLIC? TRUE)"
    (CL:FUNCTION ALL-ASSERTED-COLLECTION-MEMBERS) NULL)
   (DEFINE-FUNCTION-OBJECT "ALL-ASSERTED-COLLECTION-MEMBERS.NEXT?"
    "(DEFUN (ALL-ASSERTED-COLLECTION-MEMBERS.NEXT? BOOLEAN) ((SELF ASSERTED-COLLECTION-MEMBERS-ITERATOR)))"
    (CL:FUNCTION ALL-ASSERTED-COLLECTION-MEMBERS.NEXT?) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (NEXT? BOOLEAN) ((SELF ASSERTED-COLLECTION-MEMBERS-ITERATOR)))"
    (WRAP-METHOD-CODE (CL:FUNCTION NEXT?)) NULL)
   (DEFINE-FUNCTION-OBJECT "ASSERTED-COLLECTION-MEMBERS"
    "(DEFUN (ASSERTED-COLLECTION-MEMBERS LIST) ((SELF OBJECT) (DIRECT? BOOLEAN)) :DOCUMENTATION \"List version of `all-asserted-collection-members' for backwards compatibility.
This is called lots of places, including 'MEMBER-OF-specialist'.  If 'self' is a native collection,
a skolem collection, or a named description, return a list of asserted members of 'self', otherwise,
return NULL.  If direct?, don't look down isa hierarchies.\" :PUBLIC? TRUE)"
...
if the table is empty.\" :PUBLIC? TRUE)"
...
`predicate', and return the result.  If `predicate' has a '<' semantics, the
result will be in ascending order.\" :PUBLIC? TRUE)"
...
use the current ID counter and increment it appropriately.\")"
    (WRAP-METHOD-CODE (CL:FUNCTION DEBUG-ID-SETTER)) NULL)
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION QUERY-PROPOSITION)) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (QUERY-DESCRIPTION DESCRIPTION) ((SELF QUERY-ITERATOR)))"
    (WRAP-METHOD-CODE (CL:FUNCTION QUERY-DESCRIPTION)) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (QUERY-IS-TRUE-FALSE? BOOLEAN) ((SELF QUERY-ITERATOR)))"
    (WRAP-METHOD-CODE (CL:FUNCTION QUERY-IS-TRUE-FALSE?)) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (QUERY-IS-PARTIAL? BOOLEAN) ((SELF QUERY-ITERATOR)))"
    (WRAP-METHOD-CODE (CL:FUNCTION QUERY-IS-PARTIAL?)) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (QUERY-SUCCEEDED? BOOLEAN) ((SELF QUERY-ITERATOR)))"
    (WRAP-METHOD-CODE (CL:FUNCTION QUERY-SUCCEEDED?)) NULL)
   (DEFINE-METHOD-OBJECT
...
list of lists for tuples of arity=1.\" :PUBLIC? TRUE)"
    (WRAP-METHOD-CODE (CL:FUNCTION CONSIFY-CURRENT-SOLUTIONS)) NULL)
   (DEFINE-METHOD-OBJECT
...
list of lists for tuples of arity=1.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "MAKE-CACHED-QUERY"
    "(DEFUN (MAKE-CACHED-QUERY QUERY-ITERATOR) ((VARIABLES CONS) (QUERY OBJECT) (INPUTBINDINGS CONS) (OPTIONS OBJECT) (CACHEID SYMBOL)) :DOCUMENTATION \"Find or create a cached query and reinitialize as necessary.
`variables' are the list of IO variables, some of which will be bound by `inputBindings'.
`variables' can be NULL in case a query iterator was passed in for `query'.
`query' must be a query body cons tree, a query iterator found by `find-cached-query',
or NULL.  Called by 'apply-cached-retrieve' and 'apply-cached-ask'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION MAKE-CACHED-QUERY) NULL)
   (DEFINE-FUNCTION-OBJECT "CONSIFY-CACHED-QUERY-SOLUTIONS"
    "(DEFUN (CONSIFY-CACHED-QUERY-SOLUTIONS CONS CONS CONS) ((QUERYITERATOR QUERY-ITERATOR) (TRUTHVALUES? BOOLEAN) (JUSTIFICATIONS? BOOLEAN)) :DOCUMENTATION \"Collect `queryIterator's current solutions into a list of CONS tuples.
Only collect output values that have been bound as a result of the query, that is exclude
any bindings provided as initial values.  If `truthValues?', also return a list of truth
values for each solution (NIL otherwise).  If `justifications?' and justifications are
currently being recorded, also return a list of justifications for each solution (NIL
otherwise).  Despite the name, this will also work for regular, non-cached queries.\" :PUBLIC? TRUE)"
    (CL:FUNCTION CONSIFY-CACHED-QUERY-SOLUTIONS) NULL)
...
'apply-kappa?'.\")" (CL:FUNCTION APPLY-KAPPA?) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "HANDLE-UPDATE-PROPOSITIONS-RESULT"
    "(DEFUN (HANDLE-UPDATE-PROPOSITIONS-RESULT (CONS OF PROPOSITION)) ((RESULT (CONS OF PROPOSITION)) (RESULTMODE KEYWORD) (UPDATEMODE KEYWORD) (QUERY QUERY-ITERATOR) (MODULE MODULE)))"
    (CL:FUNCTION HANDLE-UPDATE-PROPOSITIONS-RESULT) NULL)
...
(CL:DEFUN STARTUP-QUERY ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2) (HELP-STARTUP-QUERY1)
    ...
    (HELP-STARTUP-QUERY5) (HELP-STARTUP-QUERY6))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4) (HELP-STARTUP-QUERY7))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 5) (HELP-STARTUP-QUERY8))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 6) (FINALIZE-CLASSES))
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7) (HELP-STARTUP-QUERY9)
    (HELP-STARTUP-QUERY10) (HELP-STARTUP-QUERY11)
    (HELP-STARTUP-QUERY12))
...
a duplicate rule.  Default value is infinite.\")" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
...
queries will also be traced.\" :PUBLIC? TRUE)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
...
description extension iterator is switched from a list to a hash table\")"
    ...
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *QUERY-ITERATOR-DEBUG-ID-COUNTER* INTEGER 0)" NULL)
    (REGISTER-NATIVE-NAME SYM-QUERY-STELLA-ASK KWD-QUERY-COMMON-LISP
     KWD-QUERY-FUNCTION)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *MOST-RECENT-QUERY* QUERY-ITERATOR NULL)" NULL)
...
be reparsed and reoptimized each time they are invoked.\" :THREAD-LOCAL? TRUE)"
     NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *MAX-CACHED-QUERIES-PER-ID* INTEGER 10)" NULL)
