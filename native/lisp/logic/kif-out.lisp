    ...
    ((CL:EQ TEST-VALUE-000 KWD-KIF-OUT-ISA)
     (CL:WHEN
      (CL:OR
       (%WRAPPER-VALUE
        (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROPOSITION)
         SYM-KIF-OUT-LOGIC-ASSERTED-BY-TYPE-CHECKER? FALSE-WRAPPER))
...
(CL:DEFUN PRETTY-PRINT-NAMED-DESCRIPTION (SELF STREAM)
  (PRETTY-PRINT-RELATION-DEFINITION-TREE
   (UNSTRINGIFY-IN-MODULE (STRINGIFIED-SOURCE SELF) (HOME-MODULE SELF))
   STREAM))
...
(CL:DEFUN PRETTY-PRINT-RELATION-DEFINITION (SELF STREAM)
  (CL:LET*
   ...
   (CL:WHEN (CL:NOT (CL:EQ DEFINITIONSTRING STELLA::NULL-STRING))
    (PRETTY-PRINT-RELATION-DEFINITION-TREE
     (UNSTRINGIFY-IN-MODULE DEFINITIONSTRING (HOME-MODULE SELF))
     STREAM))))
...
(CL:DEFUN HELP-STARTUP-KIF-OUT1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-KIF-OUT-LOGIC-ASSERTED-BY-TYPE-CHECKER?
...
can be :terse, :verbose, or :source.  Used by `describe'.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION STORE-NATIVE-RELATION)) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD STORE-RELATION ((STORE OBJECT-STORE) (RELATION NAMED-DESCRIPTION)))"
    (WRAP-METHOD-CODE (CL:FUNCTION STORE-RELATION)) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD STORE-ASSERTION ((STORE OBJECT-STORE) (PROPOSITION PROPOSITION)))"
    (WRAP-METHOD-CODE (CL:FUNCTION STORE-ASSERTION)) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD STORE-MODULE-HEADER ((STORE OBJECT-STORE) (MODULE MODULE)))"
    (WRAP-METHOD-CODE (CL:FUNCTION STORE-MODULE-HEADER)) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD STORE-MODULE-TRAILER ((STORE OBJECT-STORE) (MODULE MODULE)))"
    (WRAP-METHOD-CODE (CL:FUNCTION STORE-MODULE-TRAILER)) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD CLEAR-OBJECT-STORE ((STORE OBJECT-STORE)))"
    (WRAP-METHOD-CODE (CL:FUNCTION CLEAR-OBJECT-STORE)) NULL)
...
can decide in certain contexts whether to print a variable or its value.\")"
    ...
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     ...
     NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFSPECIAL *TOPLEVELPRINTKIFPROPOSITION?* BOOLEAN TRUE)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
