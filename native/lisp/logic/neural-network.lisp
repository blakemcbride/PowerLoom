...
(CL:DEFVAR SYM-NEURAL-NETWORK-LOGIC-NEURAL-NET NULL)
...
(CL:DEFCLASS NEURAL-NETWORK (STANDARD-OBJECT)
  ())

;;; (DEFCLASS PROPOSITION-NEURAL-NETWORK ...)

(CL:DEFCLASS PROPOSITION-NEURAL-NETWORK (NEURAL-NETWORK)
  ...
  (CL:LET*
   ((NET
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP)
      SYM-NEURAL-NETWORK-LOGIC-NEURAL-NET NULL))
    (OUTPUT
     (%WRAPPER-VALUE
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP)
       SYM-NEURAL-NETWORK-LOGIC-MATCH-SCORE NULL-FLOAT-WRAPPER)))
  ...
  (CL:LET*
   ...
   (CL:LOOP WHILE
    ...
    (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS (%PROPOSITION OLD-NET))
     SYM-NEURAL-NETWORK-LOGIC-NEURAL-NET NEW-NET NULL)
...
(CL:DEFUN HELP-STARTUP-NEURAL-NETWORK1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-NEURAL-NETWORK-LOGIC-NEURAL-NET
...
name will be used to perform periodic saves.\" :COMMAND? TRUE :PUBLIC? TRUE)"
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION 2_D_ELEMENT)) NULL)
   (DEFINE-METHOD-OBJECT
...
to `value' and return the result.\" :GLOBALLY-INLINE? TRUE :PUBLIC? TRUE (RETURN (SETF (NTH (THE-ARRAY ARRAY) (+ (* ROW (NOF-COLUMNS ARRAY)) COLUMN)) VALUE)))"
    (WRAP-METHOD-CODE (CL:FUNCTION 2_D_ELEMENT-SETTER)) NULL)
...
from `values'.  Missing values will retain their old values, extraneous values
will be ignored.\" :PUBLIC? TRUE)"
    (WRAP-METHOD-CODE (CL:FUNCTION FILL-ARRAY)) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD PRINT-ARRAY ((SELF 2_D_ARRAY) (STREAM NATIVE-OUTPUT-STREAM)) :DOCUMENTATION \"Print the array `self' to `stream'.\")"
    (WRAP-METHOD-CODE (CL:FUNCTION PRINT-ARRAY)) NULL)))
  ...
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
    ...
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     ...
     NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *LEARNING-RATE* FLOAT 0.1)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *MOMENTUM-TERM* FLOAT 0.9)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *WEIGHT-RANGE* FLOAT 0.05)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *ERROR-CUTOFF* FLOAT 0.0)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *ERROR-PRINT-CYCLE* INTEGER 25)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *SAVE-NETWORK-CYCLE* INTEGER 10000)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *SAVE-NETWORK-FILE* STRING NULL)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *TRACE-NEURAL-NETWORK-TRAINING* BOOLEAN FALSE)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *TRAIN-CACHED-NETWORKS?* BOOLEAN TRUE)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *MAX-MOVEMENT* FLOAT 1.75)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *MODE-SWITCH* FLOAT 0.0)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *SHRINK-FACTOR* FLOAT (/ *MAX-MOVEMENT* (+ 1.0 *MAX-MOVEMENT*)))"
     NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *WEIGHT-DECAY* FLOAT -1.0e-4)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *SIGMOID-PRIME-OFFSET* FLOAT 0.1)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
    ...
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     ...
     NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *SAVED-NET* PROPOSITION-NEURAL-NETWORK NULL)" NULL)
