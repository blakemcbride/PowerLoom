...
(CL:DEFVAR KWD-STRATEGIES-INITIALIZE NULL)
...
(CL:DEFVAR SGT-STRATEGIES-STELLA-CONS-ITERATOR NULL)
...
(CL:DEFVAR SGT-STRATEGIES-STELLA-THING NULL)
        ...
        (CL:AND
         ...
         (CL:NOT
          (CL:AND (CL:NOT (CL:EQ (%PARTIAL-MATCH-FRAME FRAME) NULL))
           (CL:NOT
            (CL:= (%MATCH-SCORE (%PARTIAL-MATCH-FRAME FRAME))
             NULL-FLOAT)))))
        (SET-FRAME-PARTIAL-TRUTH (%PARTIAL-MATCH-FRAME FRAME)
         TRUE-TRUTH-VALUE NULL-FLOAT CL:NIL))
       (CL:WHEN
...
(CL:DEFUN FINISH-CACHED-GOAL-PROCESSING (CACHEDGOAL FRAME SUCCESSORFAILURE CONTINUING?)
  (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *QUERYITERATOR*)
   ...
   (WRAP-FLOAT (%MATCH-SCORE CACHEDGOAL)) NULL-FLOAT-WRAPPER)
  (CL:SETF (%TRUTH-VALUE FRAME) (%TRUTH-VALUE CACHEDGOAL))
  (CL:WHEN (CL:NOT (CL:EQ (%PARTIAL-MATCH-FRAME FRAME) NULL))
   (SET-FRAME-PARTIAL-TRUTH (%PARTIAL-MATCH-FRAME FRAME)
    (%TRUTH-VALUE CACHEDGOAL) (%MATCH-SCORE CACHEDGOAL) CL:T))
  (CL:WHEN
   (CL:AND *RECORD-JUSTIFICATIONS?*
...
;;; (DEFUN (TSPP.INITIALIZE-STRATEGY ITERATOR) ...)

(CL:DEFUN TSPP.INITIALIZE-STRATEGY (FRAME)
  (CL:LET*
   ((PROPOSITION (%PROPOSITION FRAME))
    (ITERATOR
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME)
...
(CL:DEFUN TSPP.SPAWN-DERIVED-STRATEGIES (FRAME STATE)
  (CL:LET* ((PROPOSITION (%PROPOSITION FRAME)))
   (CL:WHEN
    (CL:AND (CL:EQ STATE KWD-STRATEGIES-INITIALIZE)
     (CL:AND (CL:NOT (CL:EQ *QUERYITERATOR* NULL))
      (CL:NOT (CL:EQ (%PARTIAL-MATCH-STRATEGY *QUERYITERATOR*) NULL)))
   ...
   (CL:WHEN
    (CL:AND (CL:EQ STATE KWD-STRATEGIES-FAILURE)
     (%REVERSE-POLARITY? FRAME)
     (CL:NOT
...
;;; (DEFUN (TSPP.SINGLE-VALUED-STRATEGY? BOOLEAN) ...)

(CL:DEFUN TSPP.SINGLE-VALUED-STRATEGY? (FRAME)
  (CL:LET* ((PROPOSITION (%PROPOSITION FRAME)))
   (CL:AND
    (CL:OR (ALL-ARGUMENTS-BOUND? PROPOSITION)
...
;;; (DEFUN TSPP.HANDLE-DEFAULT-RESULT ...)

(CL:DEFUN TSPP.HANDLE-DEFAULT-RESULT (FRAME)
  (CL:WHEN
   (CL:OR (CL:EQ (%TRUTH-VALUE FRAME) DEFAULT-TRUE-TRUTH-VALUE)
    (CL:EQ (%TRUTH-VALUE FRAME) DEFAULT-FALSE-TRUTH-VALUE))
   (CL:LET*
    ...
    (CL:LET* ((*DONTUSEDEFAULTKNOWLEDGE?* CL:T))
     ...
     (CL:WHEN (NEXT? ITERATOR)
      ...
      (CL:SETQ MATCHINGPROP (%VALUE ITERATOR))
      (CL:SETF
       (%VALUE
        (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME)
         SYM-STRATEGIES-STELLA-ITERATOR NULL))
...
;;; (DEFUN TSPP.RECORD-RESULT-JUSTIFICATION ...)

(CL:DEFUN TSPP.RECORD-RESULT-JUSTIFICATION (FRAME)
  (CL:WHEN *RECORD-JUSTIFICATIONS?*
   (CL:LET*
    ((PROPOSITION (%PROPOSITION FRAME))
     ...
     (MATCHINGPROP (%VALUE ITERATOR))
     (FORWARDJUST
      (GET-ONE-SUPPORTED-FORWARD-JUSTIFICATION MATCHINGPROP)))
    (CL:WHEN (CL:NOT (CL:EQ FORWARDJUST NULL))
     (PUSH (%JUSTIFICATIONS FRAME) FORWARDJUST))
    (CL:LET*
     ((IMPLICITJUST
       (CREATE-IMPLICIT-INFERENCE-JUSTIFICATION PROPOSITION
        MATCHINGPROP)))
     (CL:WHEN (CL:NOT (CL:EQ IMPLICITJUST NULL))
      (PUSH (%JUSTIFICATIONS FRAME) IMPLICITJUST))))))

;;; (DEFUN TSPP.PROPAGATE-RESULT-TRUTH-VALUE ...)

(CL:DEFUN TSPP.PROPAGATE-RESULT-TRUTH-VALUE (FRAME)
  (CL:LET*
   ((ITERATOR
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME)
      SYM-STRATEGIES-STELLA-ITERATOR NULL))
    (TRUTHVALUE (%TRUTH-VALUE FRAME)) (MATCHINGPROP (%VALUE ITERATOR))
   ...
   (CL:WHEN (CL:NOT (CL:EQ PMF NULL))
    (CL:LET*
     ...
     (SET-FRAME-PARTIAL-TRUTH PMF TRUTHVALUE SCORE CL:T)))))

;;; (DEFUN (TRY-SCAN-PROPOSITIONS-PROOF KEYWORD) ...)

(CL:DEFUN TRY-SCAN-PROPOSITIONS-PROOF (FRAME)
  (CL:LET*
   ((PROPOSITION (%PROPOSITION FRAME)) (SINGLEVALUED? CL:NIL)
    (ITERATOR
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME)
      SYM-STRATEGIES-STELLA-ITERATOR NULL))
    (RESULT KWD-STRATEGIES-FAILURE))
   (CL:WHEN (CL:EQ ITERATOR NULL)
    (CL:SETQ ITERATOR (TSPP.INITIALIZE-STRATEGY FRAME))
    (CL:SETQ SINGLEVALUED? (TSPP.SINGLE-VALUED-STRATEGY? FRAME))
    (TSPP.SPAWN-DERIVED-STRATEGIES FRAME KWD-STRATEGIES-INITIALIZE))
   (CL:WHEN (CL:NOT (CL:EQ ITERATOR NULL))
    (CL:LOOP WHILE (NEXT? ITERATOR) DO
     (CL:WHEN
      (RELATION-AND-ARGUMENTS-UNIFY? (%VALUE ITERATOR) PROPOSITION
       CL:T)
      (CL:COND
       (SINGLEVALUED? (CL:SETQ RESULT KWD-STRATEGIES-FINAL-SUCCESS)
        (CL:RETURN))
       (CL:T (CL:SETQ RESULT KWD-STRATEGIES-CONTINUING-SUCCESS)
        (CL:RETURN))))))
   (CL:COND
    ((CL:EQ RESULT KWD-STRATEGIES-FAILURE)
     (TSPP.SPAWN-DERIVED-STRATEGIES FRAME KWD-STRATEGIES-FAILURE))
    ((CL:NOT (CL:EQ RESULT KWD-STRATEGIES-FAILURE))
     (CL:SETF (%TRUTH-VALUE FRAME)
      (PROPOSITIONS-ITERATOR-TRUTH-VALUE ITERATOR))
     (CL:WHEN
      (CL:OR (CL:EQ (%TRUTH-VALUE FRAME) DEFAULT-TRUE-TRUTH-VALUE)
       (CL:EQ (%TRUTH-VALUE FRAME) DEFAULT-FALSE-TRUTH-VALUE))
      (TSPP.HANDLE-DEFAULT-RESULT FRAME))
     (CL:WHEN *RECORD-JUSTIFICATIONS?*
      (TSPP.RECORD-RESULT-JUSTIFICATION FRAME))
     (TSPP.PROPAGATE-RESULT-TRUTH-VALUE FRAME)))
   RESULT))
   ...
   (CL:LET* ((*REVERSEPOLARITY?* (CL:NOT (%REVERSE-POLARITY? FRAME))))
    ...
    (CL:WHEN
     (CL:AND
      ...
      (ISA? (%PARTIAL-MATCH-STRATEGY *QUERYITERATOR*)
       SGT-STRATEGIES-LOGIC-WHYNOT-PARTIAL-MATCH))
     (CL:SETQ HASDISPROOF? (HAS-DISJOINTNESS-DISPROOF? FRAME)))
    (CL:WHEN (CL:NOT HASDISPROOF?)
     (CL:SETQ HASDISPROOF?
      (SUCCESS-RESULT? (TRY-SCAN-PROPOSITIONS-PROOF FRAME))))
    (CL:WHEN
     (CL:AND (CL:NOT HASDISPROOF?) *REVERSEPOLARITY?*
      (CL:OR (CL:EQ (%KIND PROPOSITION) KWD-STRATEGIES-FUNCTION)
       (SINGLE-VALUED-PREDICATE? PROPOSITION)))
     (CL:SETQ HASDISPROOF?
      (SUCCESS-RESULT? (TRY-SCAN-FOR-VALUE-CLASH-PROOF FRAME))))
    (CL:SETF (%REVERSE-POLARITY? FRAME)
     (CL:NOT (%REVERSE-POLARITY? FRAME)))
    (CL:WHEN
     (CL:AND HASDISPROOF? (%REVERSE-POLARITY? FRAME)
      (CL:NOT (CL:EQ (%STATE (%UP FRAME)) KWD-STRATEGIES-NOT)))
     (CL:SETF (%TRUTH-VALUE FRAME)
      (INVERT-TRUTH-VALUE (%TRUTH-VALUE FRAME)))
     (CL:LET* ((PMF (%PARTIAL-MATCH-FRAME FRAME)))
      (CL:WHEN (CL:NOT (CL:EQ PMF NULL))
       (SET-FRAME-PARTIAL-TRUTH PMF NULL
        (INVERT-MATCH-SCORE PMF (%MATCH-SCORE PMF)) CL:T)))))
   (CL:WHEN (CL:NOT HASDISPROOF?)
...
;;; (DEFUN (HAS-DISJOINTNESS-DISPROOF? BOOLEAN) ...)

(CL:DEFUN HAS-DISJOINTNESS-DISPROOF? (FRAME)
  (CL:LET* ((PROPOSITION (%PROPOSITION FRAME)) (HASDISPROOF? CL:NIL))
   (CL:WHEN (CL:EQ (%KIND PROPOSITION) KWD-STRATEGIES-ISA)
    (CL:COND
     ((CL:NOT *REVERSEPOLARITY?*)
      (CL:SETQ HASDISPROOF?
       (SUCCESS-RESULT? (TRY-ISA-PROPOSITION-PROOF FRAME))))
     (CL:T
      (CL:LET*
...
;;; (DEFUN (HAS-MORE-ANTECEDENTS? BOOLEAN) ...)

(CL:DEFUN HAS-MORE-ANTECEDENTS? (FRAME)
  (CL:LET*
   ((STRATEGY (%CURRENT-STRATEGY FRAME))
    (ITERATOR
     (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME)
      SYM-STRATEGIES-STELLA-ITERATOR NULL)))
   (CL:AND (CL:NOT (CL:EQ ITERATOR NULL))
    (CL:OR (CL:EQ STRATEGY KWD-STRATEGIES-ANTECEDENTS)
     (CL:EQ STRATEGY KWD-STRATEGIES-FULL-SUBQUERY))
    (ISA? ITERATOR SGT-STRATEGIES-STELLA-CONS-ITERATOR)
    (CL:NOT (EMPTY? ITERATOR)))))
   ...
   ((PROPOSITION (%PROPOSITION FRAME))
    ...
    (SCANISAPROPOSITIONS?
     (CL:AND
      ...
      (CL:NOT (CL:EQ SURROGATE SGT-STRATEGIES-STELLA-THING)))))
...
(CL:DEFUN TRY-SCAN-COLLECTION-PROOF (FRAME)
  (CL:LET*
   ...
   (CL:WHEN (CL:EQ ITERATOR NULL)
    (CL:LET* ((COLLECTION (EXTRACT-COLLECTION-ARGUMENT PROPOSITION)))
     (CL:SETQ ITERATOR
      (ALL-ASSERTED-COLLECTION-MEMBERS COLLECTION
       (INFERABLE? COLLECTION)))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME)
      SYM-STRATEGIES-STELLA-ITERATOR ITERATOR NULL)))
   (CL:LOOP WHILE (NEXT? ITERATOR) DO
    (CL:WHEN
     ...
     (CL:WHEN *RECORD-JUSTIFICATIONS?*
      (CL:LET*
       ((MATCHINGPROP (%PROPOSITION ITERATOR))
        (FORWARDJUST
         (GET-ONE-SUPPORTED-FORWARD-JUSTIFICATION MATCHINGPROP))
        (IMPLICITJUST
         (CREATE-IMPLICIT-INFERENCE-JUSTIFICATION PROPOSITION
...
(CL:DEFUN HELP-STARTUP-STRATEGIES1 ()
  (CL:PROGN
   ...
   (CL:SETQ KWD-STRATEGIES-INITIALIZE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "INITIALIZE" NULL 2))
...
(CL:DEFUN HELP-STARTUP-STRATEGIES2 ()
  (CL:PROGN
   ...
   (CL:SETQ SGT-STRATEGIES-STELLA-CONS-ITERATOR
   ...
   (CL:SETQ SGT-STRATEGIES-STELLA-THING
...
(CL:DEFUN HELP-STARTUP-STRATEGIES3 ()
  (CL:PROGN
   ...
   (DEFINE-FUNCTION-OBJECT "TSPP.INITIALIZE-STRATEGY"
    "(DEFUN (TSPP.INITIALIZE-STRATEGY ITERATOR) ((FRAME CONTROL-FRAME)))"
    (CL:FUNCTION TSPP.INITIALIZE-STRATEGY) NULL)
   (DEFINE-FUNCTION-OBJECT "TSPP.SPAWN-DERIVED-STRATEGIES"
    "(DEFUN TSPP.SPAWN-DERIVED-STRATEGIES ((FRAME CONTROL-FRAME) (STATE KEYWORD)))"
    (CL:FUNCTION TSPP.SPAWN-DERIVED-STRATEGIES) NULL)
   (DEFINE-FUNCTION-OBJECT "TSPP.SINGLE-VALUED-STRATEGY?"
    "(DEFUN (TSPP.SINGLE-VALUED-STRATEGY? BOOLEAN) ((FRAME CONTROL-FRAME)))"
    (CL:FUNCTION TSPP.SINGLE-VALUED-STRATEGY?) NULL)
   (DEFINE-FUNCTION-OBJECT "TSPP.HANDLE-DEFAULT-RESULT"
    "(DEFUN TSPP.HANDLE-DEFAULT-RESULT ((FRAME CONTROL-FRAME)))"
    (CL:FUNCTION TSPP.HANDLE-DEFAULT-RESULT) NULL)
   (DEFINE-FUNCTION-OBJECT "TSPP.RECORD-RESULT-JUSTIFICATION"
    "(DEFUN TSPP.RECORD-RESULT-JUSTIFICATION ((FRAME CONTROL-FRAME)))"
    (CL:FUNCTION TSPP.RECORD-RESULT-JUSTIFICATION) NULL)
   (DEFINE-FUNCTION-OBJECT "TSPP.PROPAGATE-RESULT-TRUTH-VALUE"
    "(DEFUN TSPP.PROPAGATE-RESULT-TRUTH-VALUE ((FRAME CONTROL-FRAME)))"
    (CL:FUNCTION TSPP.PROPAGATE-RESULT-TRUTH-VALUE) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "HAS-DISJOINTNESS-DISPROOF?"
    "(DEFUN (HAS-DISJOINTNESS-DISPROOF? BOOLEAN) ((FRAME CONTROL-FRAME)))"
    (CL:FUNCTION HAS-DISJOINTNESS-DISPROOF?) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "HAS-MORE-ANTECEDENTS?"
    "(DEFUN (HAS-MORE-ANTECEDENTS? BOOLEAN) ((FRAME CONTROL-FRAME)))"
    (CL:FUNCTION HAS-MORE-ANTECEDENTS?) NULL)
...
control stack before executing.\")" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *FAILED-GOAL-CUTOFFS* INTEGER 0)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *SUCCEEDED-GOAL-CUTOFFS* INTEGER 0)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
