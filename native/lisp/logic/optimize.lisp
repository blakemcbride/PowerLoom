...
incompleteness.\")" NULL)
    ...
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     ...
     NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFSPECIAL *OPTIMALGOALORDERINGRECURSIONS* INTEGER NULL)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *OPTIMAL-GOAL-ORDERING-CUTOFF* INTEGER 100)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
...
dynamically during a query, :DYNAMIC-WITH-CLUSTERING which also looks
for clusters (not yet implemented), and :NONE to indicate no optimization
should be performed.\" :DEMON-PROPERTY \"powerloom.queryOptimizationStrategy\")"
     NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
