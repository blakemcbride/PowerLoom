...
(CL:DEFUN ALL-DIRECT-TYPES (SELF)
  ...
  (MOST-SPECIFIC-NAMED-DESCRIPTIONS (COPY-CONS-LIST (ALL-TYPES SELF))))
...
satisfied by 'self'.\" :PUBLIC? TRUE)" (CL:FUNCTION ALL-TYPES) NULL)
   ...
   (DEFINE-FUNCTION-OBJECT "ALL-DIRECT-TYPES"
    "(DEFUN (ALL-DIRECT-TYPES (CONS OF LOGIC-OBJECT)) ((SELF OBJECT)) :DOCUMENTATION \"Return a set of most specific types that are satisfied by 'self'.\" :PUBLIC? TRUE)"
    (CL:FUNCTION ALL-DIRECT-TYPES) NULL)
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION LEVELLIZED-TEST-TYPE-ON-INSTANCE?))
    NULL)
   (DEFINE-METHOD-OBJECT
...
relations equivalent to 'relation'.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION LEVELLIZED-ALL-CLASS-INSTANCES))
    NULL)
   (DEFINE-METHOD-OBJECT
...
'relation' (a surrogate) applied to 'nMinusOneArguments' plus that last value.\")"
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION LEVELLIZED-ALL-RELATION-VALUES))
    NULL)
...
applied to 'arguments'.\")" (CL:FUNCTION TEST-RELATION-ON-ARGUMENTS?)
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE
     (CL:FUNCTION LEVELLIZED-TEST-RELATION-ON-ARGUMENTS?))
    NULL)
...
'relation' (a surrogate) applied to the instance 'self' (an object).\" :PUBLIC? TRUE)"
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE
     (CL:FUNCTION LEVELLIZED-GET-SLOT-MINIMUM-CARDINALITY))
    NULL)
   (DEFINE-METHOD-OBJECT
...
'relation' (a surrogate) applied to the instance 'self' (an object).\" :PUBLIC? TRUE)"
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE
     (CL:FUNCTION LEVELLIZED-GET-SLOT-MAXIMUM-CARDINALITY))
    NULL)
   (DEFINE-METHOD-OBJECT
...
of the slot 'relation' applied to 'self'.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION LEVELLIZED-ALL-SLOT-VALUE-TYPES))
    NULL)
   (DEFINE-METHOD-OBJECT
