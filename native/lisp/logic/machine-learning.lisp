...
(CL:DEFVAR KWD-MACHINE-LEARNING-MOVEOUT NULL)
...
(CL:DECLAIM
  ...
  *VISITED-PROPOSITIONS* *VISITED-INSTANCES* STANDARD-ERROR
  TRUE-TRUTH-VALUE DEFAULT-TRUE-TRUTH-VALUE FALSE-WRAPPER
  *CASE-ANTECEDENT-TABLE* *CASE-TYPES-TABLE* *LOG-MATCH-RULES*
  *DROP-FUNCTION-VALUES?* *FAIL-UNBOUND-CLAUSES?* TRUE-WRAPPER *MODULE*
  NIL STANDARD-OUTPUT EOL NULL-FLOAT NULL-INTEGER))
...
(CL:DEFUN GET-CLASSIFICATION-RELATIONS (CONS-QUERY)
  (CL:LET*
   ((OPTIONS
     (LIST* KWD-MACHINE-LEARNING-MATCH-MODE KWD-MACHINE-LEARNING-BASIC
      KWD-MACHINE-LEARNING-MAXIMIZE-SCORE?
      SYM-MACHINE-LEARNING-STELLA-TRUE KWD-MACHINE-LEARNING-MOVEOUT
      (WRAP-INTEGER 100000) NIL))
    (QUERY (MAKE-QUERY NIL (COPY-CONS-TREE CONS-QUERY) NIL OPTIONS))
   ...
   (CL:LET* ((INSTANCE NULL) (ITER-000 (%THE-CONS-LIST INSTANCES)))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
     ...
     (CL:WHEN (TRUE? PROP)
      ...
      (CL:WHEN (CL:NOT (TRUE-TRUTH-VALUE? (CALL-ASK QUERY)))
       (CL:SETQ CORRECT? CL:NIL)
       (%%PRINT-STREAM (%NATIVE-STREAM STANDARD-OUTPUT)
  ...
  (CL:PROGN
   ...
   (CL:SETQ SYM-MACHINE-LEARNING-STELLA-TRUE
    (INTERN-RIGID-SYMBOL-WRT-MODULE "TRUE"
     (GET-STELLA-MODULE "/STELLA" CL:T) 0))
   (CL:SETQ KWD-MACHINE-LEARNING-MOVEOUT
  ...
  that should be returned and the module it should be evaluated in.\" :SLOTS ((QUERY :TYPE CONS) (CONCEPT :TYPE SYMBOL) (NAME :TYPE SYMBOL) (SCORE :TYPE PARTIAL-MATCH-SCORE) (MODULE :TYPE MODULE) (INPUT-FEATURES :TYPE LIST) (INPUT :TYPE VECTOR) (FACTS :TYPE (CONS OF CONS)) (NN-HIDDEN :TYPE (VECTOR OF FLOAT-WRAPPER)) (OUTPUT :TYPE OBJECT) (TEMP :TYPE FLOAT) (CACHED-SOLUTION :TYPE OBJECT) (TIMESTAMP :TYPE TIMESTAMP)))")))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
    ...
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     ...
     NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *CLOSED-WORLD-TRAINING-EXAMPLES* BOOLEAN TRUE)" NULL)
    ...
    (REGISTER-NATIVE-NAME SYM-MACHINE-LEARNING-LOGIC-APPROXIMATE
     KWD-MACHINE-LEARNING-COMMON-LISP KWD-MACHINE-LEARNING-FUNCTION)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *MAX-STRUCTURE-DEPTH* INTEGER 3)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *DROP-FUNCTION-VALUES?* BOOLEAN TRUE)" NULL)
    (REGISTER-NATIVE-NAME
