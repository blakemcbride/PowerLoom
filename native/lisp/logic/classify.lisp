...
storage object 'self'.\")" (WRAP-METHOD-CODE (CL:FUNCTION SET-MARKER))
    NULL)
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION TEST-MARKER?)) NULL)
...
recorded in 'self'.\")"
    (WRAP-METHOD-CODE (CL:FUNCTION RECALL-MARKED-OBJECTS)) NULL)
...
state of descriptions participating in a classification session.\" :TYPE CLASSIFICATION-SESSION :ALLOCATION :DYNAMIC)")
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION INTRODUCTION-TIMESTAMP)) NULL)
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION VIRGIN?)) NULL)
