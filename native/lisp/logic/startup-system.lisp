...
Ontolingua conventions.\" :USES (\"LOGIC\" \"STELLA\"))")
    ...
    (DEFINE-MODULE-FROM-STRINGIFIED-SOURCE "/CHAMELEON"
     "(:DOCUMENTATION \"Namespace for Chameleon relations\" :INCLUDES () :USES () :NICKNAME \"CHAM\" :PROTECT-SURROGATES? TRUE)")
    (DEFINE-MODULE-FROM-STRINGIFIED-SOURCE "/PLI"
     "(:DOCUMENTATION \"Defines the PowerLoom API.\" :USES (\"LOGIC\" \"STELLA\") :SHADOW (GET-OBJECT GET-RELATION GET-MODULE CHANGE-MODULE CLEAR-MODULE LOAD LOAD-IN-MODULE LOAD-STREAM LOAD-STREAM-IN-MODULE GET-RULES PRINT-RULES RUN-FORWARD-RULES SAVE-MODULE CREATE-OBJECT DESTROY-OBJECT REGISTER-SPECIALIST-FUNCTION REGISTER-COMPUTATION-FUNCTION ASSERT RETRACT CONCEIVE EVALUATE EVALUATE-STRING IS-TRUE IS-FALSE IS-UNKNOWN ASK RETRIEVE CREATE-ENUMERATED-SET RESET-POWERLOOM CLEAR-CACHES POWERLOOM GET-PROPERTY SET-PROPERTY PRINT-PROPERTIES) :API? TRUE :LISP-PACKAGE \"PLI\" :CPP-PACKAGE \"pli\" :JAVA-PACKAGE \"edu.isi.powerloom\" :JAVA-CATCHALL-CLASS \"PLI\" :CODE-ONLY? TRUE)"))
   (CL:LET*
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 7)
     (DEFINE-FUNCTION-OBJECT "STARTUP-LOGIC-SYSTEM"
      "(DEFUN STARTUP-LOGIC-SYSTEM () :PUBLIC? TRUE :C-CALLABLE? TRUE :C-NAMESPACE-PREFIX \"stella_\")"
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
     ...
     (CL:LET* ((PHASE NULL-INTEGER) (ITER-067 0) (UPPER-BOUND-068 9))
      (CL:DECLARE (CL:TYPE CL:FIXNUM PHASE ITER-067 UPPER-BOUND-068))
      (CL:LOOP WHILE (CL:<= ITER-067 UPPER-BOUND-068) DO
       (CL:SETQ PHASE ITER-067) (CL:SETQ *STARTUP-TIME-PHASE* PHASE)
       ...
       (STARTUP-QUERY) (STARTUP-JUSTIFICATIONS) (STARTUP-PARTIAL-MATCH)
       (STARTUP-MACHINE-LEARNING) (STARTUP-RULE-INDUCTION)
       (STARTUP-NEURAL-NETWORK) (STARTUP-CASE-BASED)
       (STARTUP-CHAMELEON) (STARTUP-GOAL-CACHES) (STARTUP-STRATEGIES)
       ...
       (STARTUP-TOOLS) (CL:SETQ ITER-067 (CL:1+ ITER-067))))
