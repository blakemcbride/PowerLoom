...
(CL:DEFVAR SYM-PARTIAL-MATCH-LOGIC-SCORE NULL)
...
(CL:DEFVAR SYM-PARTIAL-MATCH-LOGIC-NEURAL-NET NULL)
...
(CL:DEFVAR KWD-PARTIAL-MATCH-STATIC NULL)
...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *QUERY-OPTIMIZATION-STRATEGY*
  *ACTIVATED-NETWORKS* *MOST-RECENT-QUERY* STANDARD-ERROR *MODULE*
  NULL-INTEGER NIL UNKNOWN-TRUTH-VALUE *QUERYITERATOR*
  FALSE-TRUTH-VALUE DEFAULT-FALSE-TRUTH-VALUE NULL-FLOAT-WRAPPER
  TRUE-TRUTH-VALUE STANDARD-OUTPUT EOL TRUE-WRAPPER FALSE-WRAPPER
  NULL-FLOAT))
...
(CL:DEFUN ACCESS-PARTIAL-MATCH-FRAME-SLOT-VALUE (SELF SLOTNAME VALUE SETVALUE?)
  (CL:COND
   ...
   ((CL:EQ SLOTNAME SYM-PARTIAL-MATCH-LOGIC-MATCH-SCORE)
    (CL:IF SETVALUE?
...
(CL:DEFMETHOD CUTOFF-PARTIAL-MATCH? ((SELF PARTIAL-MATCH-FRAME) TRACE?)
  (CL:LET*
   ((SCORE (%MATCH-SCORE SELF)) (CUTOFF (%DYNAMIC-CUTOFF SELF))
    (CUTOFF? CL:NIL))
...
(CL:DEFMETHOD TRUTH-VALUE-SCORE ((SELF PARTIAL-MATCH-FRAME) TRUTHVALUE)
  (CL:IF (CL:EQ TRUTHVALUE TRUE-TRUTH-VALUE) 1.0d0 0.0d0))

;;; (DEFMETHOD (INVERT-MATCH-SCORE PARTIAL-MATCH-SCORE) ...)

(CL:DEFMETHOD INVERT-MATCH-SCORE ((SELF PARTIAL-MATCH-FRAME) SCORE)
...
;;; (DEFMETHOD (COMPUTE-ASSERTION-SCORE PARTIAL-MATCH-SCORE) ...)

(CL:DEFMETHOD COMPUTE-ASSERTION-SCORE ((SELF PARTIAL-MATCH-FRAME) PROPOSITION TRUTHVALUE)
  ...
  (CL:WHEN (CL:EQ TRUTHVALUE NULL)
   (CL:ERROR
    "Safety violation: INTERNAL ERROR: missing truth value for assertion"))
  (CL:LET*
   ((SCORE
     (ACCESS-IN-CONTEXT
      (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROPOSITION)
       SYM-PARTIAL-MATCH-LOGIC-SCORE NULL)
      (%HOME-CONTEXT PROPOSITION) CL:NIL))
    (WEIGHT (PROPOSITION-WEIGHT SELF PROPOSITION)))
   (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT WEIGHT))
   (CL:COND
    ((CL:EQ SCORE NULL)
     (CL:SETQ SCORE (WRAP-FLOAT (TRUTH-VALUE-SCORE SELF TRUTHVALUE))))
    ((CL:OR (CL:EQ TRUTHVALUE FALSE-TRUTH-VALUE)
      (CL:EQ TRUTHVALUE DEFAULT-FALSE-TRUTH-VALUE))
     (CL:SETQ SCORE
      (WRAP-FLOAT (INVERT-MATCH-SCORE SELF (%WRAPPER-VALUE SCORE))))))
   (CL:* (%WRAPPER-VALUE SCORE) WEIGHT)))
...
(CL:DEFMETHOD DEFINED-FRAME-PARTIAL-TRUTH? ((SELF CONTROL-FRAME))
  (CL:AND (CL:NOT (CL:EQ (%PARTIAL-MATCH-FRAME SELF) NULL))
   (CL:NOT
    (CL:= (%MATCH-SCORE (%PARTIAL-MATCH-FRAME SELF)) NULL-FLOAT))))

;;; (DEFMETHOD (DEFINED-FRAME-PARTIAL-TRUTH? BOOLEAN) ...)

(CL:DEFMETHOD DEFINED-FRAME-PARTIAL-TRUTH? ((SELF PARTIAL-MATCH-FRAME))
  (CL:NOT (CL:= (%MATCH-SCORE SELF) NULL-FLOAT)))

;;; (DEFMETHOD SET-FRAME-PARTIAL-TRUTH ...)

(CL:DEFMETHOD SET-FRAME-PARTIAL-TRUTH ((SELF PARTIAL-MATCH-FRAME) TRUTHVALUE SCORE IGNOREPOLARITY?)
  (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT SCORE))
  #+MCL
  (CL:CHECK-TYPE SCORE CL:DOUBLE-FLOAT)
  (CL:LET*
   ...
   (CL:WHEN
    (CL:AND (CL:= SCORE NULL-FLOAT) (CL:NOT (CL:EQ TRUTHVALUE NULL)))
    (CL:SETQ SCORE (TRUTH-VALUE-SCORE SELF TRUTHVALUE)))
   (CL:WHEN FLIPPOLARITY?
    (CL:SETQ SCORE (INVERT-MATCH-SCORE SELF SCORE)))
   (CL:SETF (%MATCH-SCORE SELF) SCORE)
...
(CL:DEFMETHOD PROPAGATE-FRAME-PARTIAL-TRUTH ((SOURCE PARTIAL-MATCH-FRAME) TARGET)
  (CL:LET*
   ...
   (CL:SETF (%MATCH-SCORE TARGETPMF) (%MATCH-SCORE SOURCE))
   (CL:WHEN
    (CL:AND FLIPPOLARITY?
     (CL:OR
      (CL:NOT
       (UNKNOWN-TRUTH-VALUE? (%TRUTH-VALUE (%CONTROL-FRAME SOURCE))))
      (CL:NOT
       (CL:= (%MATCH-SCORE SOURCE)
        (TRUTH-VALUE-SCORE SOURCE UNKNOWN-TRUTH-VALUE)))))
    (CL:SETF (%MATCH-SCORE TARGETPMF)
     (INVERT-MATCH-SCORE SOURCE (%MATCH-SCORE SOURCE))))
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *QUERYITERATOR*)
    SYM-PARTIAL-MATCH-LOGIC-LATEST-POSITIVE-SCORE
    (WRAP-FLOAT (%MATCH-SCORE TARGETPMF)) NULL-FLOAT-WRAPPER)))
...
(CL:DEFMETHOD SET-CACHE-PARTIAL-TRUTH ((SELF PARTIAL-MATCH-FRAME) CACHE)
  (CL:SETF (%MATCH-SCORE CACHE) (%MATCH-SCORE SELF)))
...
(CL:DEFMETHOD SET-JUSTIFICATION-PARTIAL-TRUTH ((SELF PARTIAL-MATCH-FRAME) JUSTIFICATION)
  (CL:SETF (%MATCH-SCORE JUSTIFICATION) (%MATCH-SCORE SELF)))
...
(CL:DEFMETHOD TRUTH-VALUE-SCORE ((SELF INCREMENTAL-PARTIAL-MATCH) TRUTHVALUE)
  (%MATCH-SCORE TRUTHVALUE))

;;; (DEFMETHOD (INVERT-MATCH-SCORE PARTIAL-MATCH-SCORE) ...)

(CL:DEFMETHOD INVERT-MATCH-SCORE ((SELF INCREMENTAL-PARTIAL-MATCH) SCORE)
  (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT SCORE))
  #+MCL
  (CL:CHECK-TYPE SCORE CL:DOUBLE-FLOAT)
  (CL:- 0 SCORE))
    ...
    (CL:WHEN TEST-VALUE-000
     (CL:LET* ((RESULT (CREATE-DOWN-FRAME FRAME CONJUNCT)))
      ...
      (SET-FRAME-PARTIAL-TRUTH (%PARTIAL-MATCH-FRAME RESULT)
       UNKNOWN-TRUTH-VALUE 0.0d0 CL:T)
    ...
    ((CL:OR (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-TRUE)
     ...
     (CL:LET*
      ((SUCCESS? (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-TRUE))
       ...
       (SCORE (%MATCH-SCORE (%PARTIAL-MATCH-FRAME CONJUNCTFRAME)))
    ...
    ((CL:OR (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-TRUE)
     ...
     (CL:LET*
      ((SUCESS? (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-TRUE))
       ...
       (SCORE NULL-FLOAT))
      (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT SCORE))
      (CL:SETQ SCORE (%MATCH-SCORE (%PARTIAL-MATCH-FRAME RESULT)))
   ...
   (CL:COND
    ...
    ((CL:OR (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-TRUE)
     ...
     (CL:LET*
      ...
      (CL:SETF (%MATCH-SCORE RESULTPMF)
       (CL:* (%MATCH-SCORE RESULTPMF)
  ...
  (CL:LET*
   ...
   (CL:COND
    ...
    ((CL:OR (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-TRUE)
      (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-FAIL))
     (CL:SETQ SCORE
      (%MATCH-SCORE (%PARTIAL-MATCH-FRAME (%RESULT FRAME))))
     (PUSH-OR-PARTIAL-MATCH-SCORE SELF SCORE
      (PROPOSITION-WEIGHT SELF
       (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME)
...
(CL:DEFMETHOD CONTINUE-PARTIAL-FAIL-PROOF ((SELF INCREMENTAL-PARTIAL-MATCH) LASTMOVE)
  (CL:LET* ((FRAME (%CONTROL-FRAME SELF)))
   (CL:COND
    ((CL:EQ LASTMOVE KWD-PARTIAL-MATCH-DOWN) (SET-DYNAMIC-CUTOFF SELF))
    ((CL:OR (CL:EQ LASTMOVE KWD-PARTIAL-MATCH-UP-FAIL)
     ...
     (CL:LET*
      ((RESULT (%RESULT FRAME))
       ...
       (GOALSCORE
        (CL:* (%MATCH-SCORE RESULTPMF)
         (PROPOSITION-WEIGHT RESULTPMF (%PROPOSITION RESULT))))
       (FAILSCORE (INVERT-MATCH-SCORE SELF GOALSCORE)))
      (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT GOALSCORE FAILSCORE))
      (CL:COND
       ((CL:NOT
         (CL:EQ
          (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS FRAME)
          ...
          NULL))
        (CL:SETQ FAILSCORE
         (TRUTH-VALUE-SCORE SELF UNKNOWN-TRUTH-VALUE)))
       ((CL:= GOALSCORE (TRUTH-VALUE-SCORE SELF UNKNOWN-TRUTH-VALUE))
        (CL:SETQ FAILSCORE (TRUTH-VALUE-SCORE SELF TRUE-TRUTH-VALUE))))
      (CL:SETF (%MATCH-SCORE RESULTPMF) FAILSCORE)
      (PROPAGATE-FRAME-PARTIAL-TRUTH RESULTPMF FRAME)
      (CL:SETQ LASTMOVE KWD-PARTIAL-MATCH-UP-FAIL)))
    (CL:T
     (CL:LET* ((STREAM-000 (NEW-OUTPUT-STRING-STREAM)))
      ...
      (CL:WHEN
       (CL:EQ
        (DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP)
         SYM-PARTIAL-MATCH-LOGIC-NEURAL-NET NULL)
        NULL)
       (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS PROP)
        SYM-PARTIAL-MATCH-LOGIC-NEURAL-NET (CREATE-NEURAL-NETWORK PROP)
        NULL)))
     (CL:T)))
...
(CL:DEFUN COMPUTE-PARTIAL-MATCH-SCORE? (FRAME)
  (CL:LET*
   ...
   (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS *QUERYITERATOR*)
    SYM-PARTIAL-MATCH-LOGIC-LATEST-POSITIVE-SCORE (WRAP-FLOAT SCORE)
    NULL-FLOAT-WRAPPER)
   (CL:SETF (%MATCH-SCORE PARTIALMATCHFRAME) SCORE)
    ...
    (MAXIMIZESCORE?
     (CL:NOT
      (EQL? (LOOKUP (%OPTIONS QUERY) KWD-PARTIAL-MATCH-MAXIMIZE-SCORE?)
       FALSE-WRAPPER)))
    (EPSILON 0.001d0) (LATESTSCORE 0.0d0)
    (HIGHESTSCORE (TRUTH-VALUE-SCORE SELF FALSE-TRUTH-VALUE))
    ...
    (CL:LOOP
     (CL:WHEN (CL:NOT (NEXT? QUERY))
      (CL:WHEN (CL:= (LENGTH (%SOLUTIONS QUERY)) 0)
       (CL:SETQ HIGHESTSCORE (%MATCH-SCORE PARTIALMATCHFRAME)))
      (CL:RETURN))
...
(CL:DEFMETHOD COMPUTE-PARTIAL-TRUTH ((SELF NN-PARTIAL-MATCH) QUERY)
  (CL:WHEN
   (CL:NOT
    (CL:EQ *QUERY-OPTIMIZATION-STRATEGY* KWD-PARTIAL-MATCH-STATIC))
   (CL:WARN
    "Switching to static query optimization required by the NN partial matcher~%")
   (CL:SETQ *QUERY-OPTIMIZATION-STRATEGY* KWD-PARTIAL-MATCH-STATIC))
  (CL:LET*
   ...
   (CL:LET* ((*QUERYITERATOR* QUERY))
    ...
    (CL:LOOP (CL:SETQ *ACTIVATED-NETWORKS* (NEW-LIST))
     (SET-DYNAMIC-SLOT-VALUE (%DYNAMIC-SLOTS QUERY)
      SYM-PARTIAL-MATCH-LOGIC-LATEST-POSITIVE-SCORE (WRAP-FLOAT 0.0d0)
      NULL-FLOAT-WRAPPER)
   ...
   (CL:WHEN (CL:NOT (CL:EQ RESULT KWD-PARTIAL-MATCH-FAILURE))
    (CL:LET*
     ((PMF (%PARTIAL-MATCH-FRAME FRAME))
      ...
      (MATCHINGPROP (%VALUE ITERATOR))
      (SCORE (COMPUTE-ASSERTION-SCORE PMF MATCHINGPROP TRUTHVALUE)))
     (CL:DECLARE (CL:TYPE CL:DOUBLE-FLOAT SCORE))
     (CL:SETF (%TRUTH-VALUE FRAME) UNKNOWN-TRUTH-VALUE)
     (SET-FRAME-PARTIAL-TRUTH PMF UNKNOWN-TRUTH-VALUE SCORE CL:T)))
   RESULT))
...
(CL:DEFUN HELP-STARTUP-PARTIAL-MATCH1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-PARTIAL-MATCH-LOGIC-SCORE
   ...
   (CL:SETQ SYM-PARTIAL-MATCH-LOGIC-NEURAL-NET
...
(CL:DEFUN HELP-STARTUP-PARTIAL-MATCH2 ()
  (CL:PROGN
   ...
   (CL:SETQ KWD-PARTIAL-MATCH-STATIC
    (INTERN-RIGID-SYMBOL-WRT-MODULE "STATIC" NULL 2))
...
(CL:DEFUN HELP-STARTUP-PARTIAL-MATCH3 ()
  (CL:PROGN
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION SET-DYNAMIC-CUTOFF)) NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (TRUTH-VALUE-SCORE PARTIAL-MATCH-SCORE) ((SELF PARTIAL-MATCH-FRAME) (TRUTHVALUE TRUTH-VALUE)))"
    (WRAP-METHOD-CODE (CL:FUNCTION TRUTH-VALUE-SCORE)) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (INVERT-MATCH-SCORE PARTIAL-MATCH-SCORE) ((SELF PARTIAL-MATCH-FRAME) (SCORE PARTIAL-MATCH-SCORE)))"
   ...
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (COMPUTE-ASSERTION-SCORE PARTIAL-MATCH-SCORE) ((SELF PARTIAL-MATCH-FRAME) (PROPOSITION PROPOSITION) (TRUTHVALUE TRUTH-VALUE)))"
    (WRAP-METHOD-CODE (CL:FUNCTION COMPUTE-ASSERTION-SCORE)) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD CLEAR-FRAME-PARTIAL-TRUTH ((SELF PARTIAL-MATCH-FRAME)))"
    (WRAP-METHOD-CODE (CL:FUNCTION CLEAR-FRAME-PARTIAL-TRUTH)) NULL)
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION DEFINED-FRAME-PARTIAL-TRUTH?)) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (DEFINED-FRAME-PARTIAL-TRUTH? BOOLEAN) ((SELF PARTIAL-MATCH-FRAME)) :GLOBALLY-INLINE? TRUE (RETURN (DEFINED? (MATCH-SCORE SELF))))"
    (WRAP-METHOD-CODE (CL:FUNCTION DEFINED-FRAME-PARTIAL-TRUTH?)) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD SET-FRAME-PARTIAL-TRUTH ((SELF PARTIAL-MATCH-FRAME) (TRUTHVALUE TRUTH-VALUE) (SCORE PARTIAL-MATCH-SCORE) (IGNOREPOLARITY? BOOLEAN)))"
    (WRAP-METHOD-CODE (CL:FUNCTION SET-FRAME-PARTIAL-TRUTH)) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD PROPAGATE-FRAME-PARTIAL-TRUTH ((SOURCE PARTIAL-MATCH-FRAME) (TARGET CONTROL-FRAME)))"
    (WRAP-METHOD-CODE (CL:FUNCTION PROPAGATE-FRAME-PARTIAL-TRUTH))
    NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD TRACE-FRAME-PARTIAL-TRUTH ((SELF PARTIAL-MATCH-FRAME) (LASTMOVE KEYWORD) (STREAM OUTPUT-STREAM)))"
    (WRAP-METHOD-CODE (CL:FUNCTION TRACE-FRAME-PARTIAL-TRUTH)) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD SET-CACHE-PARTIAL-TRUTH ((SELF CONTROL-FRAME) (CACHE ATOMIC-GOAL-CACHE)))"
    (WRAP-METHOD-CODE (CL:FUNCTION SET-CACHE-PARTIAL-TRUTH)) NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION SET-JUSTIFICATION-PARTIAL-TRUTH))
    NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION CLEAR-FRAME-PARTIAL-TRUTH)) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (TRUTH-VALUE-SCORE PARTIAL-MATCH-SCORE) ((SELF INCREMENTAL-PARTIAL-MATCH) (TRUTHVALUE TRUTH-VALUE)))"
    (WRAP-METHOD-CODE (CL:FUNCTION TRUTH-VALUE-SCORE)) NULL)
   (DEFINE-METHOD-OBJECT
    "(DEFMETHOD (INVERT-MATCH-SCORE PARTIAL-MATCH-SCORE) ((SELF INCREMENTAL-PARTIAL-MATCH) (SCORE PARTIAL-MATCH-SCORE)))"
    (WRAP-METHOD-CODE (CL:FUNCTION INVERT-MATCH-SCORE)) NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION SKIP-AND-CLAUSE?)) NULL)
   (DEFINE-METHOD-OBJECT
...
(CL:DEFUN HELP-STARTUP-PARTIAL-MATCH4 ()
  (CL:PROGN
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION INITIALIZE-NN-PARTIAL-MATCH)) NULL)
   (DEFINE-METHOD-OBJECT
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION INITIALIZE-PARTIAL-MATCH-STRATEGY))
    NULL)
...
illegal queries and logical expressions.\" :PUBLIC? TRUE)"
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION RETRIEVE-PARTIAL-SOLUTIONS)) NULL)
   (DEFINE-METHOD-OBJECT
...
user-defined partial match implementations.\" :ABSTRACT? TRUE :SLOTS ((KIND :TYPE KEYWORD :REQUIRED? TRUE) (CONTROL-FRAME :TYPE CONTROL-FRAME :REQUIRED? TRUE) (PARENT :TYPE PARTIAL-MATCH-FRAME) (CHILD :TYPE PARTIAL-MATCH-FRAME) (MATCH-SCORE :TYPE PARTIAL-MATCH-SCORE :INITIALLY NULL) (POSITIVE-SCORE :RENAMES MATCH-SCORE :DOCUMENTATION \"For backwards compatibility\") (DYNAMIC-CUTOFF :TYPE FLOAT) (ARGUMENT-SCORES :TYPE (CONS OF FLOAT-WRAPPER) :INITIALLY NIL) (ARGUMENT-WEIGHTS :TYPE (CONS OF FLOAT-WRAPPER) :INITIALLY NIL) (UNBOUND-VARS :TYPE CONS :INITIALLY NIL) (SUCCESS? :TYPE BOOLEAN :INITIALLY FALSE)))")))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
    ...
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *PARTIAL-MATCH-MODE* KEYWORD :BASIC)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *GREEDY-NETWORK-PRUNING* BOOLEAN TRUE)" NULL)
    ...
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *RULE-COMBINATION* KEYWORD :MAX)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *PLANNING-MODE* BOOLEAN FALSE)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *PLANABLE-PREDICATES* CONS NIL)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *FAIL-UNBOUND-CLAUSES?* BOOLEAN FALSE)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
...
to 1.0 during partial match operations.\")" NULL)
    ...
    (REGISTER-NATIVE-NAME
     ...
     KWD-PARTIAL-MATCH-COMMON-LISP KWD-PARTIAL-MATCH-FUNCTION)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *AND-MISSED-A-BINDING* BOOLEAN FALSE)" NULL)
