...
(CL:DEFVAR |/PL-KERNEL-KB/SGT-ARITHMETIC-STELLA-=| NULL)
...
(CL:DEFUN |/PL-KERNEL-KB/COMPARE-INTERVAL-BOUNDS?| (RELATION X Y)
  ...
  (CL:WHEN (CL:EQ RELATION |/PL-KERNEL-KB/SGT-ARITHMETIC-STELLA-=|)
    ...
    (CL:LET*
     ...
     (CL:WHEN (CL:NOT (CL:EQ P1ARGVALUE NULL))
      (CL:IF (INTEGER? P1ARGVALUE)
       ...
       (CL:RETURN-FROM |/PL-KERNEL-KB/SUBSEQUENCE-SPECIALIST|
        |/PL-KERNEL-KB/KWD-ARITHMETIC-TERMINAL-FAILURE|))
      (CL:WHEN (CL:< P1 0) (CL:SETQ P1 (CL:+ SUPERLENGTH P1 1)))
     ...
     (CL:WHEN (CL:NOT (CL:EQ P2ARGVALUE NULL))
      ...
      (CL:WHEN
       (CL:OR (CL:> P2 SUPERLENGTH) (CL:< P2 0)
  ...
  (CL:LET*
   ...
   (CL:HANDLER-CASE
    (CL:RETURN-FROM |/PL-KERNEL-KB/STRING-TO-NUMBER-COMPUTATION|
     (WRAP-INTEGER-VALUE (PARSE-LONG-INTEGER NAME)))
    (CL:CONDITION ()))
   (CL:HANDLER-CASE
    (CL:RETURN-FROM |/PL-KERNEL-KB/STRING-TO-NUMBER-COMPUTATION|
     (WRAP-FLOAT (PARSE-FLOAT NAME)))
    (CL:CONDITION ()))
   NULL))
...
(CL:DEFUN |/PL-KERNEL-KB/HELP-STARTUP-ARITHMETIC1| ()
  (CL:PROGN
   ...
   (CL:SETQ |/PL-KERNEL-KB/SGT-ARITHMETIC-STELLA-=|
...
(CL:DEFUN |/PL-KERNEL-KB/HELP-STARTUP-ARITHMETIC2| ()
  (CL:PROGN
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE
     (CL:FUNCTION |/PL-KERNEL-KB/EVALUATE-TIGHTER-INTERVAL|))
    NULL)
   (DEFINE-METHOD-OBJECT
