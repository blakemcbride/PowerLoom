...
(CL:DECLAIM
  ...
  *CHARACTER-TYPE-TABLE* *MOST-RECENT-QUERY* *CONTEXT* STANDARD-OUTPUT
...
for forward-chained propositions."
  ...
  (CL:HANDLER-CASE
   (CL:LET*
    ...
    (CL:LET*
     ((JUSTIFICATIONS (GET-SUPPORTED-FORWARD-JUSTIFICATIONS PROP)))
...
Valid values are :TECHNICAL and :LAY\" :PUBLIC? TRUE)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     ...
     NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *EXPLANATION-TAB-STRING* STRING \"    \")" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
...
proposition will be printed on the same line.\")" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *EXPLANATION-ASSERTION-MARKER* STRING \"!\")" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *EXPLANATION-FAILURE-MARKER* STRING \"?\")" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *EXPLANATION-CUTOFF-MARKER* STRING \"x\")" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *EXPLANATION-INFERENCE-MARKER* STRING \" \")" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
    ...
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFSPECIAL *CURRENTJUSTIFICATION* JUSTIFICATION NULL)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
