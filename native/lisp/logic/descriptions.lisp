...
(CL:DEFVAR KWD-DESCRIPTIONS-TAIL NULL)
       ...
       (CL:WHEN
        ...
        (CL:IF (MEMBER? IOVARIABLES ARG1)
         (CL:IF (MEMBER? IOVARIABLES ARG2)
          (CL:WHEN (CL:EQ KIND KWD-DESCRIPTIONS-TAIL)
...
primitive description.\" :ALLOCATION :DYNAMIC)")
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION DESCRIPTION-NAME)) NULL)
   (DEFINE-METHOD-OBJECT
...
the logic system. Also return true for literal classes.\")"
   ...
   (DEFINE-METHOD-OBJECT
    ...
    (WRAP-METHOD-CODE (CL:FUNCTION FIND-DUPLICATE-NAMED-DESCRIPTION))
    NULL)
...
a list of quantified, typed variables.\")" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFSPECIAL *UNIFY-PROPOSITIONS?* BOOLEAN FALSE)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
