  ...
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
    ...
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *LOG-MATCH-RULES* BOOLEAN FALSE)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *LOG-ANTECEDENT-CONSTRUCTION* BOOLEAN FALSE)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *NUM-NEIGHBORS* INTEGER 3)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
    ...
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     ...
     NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT "(DEFGLOBAL *NUM-CASES* INTEGER 0)"
     NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *NUM-TRAINING-PER-CASE* INTEGER 12)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *CASE-VARIABLE-COUNTER* INTEGER 0)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *BASE-COUNTER* INTEGER 0)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
    ...
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     ...
     NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *SEEN-INSTANCES* (LIST OF SYMBOL) NULL)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *DELETED-CASE-VARIABLES* (LIST OF SYMBOL) NULL)" NULL)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
    ...
    (REGISTER-NATIVE-NAME SYM-CASE-BASED-LOGIC-CLEAR-SLOT-FROM-CLASS
     KWD-CASE-BASED-COMMON-LISP KWD-CASE-BASED-FUNCTION)
    (DEFINE-GLOBAL-VARIABLE-OBJECT
     "(DEFGLOBAL *PRINT-CASE-DISTANCES* BOOLEAN FALSE)" NULL)
