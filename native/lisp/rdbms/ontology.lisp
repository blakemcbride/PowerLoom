...
(CL:DEFVAR SYM-ONTOLOGY-RDBMS-?CONN NULL)
...
(CL:DEFUN STARTUP-ONTOLOGY ()
  (CL:LET*
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 2)
    ...
    (CL:SETQ SYM-ONTOLOGY-RDBMS-?CONN
     (INTERN-RIGID-SYMBOL-WRT-MODULE "?CONN" NULL 0))
...
`.odbc.ini'."))
     ...
     (%DEFFUNCTION
      (CONS-LIST (COPY-CONS-TREE SYM-ONTOLOGY-RDBMS-DB-CONNECTION)
       (COPY-CONS-TREE
        (GET-QUOTED-TREE "(((?DB DATABASE)) \"/RDBMS\")" "/RDBMS"))
       KWD-ONTOLOGY--> (COPY-CONS-TREE SYM-ONTOLOGY-RDBMS-?CONN)
       KWD-ONTOLOGY-DOCUMENTATION
       (COPY-CONS-TREE
        (WRAP-STRING
