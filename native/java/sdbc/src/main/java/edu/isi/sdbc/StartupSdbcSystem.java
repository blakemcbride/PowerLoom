      ...
      { Object old$Module$000 = Stella.$MODULE$.get();
        ...
        try {
          ...
          if (Stella.currentStartupTimePhaseP(7)) {
            Stella.defineFunctionObject("STARTUP-SDBC-SYSTEM", "(DEFUN STARTUP-SDBC-SYSTEM () :PUBLIC? TRUE :C-CALLABLE? TRUE :C-NAMESPACE-PREFIX \"stella_\")", Native.find_java_method("edu.isi.sdbc.StartupSdbcSystem", "startupSdbcSystem", new java.lang.Class [] {}), null);
