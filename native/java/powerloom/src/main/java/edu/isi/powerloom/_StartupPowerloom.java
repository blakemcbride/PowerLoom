    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(2)) {
          ...
          PowerLoom.KWD_ROOT_DIRECTORY = ((Keyword)(GeneralizedSymbol.internRigidSymbolWrtModule("ROOT-DIRECTORY", null, 2)));
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFGLOBAL *POWERLOOM-EXTENSION-SYSTEMS* (CONS OF STRING-WRAPPER) (CONS-LIST \"SDBC\" \"RDBMS\") :DOCUMENTATION \"List of extension systems that can be loaded\ndynamically (not yet in C++).\" :PUBLIC? TRUE)", null);
          ...
          if (Stella.getSystemDefinition("powerloom", false) != null) {
            Stella.defineLogicalHostProperty("PL", PowerLoom.KWD_ROOT_DIRECTORY, StringWrapper.wrapString(SystemDefinition.findSystemRootDirectory(Stella.getSystemDefinition("powerloom", true))));
          }
        }
