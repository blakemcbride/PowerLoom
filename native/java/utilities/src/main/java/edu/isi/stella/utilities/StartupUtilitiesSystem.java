      ...
      { Object old$Module$000 = Stella.$MODULE$.get();
        ...
        try {
          ...
          if (Stella.currentStartupTimePhaseP(7)) {
            Stella.defineFunctionObject("STARTUP-UTILITIES-SYSTEM", "(DEFUN STARTUP-UTILITIES-SYSTEM () :PUBLIC? TRUE :C-CALLABLE? TRUE :C-NAMESPACE-PREFIX \"stella_\")", Native.find_java_method("edu.isi.stella.utilities.StartupUtilitiesSystem", "startupUtilitiesSystem", new java.lang.Class [] {}), null);
