    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFGLOBAL *TEXINFO-STYLE-FEATURES* (LIST OF KEYWORD) (LIST) :DOCUMENTATION \"A list of features that can modulate some aspects of\nhow certain objects are described.  Currently understood features:\n:INFIX-PARAMETER-LISTS.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *TEXINFO-WORD-DELIMITERS* STRING NULL)", null);
          ...
          Stella.defineGlobalVariableObject("(DEFSPECIAL *MANUAL-OUTPUT-LANGUAGE* KEYWORD :TEXINFO)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *DOCUMENTED-OBJECTS-REGISTRY* HASH-TABLE (NEW HASH-TABLE))", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *MANUAL-OUTPUT-STREAM* OUTPUT-STREAM NULL)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *MANUAL-TEMPLATE-COMMAND-PREFIX* STRING \"#$\")", null);
        }
