      ...
      { Object old$Module$000 = Stella.$MODULE$.get();
        ...
        try {
          ...
          if (Stella.currentStartupTimePhaseP(7)) {
            Stella.defineFunctionObject("STARTUP-POWERLOOM-EXTENSIONS-SYSTEM", "(DEFUN STARTUP-POWERLOOM-EXTENSIONS-SYSTEM () :PUBLIC? TRUE :C-CALLABLE? TRUE :C-NAMESPACE-PREFIX \"stella_\")", Native.find_java_method("edu.isi.powerloom.extensions.StartupPowerloomExtensionsSystem", "startupPowerloomExtensionsSystem", new java.lang.Class [] {}), null);
