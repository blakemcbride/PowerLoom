    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          Stella.defineMethodObject("(DEFMETHOD (GENERATE-SPECIALIZED-TERM OBJECT) ((SELF DIM-NUMBER-LOGIC-WRAPPER)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.extensions.units.DimNumberLogicWrapper", "generateSpecializedTerm", new java.lang.Class [] {})), null);
          Stella.defineMethodObject("(DEFMETHOD (HASH-CODE INTEGER) ((SELF DIM-NUMBER-LOGIC-WRAPPER)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.extensions.units.DimNumberLogicWrapper", "hashCode_", new java.lang.Class [] {})), null);
          Stella.defineMethodObject("(DEFMETHOD (OBJECT-EQL? BOOLEAN) ((SELF DIM-NUMBER-LOGIC-WRAPPER) (X OBJECT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.extensions.units.DimNumberLogicWrapper", "objectEqlP", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object")})), null);
          ...
          Stella.defineMethodObject("(DEFMETHOD (GET-UNIT STRING) ((SELF DIM-NUMBER-LOGIC-WRAPPER)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.extensions.units.DimNumberLogicWrapper", "getUnit", new java.lang.Class [] {})), null);
          Stella.defineMethodObject("(DEFMETHOD (GET-BASE-UNIT STRING) ((SELF DIM-NUMBER-LOGIC-WRAPPER)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.extensions.units.DimNumberLogicWrapper", "getBaseUnit", new java.lang.Class [] {})), null);
          Stella.defineMethodObject("(DEFMETHOD (GET-MAGNITUDE FLOAT) ((SELF DIM-NUMBER-LOGIC-WRAPPER) (UNITS STRING)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.extensions.units.DimNumberLogicWrapper", "getMagnitude", new java.lang.Class [] {Native.find_java_class("java.lang.String")})), null);
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFGLOBAL *DIM-NUMBER-HASH-TABLE* (STELLA-HASH-TABLE OF DIM-NUMBER DIM-NUMBER-LOGIC-WRAPPER) (NEW STELLA-HASH-TABLE) :DOCUMENTATION \"Table for interning dim number logic wrappers\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *MEASURE-INSTANCE-TABLE* (HASH-TABLE OF MEASURE LOGIC-OBJECT) (NEW HASH-TABLE) :DOCUMENTATION \"Mapping table from measure objects to their PowerLoom representation.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *INSTANCE-MEASURE-TABLE* (HASH-TABLE OF LOGIC-OBJECT MEASURE) (NEW HASH-TABLE) :DOCUMENTATION \"Mapping table from PowerLoom representations of measures to measure objects\")", null);
        }
