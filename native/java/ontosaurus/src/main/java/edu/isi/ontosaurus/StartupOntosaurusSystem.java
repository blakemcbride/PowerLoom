      ...
      { Object old$Module$000 = Stella.$MODULE$.get();
        ...
        try {
          ...
          if (Stella.currentStartupTimePhaseP(7)) {
            Stella.defineFunctionObject("STARTUP-ONTOSAURUS-SYSTEM", "(DEFUN STARTUP-ONTOSAURUS-SYSTEM () :PUBLIC? TRUE :C-CALLABLE? TRUE :C-NAMESPACE-PREFIX \"stella_\")", Native.find_java_method("edu.isi.ontosaurus.StartupOntosaurusSystem", "startupOntosaurusSystem", new java.lang.Class [] {}), null);
