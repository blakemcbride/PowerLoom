      ...
      { Object old$Module$000 = Stella.$MODULE$.get();
        ...
        try {
          ...
          if (Stella.currentStartupTimePhaseP(7)) {
            Stella.defineFunctionObject("STARTUP-RDBMS-SYSTEM", "(DEFUN STARTUP-RDBMS-SYSTEM () :PUBLIC? TRUE :C-CALLABLE? TRUE :C-NAMESPACE-PREFIX \"stella_\")", Native.find_java_method("edu.isi.powerloom.rdbms.StartupRdbmsSystem", "startupRdbmsSystem", new java.lang.Class [] {}), null);
