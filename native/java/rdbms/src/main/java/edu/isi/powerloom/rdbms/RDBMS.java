...
public class RDBMS {
  ...
  public static Symbol SYM_RDBMS_pCONN = null;
            ...
            try {
              ...
              { Object old$InvisibleassertionP$000 = Logic.$INVISIBLEASSERTIONp$.get();
                ...
                try {
                  ...
                  Native.setSpecial(Logic.$EVALUATIONMODE$, RDBMS.KWD_EXTENSIONAL_ASSERTION);
    ...
    try {
      { Object old$Module$000 = Stella.$MODULE$.get();
        ...
        try {
          ...
          { Module temp001 = Stella.getStellaModule("EELD-EDB", false);

            { Module temp000 = ((temp001 != null) ? temp001 : ((Module)(Stella.$MODULE$.get())));

              Native.setSpecial(Stella.$MODULE$, ((temp000 != null) ? temp000 : ((Module)(Stella.$MODULE$.get()))));
            }
          }
          Native.setSpecial(Stella.$CONTEXT$, ((Module)(Stella.$MODULE$.get())));
