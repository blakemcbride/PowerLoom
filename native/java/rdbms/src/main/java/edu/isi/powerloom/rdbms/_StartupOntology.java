    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(2)) {
          ...
          RDBMS.SYM_RDBMS_pCONN = ((Symbol)(GeneralizedSymbol.internRigidSymbolWrtModule("?CONN", null, 0)));
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          { Object old$Module$001 = Stella.$MODULE$.get();
            ...
            try {
              ...
              Logic.deffunction(Cons.cons(((Symbol)(Stella_Object.copyConsTree(RDBMS.SYM_RDBMS_DB_CONNECTION))), Cons.cons(((Cons)(Stella_Object.copyConsTree(Stella.getQuotedTree("(((?DB DATABASE)) \"/RDBMS\")", "/RDBMS")))), Cons.cons(RDBMS.KWD__g, Cons.cons(((Symbol)(Stella_Object.copyConsTree(RDBMS.SYM_RDBMS_pCONN))), Cons.cons(RDBMS.KWD_DOCUMENTATION, Cons.cons(((StringWrapper)(Stella_Object.copyConsTree(StringWrapper.wrapString("A connection id produced by using the rest of the information\nassociated with the database.  This relation is transient, i.e., it can be\nreset dynamically, whereas the other relations should not change.")))), Cons.cons(RDBMS.KWD_AXIOMS, Cons.cons(((Cons)(Stella_Object.copyConsTree(Stella.getQuotedTree("((HIDDEN-RELATION DB-CONNECTION) \"/RDBMS\")", "/RDBMS")))), Stella.NIL)))))))));
