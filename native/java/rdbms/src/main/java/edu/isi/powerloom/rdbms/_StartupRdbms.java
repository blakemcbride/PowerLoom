  ...
  static void helpStartupRdbms1() {
    {
      ...
      RDBMS.KWD_EXTENSIONAL_ASSERTION = ((Keyword)(GeneralizedSymbol.internRigidSymbolWrtModule("EXTENSIONAL-ASSERTION", null, 2)));
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          _StartupRdbms.helpStartupRdbms4();
