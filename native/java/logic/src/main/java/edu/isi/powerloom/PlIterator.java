...
public class PlIterator extends Iterator {
   ...
   * This is here primarily to support the <code>isDDD</code> naming convention for tests.
   * @param self
   * @return boolean
   */
  public static boolean plIteratorIsEmpty(PlIterator self) {
  ...
  /** C-callable iterator <code>value</code>-slot accessor.
   * @param self
   * @return Stella_Object
   */
  public static Stella_Object plIteratorValue(PlIterator self) {
    return (self.value);
  }
