  ...
  static void helpStartupSpecialize3() {
    {
      ...
      Stella.defineMethodObject("(DEFMETHOD (NEXT? BOOLEAN) ((SELF TRUE-PROPOSITIONS-ITERATOR)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.TruePropositionsIterator", "nextP", new java.lang.Class [] {})), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD (NEXT? BOOLEAN) ((SELF SPECIALIZING-PROPOSITIONS-ITERATOR)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.SpecializingPropositionsIterator", "nextP", new java.lang.Class [] {})), null);
      ...
      Stella.defineFunctionObject("RELATION-AND-ARGUMENTS-UNIFY?", "(DEFUN (RELATION-AND-ARGUMENTS-UNIFY? BOOLEAN) ((SUBPROPOSITION PROPOSITION) (REFERENCEPROPOSITION PROPOSITION) (DONTUNIFYRELATION? BOOLEAN)))", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "relationAndArgumentsUnifyP", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition"), Native.find_java_class("edu.isi.powerloom.logic.Proposition"), java.lang.Boolean.TYPE}), null);
      Stella.defineFunctionObject("ARGUMENTS-UNIFY-WITH-ARGUMENTS?", "(DEFUN (ARGUMENTS-UNIFY-WITH-ARGUMENTS? BOOLEAN) ((SUBPROPOSITION PROPOSITION) (REFERENCEPROPOSITION PROPOSITION)) :DOCUMENTATION \"Return TRUE if the arguments in proposition 'subProposition' unify with\nthose in 'referenceProposition'.  If one of the propositions is a HOLDS, the other one\nhas to be also for unification to succeed.\" :GLOBALLY-INLINE? TRUE (RETURN (RELATION-AND-ARGUMENTS-UNIFY? SUBPROPOSITION REFERENCEPROPOSITION TRUE)))", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "argumentsUnifyWithArgumentsP", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition"), Native.find_java_class("edu.isi.powerloom.logic.Proposition")}), null);
      ...
      Stella.defineFunctionObject("TRUE-TO-CONCEIVED-PROPOSITIONS-ITERATOR", "(DEFUN (TRUE-TO-CONCEIVED-PROPOSITIONS-ITERATOR (ITERATOR OF PROPOSITION)) ((SELF (ITERATOR OF PROPOSITION))))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "trueToConceivedPropositionsIterator", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Iterator")}), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD (NEXT? BOOLEAN) ((SELF TRANSITIVE-CLOSURE-ITERATOR)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.TransitiveClosureIterator", "nextP", new java.lang.Class [] {})), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD (NEXT? BOOLEAN) ((SELF SUPPORTED-CLOSURE-ITERATOR)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.SupportedClosureIterator", "nextP", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (NEXT? BOOLEAN) ((SELF DIRECTLY-LINKED-OBJECTS-ITERATOR)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.DirectlyLinkedObjectsIterator", "nextP", new java.lang.Class [] {})), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD (NEXT? BOOLEAN) ((SELF CLASHING-PROPOSITIONS-ITERATOR)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.ClashingPropositionsIterator", "nextP", new java.lang.Class [] {})), null);
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFCONSTANT EMPTY-PROPOSITIONS-ITERATOR (ITERATOR OF PROPOSITION) (NEW TRUE-PROPOSITIONS-ITERATOR) :DOCUMENTATION \"This iterator returns no values whenever its called.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *IMPLICATION-SUBSUMPTION-GRAPH* TAXONOMY-GRAPH NULL)", null);
