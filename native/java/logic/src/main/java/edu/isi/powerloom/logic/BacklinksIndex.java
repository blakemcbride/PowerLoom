    ...
    { HashTable table = index.predicatePropositionsTable;
      ...
      if (proposition.kind == Logic.KWD_ISA) {
        ...
        { Surrogate surrogate = ((Surrogate)(proposition.operator));
          ...
          if (surrogate == Logic.SGT_PL_KERNEL_KB_EQUIVALENT) {
            { Stella_Object arg = null;
              ...
              for (;index000 < length000; index000 = index000 + 1) {
                ...
                if (Logic.functionOutputSkolemP(arg)) {
                  BacklinksIndex.addDependentPropositionToSpecializedIndex(index, ((Skolem)(arg)).definingProposition, argument);
                }
              }
            }
          }
