    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFGLOBAL *LOG-MATCH-RULES* BOOLEAN FALSE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *LOG-ANTECEDENT-CONSTRUCTION* BOOLEAN FALSE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *NUM-NEIGHBORS* INTEGER 3)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CASE-SOLUTION-COMBINATION* KEYWORD :WEIGHTED-VOTE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CASE-RULE-NAMES* (LIST OF SYMBOL) (NEW (LIST OF SYMBOL)))", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *NUM-CASES* INTEGER 0)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *NUM-TRAINING-PER-CASE* INTEGER 12)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CASE-VARIABLE-COUNTER* INTEGER 0)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *BASE-COUNTER* INTEGER 0)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *VISITED-INSTANCES* (LIST OF SYMBOL) (NEW (LIST OF SYMBOL)))", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *ONLY-VARIABLIZE-VISITED-INSTANCES* BOOLEAN FALSE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *VISITED-PROPOSITIONS* (LIST OF PROPOSITION) (NEW (LIST OF PROPOSITION)))", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *SEEN-INSTANCES* (LIST OF SYMBOL) NULL)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *DELETED-CASE-VARIABLES* (LIST OF SYMBOL) NULL)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *SYMBOL-VARIABLE-HASH-TABLE* (HASH-TABLE OF SYMBOL SYMBOL) NULL)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CASE-ANTECEDENT-TABLE* (STRING-HASH-TABLE OF STRING (LIST OF CONS)) (NEW (STRING-HASH-TABLE OF STRING (LIST OF CONS))))", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CASE-TYPES-TABLE* (STRING-HASH-TABLE OF STRING (LIST OF SYMBOL)) (NEW (STRING-HASH-TABLE OF STRING (LIST OF SYMBOL))))", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CASE-NAME-TABLE* (HASH-TABLE OF SYMBOL (LIST OF SYMBOL)) (NEW (HASH-TABLE OF SYMBOL (LIST OF SYMBOL))))", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *PRINT-CASE-DISTANCES* BOOLEAN FALSE)", null);
        }
