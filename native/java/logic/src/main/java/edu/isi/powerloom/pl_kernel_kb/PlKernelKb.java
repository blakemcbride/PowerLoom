...
public class PlKernelKb {
  ...
  public static Surrogate SGT_STELLA_e = null;
                      ...
                      { boolean alwaysP000 = true;
                        ...
                        { PatternVariable var = null;
                          ...
                          loop000 : for (;index000 < length000; index000 = index000 + 1) {
                            ...
                            if (!(Logic.safeArgumentBoundTo(var) != null)) {
                              alwaysP000 = false;
                              break loop000;
                            }
                          }
  ...
  public static Keyword buggyDirectInstanceOfSpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
      Vector arguments = proposition.arguments;
      Stella_Object memberarg = (arguments.theArray)[0];
      Stella_Object member = Logic.argumentBoundTo(memberarg);
    ...
    { Vector arguments = frame.proposition.arguments;
      ...
      if ((lastmove == Logic.KWD_DOWN) &&
        ...
        { Stella_Object member = Logic.argumentBoundTo(memberarg);
          ...
          if ((member != null) &&
              (collection != null)) {
            if (Logic.allDirectTypes(member).memberP(collection)) {
              return (Logic.KWD_FINAL_SUCCESS);
            }
            else {
              return (Logic.KWD_TERMINAL_FAILURE);
            ...
            KeyValueList.setDynamicSlotValue(frame.dynamicSlots, Logic.SYM_STELLA_ITERATOR, Logic.allDirectTypes(member).allocateIterator(), null);
          }
        }
      }
      { Keyword instanceofvalue = PlKernelKb.instanceOfSpecialist(frame, lastmove);

        if ((instanceofvalue == Logic.KWD_CONTINUING_SUCCESS) ||
            (instanceofvalue == Logic.KWD_FINAL_SUCCESS)) {
          if (((Iterator)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_STELLA_ITERATOR, null))) != null) {
            return (instanceofvalue);
          }
          else if (Logic.allDirectTypes(Logic.argumentBoundTo(memberarg)).memberP(Logic.argumentBoundTo(collectionarg))) {
            return (instanceofvalue);
          }
          else {
            return (Logic.KWD_MOVE_DOWN);
  ...
  public static Keyword assertedInstanceOfSpecialist(ControlFrame frame, Keyword lastmove) {
    lastmove = lastmove;
    { Proposition proposition = frame.proposition;
      Vector arguments = proposition.arguments;
      Stella_Object memberarg = (arguments.theArray)[0];
      ...
      if (iterator == null) {
        if (member != null) {
          iterator = Logic.allTrueDependentIsaPropositions(member);
        }
        else if ((collection != null) &&
            (Logic.classP(collection) &&
             Stella_Object.isaP(collection, Logic.SGT_LOGIC_NAMED_DESCRIPTION))) {
          iterator = NamedDescription.allTrueExtensionMembers(((NamedDescription)(collection)), false);
        }
        else {
          return (Logic.KWD_TERMINAL_FAILURE);
        }
      ...
      while (iterator.nextP()) {
        { Proposition isaprop = ((Proposition)(iterator.value));
          NamedDescription isatype = Logic.getDescription(((Surrogate)(isaprop.operator)));
          Stella_Object isaarg = (isaprop.arguments.theArray)[0];

          if (Proposition.assertedTrueP(isaprop) &&
              (Logic.bindArgumentToValueP(collectionarg, isatype, true) &&
               Logic.bindArgumentToValueP(memberarg, isaarg, true))) {
            if ((member == null) ||
                (collection == null)) {
              return (Logic.KWD_CONTINUING_SUCCESS);
            }
...
;
  ...
  public static Stella_Object thatComputation(Stella_Object p) {
    if (Surrogate.subtypeOfP(Stella_Object.safePrimaryType(p), Logic.SGT_LOGIC_PROPOSITION)) {
      { Proposition p000 = ((Proposition)(p));

        if (Proposition.allArgumentsBoundP(p000)) {
          { KeyValueMap mapping = KeyValueMap.newKeyValueMap();
            Proposition that = null;

            { Stella_Object arg = null;
              Vector vector000 = p000.arguments;
              int index000 = 0;
              int length000 = vector000.length();

              for (;index000 < length000; index000 = index000 + 1) {
                arg = (vector000.theArray)[index000];
                { Stella_Object value = Logic.safeArgumentBoundTo(arg);

                  if (!Stella_Object.eqlP(arg, value)) {
                    mapping.insertAt(arg, value);
                  }
                }
              }
            }
            that = Proposition.findMatchingNonDescriptiveProposition(p000, mapping);
            if ((that != null) &&
                Context.visibleFromP(that.homeModule(), ((Module)(Stella.$MODULE$.get())))) {
              return (that);
            }
          }
        }
      ...
      if (Surrogate.subtypeOfP(testValue000, Logic.SGT_LOGIC_PROPOSITION)) {
        { Proposition p000 = ((Proposition)(p));
          ...
          { Vector arguments = p000.arguments;
            ...
            if (i.wrapperValue < 0) {
              i = IntegerWrapper.wrapInteger(arity + i.wrapperValue);
            }
            if ((i.wrapperValue >= 0) &&
        ...
        { Skolem p000 = ((Skolem)(p));
          ...
          if (Logic.functionOutputSkolemP(p000)) {
            { Proposition prop = ((Skolem)(p000)).definingProposition;
              ...
              if (i.wrapperValue < 0) {
                i = IntegerWrapper.wrapInteger((arity + i.wrapperValue) - 1);
              }
              if ((i.wrapperValue >= 0) &&
  ...
  public static Keyword conceivedPropositionTermSpecialist(ControlFrame frame, Keyword lastmove) {
    lastmove = lastmove;
    { Vector arguments = frame.proposition.arguments;
      Stella_Object goalvalue = Logic.argumentBoundTo((arguments.theArray)[0]);
      Proposition goalprop = null;
      boolean holdsP = false;
      Stella_Object termarg = (arguments.theArray)[1];
      Iterator iterator = ((Iterator)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_STELLA_ITERATOR, null)));

      if ((goalvalue == null) ||
          (!Stella_Object.isaP(goalvalue, Logic.SGT_LOGIC_PROPOSITION))) {
        return (Logic.KWD_TERMINAL_FAILURE);
      }
      goalprop = ((Proposition)(goalvalue));
      holdsP = goalprop.operator == Logic.SGT_PL_KERNEL_KB_HOLDS;
      if (iterator == null) {
        if (holdsP) {
          { Vector goalarguments = goalprop.arguments;
            Stella_Object relation = Logic.argumentBoundTo((goalarguments.theArray)[0]);
            Stella_Object backlinkedarg = null;

            if (relation != null) {
              relation = Logic.objectSurrogate(relation);
              { Cons value000 = Stella.NIL;
                ...
                { int i = Stella.NULL_INTEGER;
                  ...
                  for (;iter000 <= upperBound000; iter000 = iter000 + 1) {
                    ...
                    if (collect000 == null) {
                      {
                        collect000 = Cons.cons(Logic.argumentBoundTo((goalarguments.theArray)[i]), Stella.NIL);
                        if (value000 == Stella.NIL) {
                          value000 = collect000;
                        }
                        else {
                      ...
                      {
                        collect000.rest = Cons.cons(Logic.argumentBoundTo((goalarguments.theArray)[i]), Stella.NIL);
                        collect000 = collect000.rest;
                      }
                    }
                  }
                }
                backlinkedarg = Logic.selectInstanceWithBacklinks(value000, ((Surrogate)(relation)));
              }
            }
            else {
              backlinkedarg = Proposition.selectArgumentWithBacklinks(goalprop, new Object[1]);
            }
            if (backlinkedarg != null) {
              iterator = Logic.unfilteredDependentPropositions(backlinkedarg, ((Surrogate)(relation))).allocateIterator();
            }
            else if (relation != null) {
              iterator = NamedDescription.allExtensionMembers(Logic.surrogateToDescription(((Surrogate)(relation))));
            }
          }
        }
        else {
          iterator = Logic.trueToConceivedPropositionsIterator(Proposition.allMatchingPropositions(goalprop));
        }
      ...
      if (iterator != null) {
        while (iterator.nextP()) {
          if (Context.visibleFromP(iterator.value.homeModule(), ((Context)(Stella.$CONTEXT$.get()))) &&
              (Proposition.allArgumentsBoundP(((Proposition)(iterator.value))) &&
               (Proposition.relationAndArgumentsUnifyP(((Proposition)(iterator.value)), goalprop, false) &&
                Logic.bindArgumentToValueP(termarg, iterator.value, true)))) {
            return (Logic.KWD_CONTINUING_SUCCESS);
          }
        }
      }
  ...
  public static Keyword collectMembersSpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
      ...
      { GeneralizedSymbol testValue000 = proposition.operator;
        ...
        else if (testValue000 == Logic.SGT_PL_KERNEL_KB_COUNT_MEMBERS) {
          countP = true;
        }
        else {
        }
                  ...
                  { boolean foundP000 = false;
                    ...
                    { PatternVariable v = null;
                      ...
                      loop000 : for (;index000 < length000; index000 = index000 + 1) {
                        ...
                        if (!(Logic.safeArgumentBoundTo(v) != null)) {
                          foundP000 = true;
                          break loop000;
                        }
                      }
      ...
      { Object old$Module$000 = Stella.$MODULE$.get();
        ...
        try {
          ...
          if (result != null) {
            if (countP) {
              result = IntegerWrapper.wrapInteger(((Skolem)(result)).definingProposition.arguments.length() - 1);
            }
          }
          else {
            if (uniqueP) {
            ...
            if (countP) {
              result = IntegerWrapper.wrapInteger(members.length());
            }
            else if (listP) {
              result = Logic.createLogicalList(members);
            }
            else {
              result = Logic.createEnumeratedSet(members);
            }
          }
        ...
        { int then = Stella.NULL_INTEGER;
          ...
          if (Stella_Object.integerP(n)) {
            ...
            if ((then >= 0) &&
              ...
              ((n == null) &&
               ((element != null) &&
                Logic.enumeratedSetP(collection)))) {
            { Stella_Object arg = null;
            ...
            { AllPurposeIterator iterator = ((AllPurposeIterator)(((Iterator)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_STELLA_ITERATOR, null)))));
              ...
              { Stella_Object element000 = null;
                AllPurposeIterator iter001 = iterator;

                while (iter001.nextP()) {
                  element000 = iter001.value;
                  if (iterator.iteratorInteger <= nargs) {
                    ...
                    if (Logic.bindArgumentToValueP(narg, IntegerWrapper.wrapInteger(then), true) &&
                        Logic.bindArgumentToValueP(elementarg, element000, true)) {
                      return (Logic.KWD_CONTINUING_SUCCESS);
                    }
                    else {
                      PatternRecord.unbindVariablesBeginningAt(patternrecord, ubstackoffset + 1);
...
;
  ...
  public static Context objectContextComputation(Stella_Object instance) {
    return (instance.homeModule());
  }

  public static Context objectNameContextComputation(Stella_Object instance) {
    { Surrogate namesymbol = Logic.objectSurrogate(Logic.valueOf(instance));
  ...
  public static Keyword istSpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
      ...
      if (lastmove == Logic.KWD_DOWN) {
        ...
        frame.down = adjunct.downFrame;
        Logic.getInferenceCache(((Context)(contextvalue)), Logic.KWD_JUST_IN_TIME);
  ...
  public static Stella_Object equivalentTermsComputation(Stella_Object term) {
    { Cons equivs = Cons.cons(term, Logic.getAllEquivalentValues(term));

      equivs = equivs.sort(Native.find_java_method("edu.isi.powerloom.logic.Logic", "logicFormLessP", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.stella.Stella_Object")}));
      return (Logic.createLogicalList(equivs.listify()));
    }
  }
  ...
  public static boolean compareIntervalBoundsP(Surrogate relation, Stella_Object x, Stella_Object y) {
    ...
    if (relation == PlKernelKb.SGT_STELLA_e) {
  ...
  public static NumberWrapper stringToNumberComputation(Stella_Object x, Stella_Object start, Stella_Object end) {
    { String name = null;
      ...
      try {
        return (Stella.wrapIntegerValue(Stella.parseLongInteger(name)));
      } catch (java.lang.Exception e000) {
      }
      try {
        return (FloatWrapper.wrapFloat(Stella.parseFloat(name)));
