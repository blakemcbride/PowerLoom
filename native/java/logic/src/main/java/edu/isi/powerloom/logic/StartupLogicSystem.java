  ...
  public static void startupLogicSystem() {
    synchronized (Stella.$BOOTSTRAP_LOCK$) {
      ...
      if (Stella.currentStartupTimePhaseP(1)) {
        ...
        Module.defineModuleFromStringifiedSource("/CHAMELEON", "(:DOCUMENTATION \"Namespace for Chameleon relations\" :INCLUDES () :USES () :NICKNAME \"CHAM\" :PROTECT-SURROGATES? TRUE)");
      ...
      { Object old$Module$000 = Stella.$MODULE$.get();
        ...
        try {
          ...
          if (Stella.currentStartupTimePhaseP(7)) {
            Stella.defineFunctionObject("STARTUP-LOGIC-SYSTEM", "(DEFUN STARTUP-LOGIC-SYSTEM () :PUBLIC? TRUE :C-CALLABLE? TRUE :C-NAMESPACE-PREFIX \"stella_\")", Native.find_java_method("edu.isi.powerloom.logic.StartupLogicSystem", "startupLogicSystem", new java.lang.Class [] {}), null);
          ...
          if (Stella.currentStartupTimePhaseP(9)) {
            ...
            { int phase = Stella.NULL_INTEGER;
              ...
              for (;iter069 <= upperBound070; iter069 = iter069 + 1) {
                phase = iter069;
                ...
                _StartupChameleon.startupChameleon();
