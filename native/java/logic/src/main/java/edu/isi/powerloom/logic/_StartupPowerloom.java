    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFGLOBAL *POWERLOOM-MAJOR-VERSION-NUMBER* INTEGER 5)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *POWERLOOM-MINOR-VERSION-NUMBER* INTEGER 0)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *POWERLOOM-RELEASE-STATE* STRING \"\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *POWERLOOM-PATCH-LEVEL* INTEGER 0)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *POWERLOOM-VERSION-STRING* STRING (CONCATENATE \"PowerLoom \" (INTEGER-TO-STRING *POWERLOOM-MAJOR-VERSION-NUMBER*) \".\" (INTEGER-TO-STRING *POWERLOOM-MINOR-VERSION-NUMBER*) \".\" (INTEGER-TO-STRING *POWERLOOM-PATCH-LEVEL*) *POWERLOOM-RELEASE-STATE*))", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *POWERLOOM-EXECUTION-MODE* KEYWORD :RELEASE :DOCUMENTATION \"Either :development, :debugging or :release (so far) which controls\nwhether certain internal error and warning messages are surfaced to the user.\" :DEMON-PROPERTY \"powerloom.executionMode\")", null);
          ...
          Stella.defineGlobalVariableObject("(DEFGLOBAL *POWERLOOM-LOCK* PROCESS-LOCK-OBJECT (MAKE-PROCESS-LOCK) :PUBLIC? TRUE :DOCUMENTATION \"Lock object for synchronizing safe multi-process access to PowerLoom\")", null);
        }
