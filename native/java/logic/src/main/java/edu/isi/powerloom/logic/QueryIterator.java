...
public class QueryIterator extends Iterator {
  ...
  public static Cons updatePropositionsFromQuery(QueryIterator query, Description description, Module module, Keyword updatemode, boolean recordjustificationsP) {
    ...
    { Description querydescription = query.queryDescription();
      ...
      boolean retractP = updatemode == Logic.KWD_RETRACT_TRUE;
      QuerySolutionTable solutions = query.solutions;
              ...
              { Proposition prop = null;
                ...
                for (;!(iter002 == Stella.NIL); iter002 = iter002.rest) {
                  ...
                  { Keyword thisupdatemode = updatemode;
                    ...
                    if (recordjustificationsP &&
                        (justification != null)) {
                      { ForwardJustification self007 = ForwardJustification.newForwardJustification();
                        ...
                        { ForwardJustification resultjustification = self007;
                          ...
                          Proposition.addForwardJustification(prop, resultjustification);
                        }
                      }
                    }
  ...
  /** Collect <code>queryiterator</code>s current solutions into a list of CONS tuples.
   * Only collect output values that have been bound as a result of the query, that is exclude
   * any bindings provided as initial values.  If <code>truthValuesP</code>, also return a list of truth
   * values for each solution (NIL otherwise).  If <code>justificationsP</code> and justifications are
   ...
   * @param queryiterator
   * @param truthvaluesP
   * @param justificationsP
   * @param MV_returnarray
   * @return Cons
   */
  public static Cons consifyCachedQuerySolutions(QueryIterator queryiterator, boolean truthvaluesP, boolean justificationsP, Object [] MV_returnarray) {
    ...
    { PropertyList options = queryiterator.options;
      ...
      int nunbound = 0;
      Vector inputbindings = ((Vector)(KeyValueList.dynamicSlotValue(queryiterator.dynamicSlots, Logic.SYM_LOGIC_INITIAL_BINDINGS, null)));
      ...
      if ((!(nunbound == 1)) ||
          (Stella_Object.eqlP(options.lookup(Logic.KWD_ATOMIC_SINGLETONSp), Stella.FALSE_WRAPPER) ||
           Stella_Object.eqlP(options.lookup(Logic.KWD_SINGLETONSp), Stella.FALSE_WRAPPER))) {
      ...
      { QuerySolution s = null;
        ...
        while (iter000.nextP()) {
          ...
          { Stella_Object v = null;
            ...
            loop002 : for (;index001 < length001; index001 = index001 + 1, iter001 = iter001 + 1) {
              v = (vector001.theArray)[index001];
              i = iter001;
              if ((inputbindings == null) ||
                  ((inputbindings.theArray)[i] == null)) {
                if (atomicsingletonsP) {
                  outputbindings = Cons.cons(v, outputbindings);
                  break loop002;
                }
                if (collect000 == null) {
                  {
                    ...
                    if (tuple == Stella.NIL) {
                      ...
                      Cons.addConsToEndOfConsList(tuple, collect000);
                    }
                  }
                }
                else {
      ...
      { Cons _return_temp = outputbindings.reverse();
        ...
        MV_returnarray[0] = (truthvaluesP ? truthvalues.reverse() : Stella.NIL);
        MV_returnarray[1] = (justificationsP ? justifications.reverse() : Stella.NIL);
        return (_return_temp);
      }
    }
  }
      ...
      { Stella_Object key = null;
        ...
        for (;!(iter000 == Stella.NIL); iter000 = iter000.rest.rest) {
          ...
          { GeneralizedSymbol testValue000 = ((GeneralizedSymbol)(key));
            ...
            if (testValue000 == Logic.KWD_TIMEOUT) {
            ...
            else if (testValue000 == Logic.KWD_VALUE_FORMAT) {
              if (Surrogate.subtypeOfP(Stella_Object.safePrimaryType(value), Logic.SGT_STELLA_GENERALIZED_SYMBOL)) {
                { GeneralizedSymbol value000 = ((GeneralizedSymbol)(value));

                  if (Stella.stringEqlP(value000.symbolName, "BARE")) {
                    theoptions.insertAt(key, Logic.KWD_BARE);
                  }
                  else if (Stella.stringEqlP(value000.symbolName, "READABLE")) {
                    theoptions.insertAt(key, Logic.KWD_READABLE);
                  }
                  else {
                    { OutputStringStream stream009 = OutputStringStream.newOutputStringStream();
                      ...
                      { Object old$PrintreadablyP$009 = Stella.$PRINTREADABLYp$.get();
                        ...
                        try {
                          Native.setBooleanSpecial(Stella.$PRINTREADABLYp$, true);
                          stream009.nativeStream.println("PARSING ERROR: Illegal :VALUE-FORMAT value: `" + value000 + "'.");
                ...
                { OutputStringStream stream010 = OutputStringStream.newOutputStringStream();
                  ...
                  { Object old$PrintreadablyP$010 = Stella.$PRINTREADABLYp$.get();
                    ...
                    try {
                      Native.setBooleanSpecial(Stella.$PRINTREADABLYp$, true);
                      stream010.nativeStream.println("PARSING ERROR: Illegal :VALUE-FORMAT value: `" + value + "'.");
              ...
              if (!(theoptions.lookup(key) != null)) {
                { OutputStringStream stream011 = OutputStringStream.newOutputStringStream();
                  ...
                  { Object old$PrintreadablyP$011 = Stella.$PRINTREADABLYp$.get();
                    ...
                    try {
                      Native.setBooleanSpecial(Stella.$PRINTREADABLYp$, true);
                      stream011.nativeStream.println("PARSING ERROR: Illegal :IF-EXISTS value: `" + value + "'.");
                ...
                if (Surrogate.subtypeOfP(testValue007, Logic.SGT_STELLA_GENERALIZED_SYMBOL)) {
                  ...
                  { OutputStringStream stream012 = OutputStringStream.newOutputStringStream();
                    ...
                    { Object old$PrintreadablyP$012 = Stella.$PRINTREADABLYp$.get();
                      ...
                      try {
                        Native.setBooleanSpecial(Stella.$PRINTREADABLYp$, true);
                        stream012.nativeStream.println("PARSING ERROR: Illegal :MATCH-MODE value: `" + value + "'.");
              ...
              { Surrogate testValue008 = Stella_Object.safePrimaryType(value);
                ...
                if (Surrogate.subtypeOfIntegerP(testValue008)) {
                  ...
                  { OutputStringStream stream013 = OutputStringStream.newOutputStringStream();

                    { Object old$PrintreadablyP$013 = Stella.$PRINTREADABLYp$.get();

                      try {
                        Native.setBooleanSpecial(Stella.$PRINTREADABLYp$, true);
                        stream013.nativeStream.println("PARSING ERROR: Illegal :MINIMUM-SCORE value: `" + value + "'.");
                        Logic.helpSignalPropositionError(stream013, Logic.KWD_ERROR);

                      } finally {
                        Stella.$PRINTREADABLYp$.set(old$PrintreadablyP$013);
                      }
                    }
                    throw ((ParsingError)(ParsingError.newParsingError(stream013.theStringReader()).fillInStackTrace()));
                  }
                }
              }
            }
              ...
              { Surrogate testValue009 = Stella_Object.safePrimaryType(value);
                ...
                if (Surrogate.subtypeOfIntegerP(testValue009)) {
                  ...
                  { OutputStringStream stream014 = OutputStringStream.newOutputStringStream();

                    { Object old$PrintreadablyP$014 = Stella.$PRINTREADABLYp$.get();

                      try {
                        Native.setBooleanSpecial(Stella.$PRINTREADABLYp$, true);
                        stream014.nativeStream.println("PARSING ERROR: Illegal :MAXIMUM-UNKNOWNS value: `" + value + "'.");
                        Logic.helpSignalPropositionError(stream014, Logic.KWD_ERROR);

                      } finally {
                        Stella.$PRINTREADABLYp$.set(old$PrintreadablyP$014);
                      }
                    }
                    throw ((ParsingError)(ParsingError.newParsingError(stream014.theStringReader()).fillInStackTrace()));
                  }
                }
              }
            }
                  ...
                  loop001 : for (;;) {
                    ...
                    if ((((QueryIterator)(Logic.$QUERYITERATOR$.get())) != null) &&
                      ...
                      solution.matchScore = (((baseframe.partialMatchFrame != null) &&
                          (baseframe.partialMatchFrame.matchScore != Stella.NULL_FLOAT)) ? baseframe.partialMatchFrame.matchScore : ((FloatWrapper)(KeyValueList.dynamicSlotValue(self.dynamicSlots, Logic.SYM_LOGIC_LATEST_POSITIVE_SCORE, Stella.NULL_FLOAT_WRAPPER))).wrapperValue);
                    }
...
;
  ...
  public static void printQueryIteratorTabSeparated(QueryIterator self, edu.isi.stella.javalib.NativeOutputStream stream) {
    { QuerySolutionTable solutions = self.solutions;
      char separator = '\t';
      boolean bareP = Logic.lookupQueryOptionWithDefault(self, Logic.KWD_VALUE_FORMAT, Logic.KWD_READABLE) == Logic.KWD_BARE;
            ...
            for (;iter000.nextP() &&
              ...
              { Stella_Object value = null;
                ...
                for (;index000 < length000; index000 = index000 + 1, iter002 = iter002 + 1) {
                  ...
                  if (bareP &&
                      Stella_Object.stringP(value)) {
                    stream.print(StringWrapper.unwrapString(((StringWrapper)(value))));
                  }
                  else {
                    stream.print(value);
                  }
...
;
  ...
  public static void printQueryIteratorSolutionOrnately(QueryIterator self, QuerySolution solution, int solutionnumber, edu.isi.stella.javalib.NativeOutputStream stream) {
    { int nsolutions = self.solutions.length();
      ...
      int maxdigits = Stella.integerLength10(((long)(nsolutions)));
      ...
      solnumberdigits = Stella.integerLength10(((long)(solutionnumber)));
      { Object old$PrintreadablyP$000 = Stella.$PRINTREADABLYp$.get();
