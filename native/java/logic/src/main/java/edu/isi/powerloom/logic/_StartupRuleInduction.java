    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFGLOBAL *RULE-INDUCTION-STRATEGY* KEYWORD :TOP-DOWN :DEMON-PROPERTY \"powerloom.learning.ruleInductionStrategy\" :PUBLIC? TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *SIGNATURE-STRATEGY* KEYWORD :TOP-DOWN :DEMON-PROPERTY \"powerloom.learning.ruleInductionSignatureStrategy\" :PUBLIC? TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *ENABLE-USER-THING* BOOLEAN TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *OPTIMIZE-INDUCED-QUERIES* BOOLEAN TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *SIMPLIFY-RULE-ANTECEDENT?* BOOLEAN FALSE :DOCUMENTATION \"Flag to control whether we try to simplify the rule antecedent.\nThis should be set to FALSE if we expect the user to edit the rule and\nTRUE if we want to have final rules as general as possible.\" :PUBLIC? TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *TRACE-ID3* BOOLEAN FALSE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *TRACE-FOIL* BOOLEAN FALSE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *INDUCE-RULES-FROM-SIGNATURES* BOOLEAN TRUE :DEMON-PROPERTY \"powerloom.learning.induceRulesFromSignatures\" :PUBLIC? TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *NUM-LGGS* INTEGER 2000)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *ENFORCE-LINKED-VARIABLES* BOOLEAN FALSE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *LOG-INDUCED-RULES* BOOLEAN FALSE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *ALLOW-RECURSIVE-DECISION-NODES* BOOLEAN TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *LOG-DECISION-RULE-CONSTRUCTION* BOOLEAN FALSE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL LOG_2 FLOAT 0.6931472)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *INDUCED-DECISION-RULES* (LIST OF CONS) NULL)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *INDUCED-RULE-COUNTER* INTEGER 0)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CANDIDATE-CLAUSES* (VECTOR OF CONS) NULL)", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *BOTTOM-UP-VARIABLE-COUNTER* INTEGER -1)", null);
        }
