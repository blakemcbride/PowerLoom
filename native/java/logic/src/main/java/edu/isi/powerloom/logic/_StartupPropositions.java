  ...
  static void helpStartupPropositions1() {
    {
      ...
      Logic.SYM_LOGIC_NATIVE_RELATION = ((Symbol)(GeneralizedSymbol.internRigidSymbolWrtModule("NATIVE-RELATION", null, 0)));
      ...
      Logic.SYM_LOGIC_NATIVE_RELATION_SETTER = ((Symbol)(GeneralizedSymbol.internRigidSymbolWrtModule("NATIVE-RELATION-SETTER", null, 0)));
  ...
  static void helpStartupPropositions2() {
    {
      ...
      Logic.SYM_LOGIC_PROPOSITION_NEURAL_NETWORK = ((Symbol)(GeneralizedSymbol.internRigidSymbolWrtModule("PROPOSITION-NEURAL-NETWORK", null, 0)));
      Logic.SYM_LOGIC_NEURAL_NETWORK = ((Symbol)(GeneralizedSymbol.internRigidSymbolWrtModule("NEURAL-NETWORK", null, 0)));
      Logic.SYM_LOGIC_NEURAL_NET = ((Symbol)(GeneralizedSymbol.internRigidSymbolWrtModule("NEURAL-NET", null, 0)));
  ...
  static void helpStartupPropositions5() {
    {
      ...
      { TruthValue self006 = TruthValue.newTruthValue();
        ...
        self006.polarity = Logic.KWD_TRUE;
        self006.strength = Logic.KWD_STRICT;
        self006.matchScore = 1.0;
        Logic.TRUE_TRUTH_VALUE = self006;
      }
      { TruthValue self007 = TruthValue.newTruthValue();

        self007.polarity = Logic.KWD_FALSE;
        self007.strength = Logic.KWD_STRICT;
        self007.matchScore = -1.0;
        Logic.FALSE_TRUTH_VALUE = self007;
      }
      { TruthValue self008 = TruthValue.newTruthValue();

        self008.polarity = Logic.KWD_TRUE;
        self008.strength = Logic.KWD_DEFAULT;
        self008.matchScore = 0.8;
        Logic.DEFAULT_TRUE_TRUTH_VALUE = self008;
      }
      { TruthValue self009 = TruthValue.newTruthValue();

        self009.polarity = Logic.KWD_FALSE;
        self009.strength = Logic.KWD_DEFAULT;
        self009.matchScore = -0.8;
        Logic.DEFAULT_FALSE_TRUTH_VALUE = self009;
      }
      { TruthValue self010 = TruthValue.newTruthValue();

        self010.polarity = Logic.KWD_UNKNOWN;
        Logic.UNKNOWN_TRUTH_VALUE = self010;
      }
      { TruthValue self011 = TruthValue.newTruthValue();

        self011.polarity = Logic.KWD_INCONSISTENT;
        self011.strength = Logic.KWD_STRICT;
        Logic.INCONSISTENT_TRUTH_VALUE = self011;
      }
      Logic.$SUPPRESSUNTYPEDTYPEERRORp$.setDefaultValue(new Boolean(false));
      { Proposition self012 = Proposition.newProposition();

        self012.kind = Logic.KWD_CONSTANT;
        self012.operator = Logic.SGT_STELLA_TRUE;
        self012.arguments = Vector.newVector(0);
        { Proposition object014 = self012;
          TruthValue value015 = Logic.TRUE_TRUTH_VALUE;
          Stella_Object oldValue016 = object014.truthValue;
          Stella_Object newValue017 = Stella_Object.updateInContext(oldValue016, value015, object014.homeContext, false);

          if (!((oldValue016 != null) &&
              (oldValue016.primaryType() == Logic.SGT_STELLA_CS_VALUE))) {
            object014.truthValue = newValue017;
          }
        }
        self012.homeContext = Logic.$PL_KERNEL_MODULE$;
        Logic.TRUE_PROPOSITION = self012;
      }
      { Proposition self018 = Proposition.newProposition();

        self018.kind = Logic.KWD_CONSTANT;
        self018.operator = Logic.SGT_STELLA_FALSE;
        self018.arguments = Vector.newVector(0);
        { Proposition object020 = self018;
          TruthValue value021 = Logic.FALSE_TRUTH_VALUE;
          Stella_Object oldValue022 = object020.truthValue;
          Stella_Object newValue023 = Stella_Object.updateInContext(oldValue022, value021, object020.homeContext, false);

          if (!((oldValue022 != null) &&
              (oldValue022.primaryType() == Logic.SGT_STELLA_CS_VALUE))) {
            object020.truthValue = newValue023;
          }
        }
        self018.homeContext = Logic.$PL_KERNEL_MODULE$;
        Logic.FALSE_PROPOSITION = self018;
      }
  ...
  static void helpStartupPropositions7() {
    {
      ...
      Stella.defineMethodObject("(DEFMETHOD (DELETED? BOOLEAN) ((SELF FORWARD-CHAINING-INDEX)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.ForwardChainingIndex", "deletedP", new java.lang.Class [] {})), null);
      Surrogate.defineInlineMethodCode(Logic.SGT_LOGIC_DESCRIPTION, Logic.SYM_LOGIC_NATIVE_RELATION, MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.Description", "nativeRelation", new java.lang.Class [] {})), null);
      Surrogate.defineInlineMethodCode(Logic.SGT_LOGIC_NAMED_DESCRIPTION, Logic.SYM_LOGIC_NATIVE_RELATION, MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.NamedDescription", "nativeRelation", new java.lang.Class [] {})), null);
      Surrogate.defineInlineMethodCode(Logic.SGT_LOGIC_NAMED_DESCRIPTION, Logic.SYM_LOGIC_NATIVE_RELATION_SETTER, MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.NamedDescription", "nativeRelationSetter", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Relation")})), null);
      ...
      Stella.defineExternalSlotFromStringifiedSource("(DEFSLOT CONTEXT MONOTONIC? :TYPE BOOLEAN :PUBLIC? TRUE :DOCUMENTATION \"Mark context as not allowing any retractions.\" :ALLOCATION :DYNAMIC)");
      ...
      Stella.defineMethodObject("(DEFMETHOD (ARITY INTEGER) ((SELF NAMED-DESCRIPTION)) :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.NamedDescription", "arity", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (ARITY INTEGER) ((SELF DESCRIPTION)) :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.Description", "arity", new java.lang.Class [] {})), null);
  ...
  static void helpStartupPropositions8() {
    {
      ...
      Stella.defineMethodObject("(DEFMETHOD (OBJECT-EQUAL? BOOLEAN) ((SELF SKOLEM) (OTHER OBJECT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.Skolem", "objectEqualP", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object")})), null);
      ...
      Stella.defineFunctionObject("ASSERTED-TRUE?", "(DEFUN (ASSERTED-TRUE? BOOLEAN) ((SELF PROPOSITION)) :DOCUMENTATION \"Return true if `self' has been asserted to be true.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "assertedTrueP", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition")}), null);
      Stella.defineFunctionObject("ASSERTED-FALSE?", "(DEFUN (ASSERTED-FALSE? BOOLEAN) ((SELF PROPOSITION)) :DOCUMENTATION \"Return true if `self' has been asserted to be false.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "assertedFalseP", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition")}), null);
  ...
  static void helpStartupPropositions9() {
    {
      ...
      Stella.defineFunctionObject("VERIFY-SKOLEM-AND-VALUE-TYPES", "(DEFUN VERIFY-SKOLEM-AND-VALUE-TYPES ((FROMSKOLEM SKOLEM) (TOVALUE OBJECT)))", Native.find_java_method("edu.isi.powerloom.logic.Skolem", "verifySkolemAndValueTypes", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Skolem"), Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
      Stella.defineFunctionObject("SKOLEM-WITH-VARIABLE-VALUE-CYCLE?", "(DEFUN (SKOLEM-WITH-VARIABLE-VALUE-CYCLE? BOOLEAN) ((SELF OBJECT)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "skolemWithVariableValueCycleP", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
      Stella.defineFunctionObject("SYNCHRONIZE-VARIABLE-VALUE-INFERENCE-CACHES", "(DEFUN SYNCHRONIZE-VARIABLE-VALUE-INFERENCE-CACHES ((FROMSKOLEM SKOLEM) (TOVALUE SKOLEM)))", Native.find_java_method("edu.isi.powerloom.logic.Skolem", "synchronizeVariableValueInferenceCaches", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Skolem"), Native.find_java_class("edu.isi.powerloom.logic.Skolem")}), null);
      ...
      Stella.defineFunctionObject("GET-VARIABLE-VALUE-INVERSES", "(DEFUN (GET-VARIABLE-VALUE-INVERSES CONS) ((TERM OBJECT)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "getVariableValueInverses", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
      Stella.defineFunctionObject("GET-ALL-VARIABLE-VALUE-INVERSES", "(DEFUN (GET-ALL-VARIABLE-VALUE-INVERSES CONS) ((TERM OBJECT)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "getAllVariableValueInverses", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
      Stella.defineFunctionObject("GET-ALL-EQUIVALENT-VALUES", "(DEFUN (GET-ALL-EQUIVALENT-VALUES CONS) ((TERM OBJECT)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "getAllEquivalentValues", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
  ...
  static void helpStartupPropositions10() {
    {
      ...
      Stella.defineMethodObject("(DEFMETHOD (DESCRIPTION-SURROGATE TYPE) ((SELF DESCRIPTION)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.Description", "descriptionSurrogate", new java.lang.Class [] {})), null);
      ...
      Stella.defineFunctionObject("INHERIT-PROPOSITION-ANNOTATIONS", "(DEFUN INHERIT-PROPOSITION-ANNOTATIONS ((ANNOTATIONS PROPERTY-LIST) (TO PROPOSITION)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "inheritPropositionAnnotations", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.PropertyList"), Native.find_java_class("edu.isi.powerloom.logic.Proposition")}), null);
  ...
  static void helpStartupPropositions12() {
    {
      ...
      Stella.defineMethodObject("(DEFMETHOD (DELETED? BOOLEAN) ((SELF PROPOSITION)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.Proposition", "deletedP", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (DELETED?-SETTER BOOLEAN) ((SELF PROPOSITION) (VALUE BOOLEAN)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.Proposition", "deletedPSetter", new java.lang.Class [] {java.lang.Boolean.TYPE})), null);
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFCONSTANT ZERO-VARIABLES-VECTOR VARIABLES-VECTOR (NEW VARIABLES-VECTOR :ARRAY-SIZE 0) :DOCUMENTATION \"Save space by structure-sharing zero-length variable vectors.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *PARTIAL-SUPPORT-COUNTER* INTEGER 0)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *OPERATOR-NAME-TO-SURROGATE-TABLE* (PROPERTY-LIST OF KEYWORD SURROGATE) (NEW PROPERTY-LIST :THE-PLIST (BQUOTE (:AND /PL-KERNEL-KB/@AND :OR /PL-KERNEL-KB/@OR :NOT /PL-KERNEL-KB/@NOT :FORALL /PL-KERNEL-KB/@FORALL :EXISTS /PL-KERNEL-KB/@EXISTS :EQUIVALENT /PL-KERNEL-KB/@EQUIVALENT :FAIL /PL-KERNEL-KB/@FAIL :COLLECT-INTO /PL-KERNEL-KB/@COLLECT-INTO :IMPLIES /PL-KERNEL-KB/@SUBSET-OF))) :DOCUMENTATION \"Maps names of KIF operators to relational surrogates.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *LOGIC-MODULE* MODULE (GET-STELLA-MODULE \"LOGIC\" TRUE) :PUBLIC? TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *PL-KERNEL-MODULE* MODULE (GET-STELLA-MODULE \"PL-KERNEL\" TRUE) :PUBLIC? TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *NOW-TIMESTAMP* TIMESTAMP 0 :DOCUMENTATION \"The NOW time stamp is incremented whenever a series\nof one or more updates is followed by a query.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *LAST-KB-ACTION* KEYWORD :UPDATE-PROPOSITION :DOCUMENTATION \"Records whether the last KB access was a query or\nan update.  Used to determine when to increment the NOW time stamp\ncounter.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL BOTTOM LOGIC-OBJECT NULL :PUBLIC? TRUE :DOCUMENTATION \"The undefined individual.  Denotes the non-existence of\nan individual in whatever slot it occupies.\")", null);
          Logic.BOTTOM = Logic.createSkolem(null, Logic.SYM_LOGIC_BOTTOM);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *EVALUATIONMODE* KEYWORD :EXTENSIONAL-ASSERTION :DOCUMENTATION \"Indicates the context for evaluating a proposition.  One\nof :DESCRIPTION, :INTENSIONAL-ASSERTION, or :EXTENSIONAL-ASSERTION.\")", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *CLIPPINGENABLED?* BOOLEAN TRUE :DOCUMENTATION \"When enabled, slot-value assertions can be retracted\nby later conflicting assertions.\")", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *NATURALDEDUCTIONMODE?* BOOLEAN TRUE :DOCUMENTATION \"When enabled, blocks normalizations that significantly\nchange the behavior of inference rules.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CONTEXT-DEPENDENT-SEARCH-MODE?* BOOLEAN FALSE :DOCUMENTATION \"Signals that we are performing search across multiple\ncontexts.  Used to disable retraction from collections, since that increases\nthe overhead of the context mechanism.\")", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *COMPUTEDQUERY?* BOOLEAN FALSE :DOCUMENTATION \"Used to signal 'ground-value-of' that it can\ncall 'bound-to' safely.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *SKOLEM-ID-COUNTER* INTEGER 0)", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *VARIABLEIDCOUNTER* INTEGER 0)", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *FREESKOLEMS* CONS NULL :DOCUMENTATION \"Cons-list of top-level existentially-quantified skolems.\")", null);
          Stella.defineGlobalVariableObject("(DEFCONSTANT TRUE-TRUTH-VALUE TRUTH-VALUE (NEW TRUTH-VALUE :POLARITY :TRUE :STRENGTH :STRICT :MATCH-SCORE 1.0) :DOCUMENTATION \"Value representing TRUE.\")", null);
          Stella.defineGlobalVariableObject("(DEFCONSTANT FALSE-TRUTH-VALUE TRUTH-VALUE (NEW TRUTH-VALUE :POLARITY :FALSE :STRENGTH :STRICT :MATCH-SCORE -1.0) :DOCUMENTATION \"Value representing FALSE.\")", null);
          Stella.defineGlobalVariableObject("(DEFCONSTANT DEFAULT-TRUE-TRUTH-VALUE TRUTH-VALUE (NEW TRUTH-VALUE :POLARITY :TRUE :STRENGTH :DEFAULT :MATCH-SCORE 0.8) :DOCUMENTATION \"Value representing DEFAULT-TRUE.\")", null);
          Stella.defineGlobalVariableObject("(DEFCONSTANT DEFAULT-FALSE-TRUTH-VALUE TRUTH-VALUE (NEW TRUTH-VALUE :POLARITY :FALSE :STRENGTH :DEFAULT :MATCH-SCORE -0.8) :DOCUMENTATION \"Value representing DEFAULT-FALSE.\")", null);
          Stella.defineGlobalVariableObject("(DEFCONSTANT UNKNOWN-TRUTH-VALUE TRUTH-VALUE (NEW TRUTH-VALUE :POLARITY :UNKNOWN) :DOCUMENTATION \"Value representing UNKNOWN.  Needed for those cases\nwhere we need a non-NULL truth value to represents UNKNOWN.\")", null);
          Stella.defineGlobalVariableObject("(DEFCONSTANT INCONSISTENT-TRUTH-VALUE TRUTH-VALUE (NEW TRUTH-VALUE :POLARITY :INCONSISTENT :STRENGTH :STRICT) :DOCUMENTATION \"Value representing a contradiction.\")", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *SUPPRESSUNTYPEDTYPEERROR?* BOOLEAN FALSE :DOCUMENTATION \"Used by 'safe-logical-type' to ask for a type\nwithout signalling an error if none exists.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *EQUIVALENCE-COLLECTIONS?* BOOLEAN TRUE :DOCUMENTATION \"Experiment with equality reasoning on collections.\")", null);
          Stella.defineGlobalVariableObject("(DEFCONSTANT TRUE-PROPOSITION PROPOSITION (NEW PROPOSITION :KIND :CONSTANT :OPERATOR @TRUE :ARGUMENTS (NEW ARGUMENTS-VECTOR :ARRAY-SIZE 0) :TRUTH-VALUE TRUE-TRUTH-VALUE :HOME-CONTEXT *PL-KERNEL-MODULE*))", null);
          Stella.defineGlobalVariableObject("(DEFCONSTANT FALSE-PROPOSITION PROPOSITION (NEW PROPOSITION :KIND :CONSTANT :OPERATOR @FALSE :ARGUMENTS (NEW ARGUMENTS-VECTOR :ARRAY-SIZE 0) :TRUTH-VALUE FALSE-TRUTH-VALUE :HOME-CONTEXT *PL-KERNEL-MODULE*))", null);
          ...
          Stella.defineGlobalVariableObject("(DEFCONSTANT ANONYMOUS-VARIABLE-NAME SYMBOL (QUOTE ?) :DOCUMENTATION \"Variables with name 'ANONYMOUS-VARIABLE-NAME' are considered\nanonymous, and are not assumed to be identical to any other variable also named\n'ANONYMOUS-VARIABLE-NAME'.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *MISSING-KEY-VALUE-LIST* KEY-VALUE-LIST (NEW KEY-VALUE-LIST) :DOCUMENTATION \"Represents a key-value list that should never be used.\")", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *AUTOMATICINSTANCETABLE* (KEY-VALUE-LIST OF SYMBOL LOGIC-OBJECT) *MISSING-KEY-VALUE-LIST* :DOCUMENTATION \"Used by 'evaluate-automatic-instance' to\nrecord current bindings of automatic instance symbols.\")", null);
          HookList.addHook(Stella.$REDEFINE_RELATION_HOOKS$, Logic.SYM_LOGIC_TRANSFER_LOGIC_INFORMATION_FROM_RELATION_HOOK);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *DEFAULTCREATIONTYPE* SURROGATE NULL)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *STRUCTURED-OBJECTS-INDEX* (KEY-VALUE-MAP OF INTEGER-WRAPPER (LIST OF CONTEXT-SENSITIVE-OBJECT)) (NEW KEY-VALUE-MAP) :DOCUMENTATION \"Contains a table of propositions and descriptions, indexed by a\nstructure hash code which might be shared by different objects.\")", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *DONT-CHECK-FOR-DUPLICATE-PROPOSITIONS?* BOOLEAN FALSE :DOCUMENTATION \"If TRUE never check for the existence of duplicate\npropositions when building a new proposition.\")", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *VISITEDUNFASTENEDDEFININGPROPOSITIONS* LIST NULL :DOCUMENTATION \"Used by 'recursively-fasten-down-propositions'.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *AUTO-COERCE-PROPOSITIONAL-ARGUMENTS?* BOOLEAN FALSE :DOCUMENTATION \"If TRUE, automatically coerce propositional arguments of a\nproposition, even if the corresponding argument type of the hosting relation\ndoesn't indicate that.\" :DEMON-PROPERTY \"powerloom.autoCoercePropositionalArguments\" :PUBLIC? TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *TYPE-CHECK-POLICY* KEYWORD :AUTOMATICALLY-FIX-TYPE-VIOLATIONS :DOCUMENTATION \"Three policies are implemented:\n   :AUTOMATICALLY-FIX-TYPE-VIOLATIONS asserts missing types to fix type\n       violations (default),\n   :REPORT-TYPE-VIOLATIONS complains about missing or incorrect types,\n   :SIGNAL-TYPE-VIOLATIONS throws exception for missing or incorrect types, and\n   :IGNORE-TYPE-VIOLATIONS which disables all type checking.\")", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *TYPECHECKMODE* KEYWORD :POST-TYPE-VIOLATIONS :DOCUMENTATION \"Controls the behavior of the type-checking\nroutines in the event that a type-check fails.  Options are:\n  :POST-TYPE-VIOLATIONS              push offending proposition onto queue,\n  :REPORT-TYPE-VIOLATIONS            print occasions of failed type checks,\n  :SIGNAL-TYPE-VIOLATIONS            throw exception for failed type checks,\n  :AUTOMATICALLY-FIX-TYPE-VIOLATIONS assert missing types on propositions, and\n  :IGNORE-TYPE-VIOLATIONS            don't perform any type checking at all.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CHECK-TYPES-AGENDA* (VECTOR-SEQUENCE OF CHECK-TYPES-RECORD) (NEW VECTOR-SEQUENCE :ARRAY-SIZE 4) :DOCUMENTATION \"List of propositions that have failed a type check,\nbut might pass once finalization is complete.\")", null);
          Symbol.registerNativeName(Logic.SYM_STELLA_ASSERT, Logic.KWD_CPP, Logic.KWD_FUNCTION);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *DEFERRED-TERMS-TO-UNLINK* HASH-SET NULL)", null);
