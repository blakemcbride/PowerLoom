...
public class AtomicGoalCache extends StandardObject {
  ...
  public static Keyword finishCachedGoalProcessing(AtomicGoalCache cachedgoal, ControlFrame frame, Keyword successorfailure, boolean continuingP) {
    KeyValueList.setDynamicSlotValue(((QueryIterator)(Logic.$QUERYITERATOR$.get())).dynamicSlots, Logic.SYM_LOGIC_LATEST_POSITIVE_SCORE, FloatWrapper.wrapFloat(cachedgoal.matchScore), Stella.NULL_FLOAT_WRAPPER);
