...
public class _StartupJustifications {
  static void helpStartupJustifications1() {
    {
      ...
      Logic.SYM_LOGIC_INFERENCE_STRATEGY = ((Symbol)(GeneralizedSymbol.internRigidSymbolWrtModule("INFERENCE-STRATEGY", null, 0)));
      Logic.SYM_LOGIC_INFERENCE_DIRECTION = ((Symbol)(GeneralizedSymbol.internRigidSymbolWrtModule("INFERENCE-DIRECTION", null, 0)));
      ...
      Logic.SYM_LOGIC_ERROR_SCORE = ((Symbol)(GeneralizedSymbol.internRigidSymbolWrtModule("ERROR-SCORE", null, 0)));
      ...
      Logic.KWD_MATCH_SCORE = ((Keyword)(GeneralizedSymbol.internRigidSymbolWrtModule("MATCH-SCORE", null, 2)));
      ...
      Logic.SYM_STELLA_DELETEDp = ((Symbol)(GeneralizedSymbol.internRigidSymbolWrtModule("DELETED?", Stella.getStellaModule("/STELLA", true), 0)));
      Logic.SYM_LOGIC_SUPPORTEDp = ((Symbol)(GeneralizedSymbol.internRigidSymbolWrtModule("SUPPORTED?", null, 0)));
      Logic.SYM_LOGIC_SUPPORTING_CONTEXTS = ((Symbol)(GeneralizedSymbol.internRigidSymbolWrtModule("SUPPORTING-CONTEXTS", null, 0)));
  ...
  static void helpStartupJustifications2() {
    {
      Surrogate.defineInlineMethodCode(Logic.SGT_LOGIC_JUSTIFICATION, Logic.SYM_LOGIC_INFERENCE_STRATEGY, MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.Justification", "inferenceStrategy", new java.lang.Class [] {})), null);
      Surrogate.defineInlineMethodCode(Logic.SGT_LOGIC_JUSTIFICATION, Logic.SYM_LOGIC_INFERENCE_DIRECTION, MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.Justification", "inferenceDirection", new java.lang.Class [] {})), null);
      Surrogate.defineInlineMethodCode(Logic.SGT_LOGIC_PRIMITIVE_STRATEGY, Logic.SYM_LOGIC_INFERENCE_STRATEGY, MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.PrimitiveStrategy", "inferenceStrategy", new java.lang.Class [] {})), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD (COPY (LIKE SELF)) ((SELF JUSTIFICATION)) :DOCUMENTATION \"Return a copy of the proof starting at `self'.  Allocates\nall new justification objects, but structure-shares other information such\nas propositions and substitutions.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.Justification", "copy", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (SHALLOW-COPY (LIKE SELF)) ((SELF JUSTIFICATION)) :DOCUMENTATION \"Similar to `copy' but does not copy antecedent justifications.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.Justification", "shallowCopy", new java.lang.Class [] {})), null);
      ...
      Stella.defineMethodObject("(DEFMETHOD (DELETED? BOOLEAN) ((SELF FORWARD-GOAL-RECORD)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.ForwardGoalRecord", "deletedP", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (DELETED?-SETTER BOOLEAN) ((SELF FORWARD-GOAL-RECORD) (VALUE BOOLEAN)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.ForwardGoalRecord", "deletedPSetter", new java.lang.Class [] {java.lang.Boolean.TYPE})), null);
      ...
      Surrogate.defineInlineMethodCode(Logic.SGT_LOGIC_FORWARD_JUSTIFICATION, Logic.SYM_LOGIC_INFERENCE_DIRECTION, MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.ForwardJustification", "inferenceDirection", new java.lang.Class [] {})), null);
      Surrogate.defineInlineMethodCode(Logic.SGT_LOGIC_FORWARD_JUSTIFICATION, Logic.SYM_STELLA_DELETEDp, MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.ForwardJustification", "deletedP", new java.lang.Class [] {})), null);
      Surrogate.defineInlineMethodCode(Logic.SGT_LOGIC_FORWARD_JUSTIFICATION, Logic.SYM_LOGIC_SUPPORTEDp, MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.ForwardJustification", "supportedP", new java.lang.Class [] {})), null);
      ...
      Stella.defineFunctionObject("GET-SUPPORTED-FORWARD-JUSTIFICATIONS", "(DEFUN (GET-SUPPORTED-FORWARD-JUSTIFICATIONS (LIST OF FORWARD-JUSTIFICATION)) ((PROPOSITION PROPOSITION)) :DOCUMENTATION \"Return all of `proposition's forward justifications supported in the current context.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "getSupportedForwardJustifications", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition")}), null);
      Stella.defineFunctionObject("GET-ONE-SUPPORTED-FORWARD-JUSTIFICATION", "(DEFUN (GET-ONE-SUPPORTED-FORWARD-JUSTIFICATION FORWARD-JUSTIFICATION) ((PROPOSITION PROPOSITION)) :DOCUMENTATION \"Return one of `proposition's forward justifications supported in the current context.\" :PUBLIC? TRUE)", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "getOneSupportedForwardJustification", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition")}), null);
      Stella.defineFunctionObject("ADD-FORWARD-JUSTIFICATION", "(DEFUN ADD-FORWARD-JUSTIFICATION ((PROPOSITION PROPOSITION) (JUSTIFICATION JUSTIFICATION)))", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "addForwardJustification", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition"), Native.find_java_class("edu.isi.powerloom.logic.Justification")}), null);
      ...
      Stella.defineFunctionObject("CREATE-FORWARD-RULE-JUSTIFICATION", "(DEFUN (CREATE-FORWARD-RULE-JUSTIFICATION FORWARD-JUSTIFICATION) ((ANTECEDENTS (CONS OF PROPOSITION)) (FORWARDRULE PROPOSITION) (ARGUMENTS ARGUMENTS-VECTOR) (CONSEQUENTPROPOSITION PROPOSITION) (BC-JUSTIFICATION JUSTIFICATION)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "createForwardRuleJustification", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons"), Native.find_java_class("edu.isi.powerloom.logic.Proposition"), Native.find_java_class("edu.isi.stella.Vector"), Native.find_java_class("edu.isi.powerloom.logic.Proposition"), Native.find_java_class("edu.isi.powerloom.logic.Justification")}), null);
      ...
      Stella.defineFunctionObject("RECORD-FORWARD-RULE-JUSTIFICATION", "(DEFUN RECORD-FORWARD-RULE-JUSTIFICATION ((ANTECEDENTS (CONS OF PROPOSITION)) (FORWARDRULE PROPOSITION) (ARGUMENTS ARGUMENTS-VECTOR) (CONSEQUENTPROPOSITION PROPOSITION) (BC-JUSTIFICATION JUSTIFICATION)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "recordForwardRuleJustification", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons"), Native.find_java_class("edu.isi.powerloom.logic.Proposition"), Native.find_java_class("edu.isi.stella.Vector"), Native.find_java_class("edu.isi.powerloom.logic.Proposition"), Native.find_java_class("edu.isi.powerloom.logic.Justification")}), null);
      Stella.defineFunctionObject("CREATE-SUBSET-OF-JUSTIFICATION", "(DEFUN (CREATE-SUBSET-OF-JUSTIFICATION JUSTIFICATION) ((SUB OBJECT) (SUPER OBJECT)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "createSubsetOfJustification", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
      Stella.defineFunctionObject("GET-SUPPORTING-EQUIVALENCE-PROPOSITIONS", "(DEFUN (GET-SUPPORTING-EQUIVALENCE-PROPOSITIONS (CONS OF PROPOSITION)) ((X SKOLEM) (Y OBJECT)))", Native.find_java_method("edu.isi.powerloom.logic.Skolem", "getSupportingEquivalencePropositions", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Skolem"), Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
      Stella.defineFunctionObject("FIND-EQUIVALENCE-PROPOSITION-PATH", "(DEFUN (FIND-EQUIVALENCE-PROPOSITION-PATH (CONS OF PROPOSITION)) ((EQUIVPROPS (CONS OF PROPOSITION)) (X SKOLEM) (Y OBJECT)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "findEquivalencePropositionPath", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons"), Native.find_java_class("edu.isi.powerloom.logic.Skolem"), Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
      Stella.defineFunctionObject("CREATE-EQUIVALENCE-JUSTIFICATIONS", "(DEFUN (CREATE-EQUIVALENCE-JUSTIFICATIONS (CONS OF JUSTIFICATION)) ((X OBJECT) (Y OBJECT)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "createEquivalenceJustifications", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
      Stella.defineFunctionObject("CREATE-IMPLICIT-INFERENCE-JUSTIFICATION", "(DEFUN (CREATE-IMPLICIT-INFERENCE-JUSTIFICATION JUSTIFICATION) ((INFERREDPROP PROPOSITION) (SUPPORTPROP PROPOSITION)))", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "createImplicitInferenceJustification", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition"), Native.find_java_class("edu.isi.powerloom.logic.Proposition")}), null);
      Surrogate.defineInlineMethodCode(Logic.SGT_LOGIC_CLASH_JUSTIFICATION, Logic.SYM_LOGIC_INFERENCE_DIRECTION, MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.ClashJustification", "inferenceDirection", new java.lang.Class [] {})), null);
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFSPECIAL *RECORD-JUSTIFICATIONS?* BOOLEAN FALSE :DOCUMENTATION \"If TRUE every query records justifications to enable\nthe explanation of concluded results.\")", null);
