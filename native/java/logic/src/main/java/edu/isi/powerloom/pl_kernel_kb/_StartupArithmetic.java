  ...
  static void helpStartupArithmetic1() {
    {
      ...
      PlKernelKb.SYM_STELLA_HOME_CONTEXT = ((Symbol)(GeneralizedSymbol.internRigidSymbolWrtModule("HOME-CONTEXT", Stella.getStellaModule("/STELLA", true), 0)));
      ...
      PlKernelKb.SGT_STELLA_e = ((Surrogate)(GeneralizedSymbol.internRigidSymbolWrtModule("=", Stella.getStellaModule("/STELLA", true), 1)));
  ...
  static void helpStartupArithmetic2() {
    {
      ...
      Stella.defineMethodObject("(DEFMETHOD (INTEGER-VALUED-MEMBER? BOOLEAN) ((INTERVAL INTERVAL-CACHE)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.pl_kernel_kb.IntervalCache", "integerValuedMemberP", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (INTEGER-LOWER-BOUND INTEGER-WRAPPER) ((INTERVAL INTERVAL-CACHE)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.pl_kernel_kb.IntervalCache", "integerLowerBound", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD (INTEGER-UPPER-BOUND INTEGER-WRAPPER) ((INTERVAL INTERVAL-CACHE)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.pl_kernel_kb.IntervalCache", "integerUpperBound", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD EVALUATE-TIGHTER-INTEGER-INTERVAL ((INTERVAL INTERVAL-CACHE)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.pl_kernel_kb.IntervalCache", "evaluateTighterIntegerInterval", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD EVALUATE-TIGHTER-INTERVAL ((INTERVAL INTERVAL-CACHE)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.pl_kernel_kb.IntervalCache", "evaluateTighterInterval", new java.lang.Class [] {})), null);
      Stella.defineMethodObject("(DEFMETHOD PROPAGATE-INEQUALITY-TO-INTERVAL-CACHE ((SELF INTERVAL-CACHE) (VALUE OBJECT) (OPERATOR SURROGATE)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.pl_kernel_kb.IntervalCache", "propagateInequalityToIntervalCache", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.stella.Surrogate")})), null);
