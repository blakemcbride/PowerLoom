    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          Stella.defineMethodObject("(DEFMETHOD (NEXT? BOOLEAN) ((SELF ATOMIC-GOAL-CACHE-ITERATOR)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.AtomicGoalCacheIterator", "nextP", new java.lang.Class [] {})), null);
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CACHE-SUCCEEDED-GOALS?* BOOLEAN TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CACHE-FAILED-GOALS?* BOOLEAN TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *CACHE-GOAL-QUANTUM* INTEGER 5 :DOCUMENTATION \"Only goals whose success or failure took at least this\nnumber of query clock ticks will be cached.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *SUCCEEDED-GOALS-CACHE* (VECTOR OF ATOMIC-GOAL-CACHE) (NEW VECTOR :ARRAY-SIZE 1541))", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *FAILED-GOALS-CACHE* (VECTOR OF ATOMIC-GOAL-CACHE) (NEW VECTOR :ARRAY-SIZE 1541))", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *UNIFICATION-VECTOR-1* VECTOR (NEW VECTOR :ARRAY-SIZE 10))", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *UNIFICATION-VECTOR-2* VECTOR (NEW VECTOR :ARRAY-SIZE 10))", null);
        }
