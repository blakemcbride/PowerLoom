...
public class NnPartialMatch extends PartialMatchFrame {
  ...
  public double computePartialTruth(QueryIterator query) {
    { NnPartialMatch self = this;
      ...
      if (!(Logic.$QUERY_OPTIMIZATION_STRATEGY$ == Logic.KWD_STATIC)) {
        {
          Stella.STANDARD_WARNING.nativeStream.println("Warning: Switching to static query optimization required by the NN partial matcher");
          Stella.STANDARD_WARNING.nativeStream.println();
        }
;
        Logic.$QUERY_OPTIMIZATION_STRATEGY$ = Logic.KWD_STATIC;
      }
      { Proposition proposition = query.baseControlFrame.proposition;
        ...
        double highestscore = self.truthValueScore(Logic.FALSE_TRUTH_VALUE);
  ...
  public double computeOrScore() {
    { NnPartialMatch self = this;
      ...
      { PropositionNeuralNetwork net = ((PropositionNeuralNetwork)(KeyValueList.dynamicSlotValue(self.controlFrame.proposition.dynamicSlots, Logic.SYM_LOGIC_NEURAL_NET, null)));
  ...
  public void setJustificationPartialTruth(Justification justification) {
    { NnPartialMatch self = this;
      ...
      justification.matchScore = ((FloatWrapper)(KeyValueList.dynamicSlotValue(((QueryIterator)(Logic.$QUERYITERATOR$.get())).dynamicSlots, Logic.SYM_LOGIC_LATEST_POSITIVE_SCORE, Stella.NULL_FLOAT_WRAPPER))).wrapperValue;
    }
  }
  ...
  public void setCachePartialTruth(AtomicGoalCache cache) {
    { NnPartialMatch self = this;
      ...
      cache.matchScore = ((FloatWrapper)(KeyValueList.dynamicSlotValue(((QueryIterator)(Logic.$QUERYITERATOR$.get())).dynamicSlots, Logic.SYM_LOGIC_LATEST_POSITIVE_SCORE, Stella.NULL_FLOAT_WRAPPER))).wrapperValue;
    }
  }
      ...
      { Proposition prop = self.controlFrame.proposition;
        ...
        { Keyword testValue000 = self.kind;
          ...
          if ((testValue000 == Logic.KWD_AND) ||
              (testValue000 == Logic.KWD_OR)) {
            if (((PropositionNeuralNetwork)(KeyValueList.dynamicSlotValue(prop.dynamicSlots, Logic.SYM_LOGIC_NEURAL_NET, null))) == null) {
  ...
  public static Stella_Object accessNnPartialMatchSlotValue(NnPartialMatch self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Logic.SYM_LOGIC_ACCUMULATED_SCORE) {
      if (setvalueP) {
