...
;
  ...
  public static boolean argumentsMatchArgumentsP(Proposition subproposition, Proposition referenceproposition) {
    if (((QueryIterator)(Logic.$QUERYITERATOR$.get())) != null) {
      return (Proposition.relationAndArgumentsUnifyP(subproposition, referenceproposition, true));
    }
    else {
   ...
   * those in 'referenceProposition'.  If one of the propositions is a HOLDS, the other one
   * has to be also for unification to succeed.
   * @param subproposition
  ...
  public static boolean relationAndArgumentsUnifyP(Proposition subproposition, Proposition referenceproposition, boolean dontunifyrelationP) {
    { PatternRecord patternrecord = ((QueryIterator)(Logic.$QUERYITERATOR$.get())).currentPatternRecord;
      ...
      int refstart = 0;
      Vector refargs = referenceproposition.arguments;
      int numrefargs = refargs.length();
      int substart = 0;
      Vector subargs = subproposition.arguments;
      int numsubargs = subargs.length();
      boolean successP = true;

      if (!(dontunifyrelationP)) {
        if (referenceproposition.operator == Logic.SGT_PL_KERNEL_KB_HOLDS) {
          refstart = refstart + 1;
        }
        if (subproposition.operator == Logic.SGT_PL_KERNEL_KB_HOLDS) {
          substart = substart + 1;
        }
        { Stella_Object suboperator = ((substart > 0) ? Logic.argumentBoundTo((subargs.theArray)[0]) : ((Surrogate)(subproposition.operator)).surrogateValue);

          if (suboperator == null) {
            successP = false;
          }
          else if (refstart > 0) {
            successP = Logic.bindArgumentToValueP((refargs.theArray)[0], suboperator, false);
          }
          else {
            successP = Stella_Object.eqlP(((Surrogate)(referenceproposition.operator)).surrogateValue, suboperator);
          }
        }
      }
      if (successP) {
        { boolean testValue000 = false;
          ...
          { boolean alwaysP000 = true;
            ...
            { int supi = Stella.NULL_INTEGER;
              int iter000 = refstart;
              int upperBound000 = numrefargs - 1;
              int subi = Stella.NULL_INTEGER;
              int iter001 = substart;
              int upperBound001 = numsubargs - 1;

              loop000 : for (;(iter000 <= upperBound000) &&
                        (iter001 <= upperBound001); iter000 = iter000 + 1, iter001 = iter001 + 1) {
                supi = iter000;
                subi = iter001;
                if (!((!Logic.nullInstanceP((subargs.theArray)[subi])) &&
                    Logic.bindArgumentToValueP((refargs.theArray)[supi], Logic.valueOf((subargs.theArray)[subi]), false))) {
                  alwaysP000 = false;
                  break loop000;
                }
              }
          ...
          if (testValue000) {
            testValue000 = (numrefargs - refstart) == (numsubargs - substart);
          }
  ...
  public static void printKifImpliesProposition(Proposition self) {
    { Stella_Object tailarg = (self.arguments.theArray)[0];
      ...
      if (Stella_Object.isaP(headarg, Logic.SGT_LOGIC_DESCRIPTION) &&
        ...
        Logic.printKifOperatorWithArguments(Logic.stringifiedSurrogate(Logic.SGT_PL_KERNEL_KB_SUBSET_OF), self.arguments, false, false);
      }
    }
  }
    ...
    try {
      { Object old$Context$000 = Stella.$CONTEXT$.get();
        ...
        try {
          ...
          { List justifications = Proposition.getSupportedForwardJustifications(prop);
            ...
            if (justifications != null) {
              { Object old$ExplanationStyle$000 = Logic.$EXPLANATION_STYLE$.get();
                ...
                try {
                  ...
                  { ForwardJustification justification = null;
                    Cons iter000 = justifications.theConsList;

                    for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
                      justification = ((ForwardJustification)(iter000.value));
                      Native.setSpecial(Logic.$MOST_RECENT_EXPLANATION_MAPPING$, null);
  ...
  /** Return the neural network associated with <code>prop</code>.  If <code>errorP</code>, raise an
   * exception if it cannot be found, otherwise, simply return NULL.
   * @param prop
   * @param errorP
   * @return NeuralNetwork
   */
  public static NeuralNetwork getPropositionNeuralNetwork(Proposition prop, boolean errorP) {
    { NeuralNetwork net = ((NeuralNetwork)(KeyValueList.dynamicSlotValue(prop.dynamicSlots, Logic.SYM_LOGIC_NEURAL_NET, null)));

      if (net == null) {
        net = Proposition.lookupPropositionNeuralNetwork(prop);
        if (net != null) {
          KeyValueList.setDynamicSlotValue(prop.dynamicSlots, Logic.SYM_LOGIC_NEURAL_NET, net, null);
        }
        else if (errorP) {
          { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();

            stream000.nativeStream.print("Missing neural network for proposition: `" + prop + "'");
            throw ((StellaException)(StellaException.newStellaException(stream000.theStringReader()).fillInStackTrace()));
          }
        }
      }
  ...
  public static void createAndLinkNeuralNetwork(Proposition prop) {
    { NeuralNetwork net = null;

      if (Logic.$CHAMELEON_NEURAL_NETWORK_IMPLEMENTATION$ == Logic.KWD_ORIGINAL) {
        KeyValueList.setDynamicSlotValue(prop.dynamicSlots, Logic.SYM_LOGIC_NEURAL_NET, Proposition.createNeuralNetwork(prop), null);
        return;
      }
      else if (Logic.$CHAMELEON_NEURAL_NETWORK_IMPLEMENTATION$ == Logic.KWD_PROPOSITION) {
        net = PropositionNeuralNetwork.newPropositionNeuralNetwork();
      }
      else if (Logic.$CHAMELEON_NEURAL_NETWORK_IMPLEMENTATION$ == Logic.KWD_CHAMELEON) {
        Logic.ensureChameleonOntology();
        net = ChameleonNeuralNetwork.newChameleonNeuralNetwork();
      }
      else if (Logic.$CHAMELEON_NEURAL_NETWORK_IMPLEMENTATION$ == Logic.KWD_CHAMELEON_BATCH) {
        Logic.ensureChameleonOntology();
        net = ChameleonBatchNeuralNetwork.newChameleonBatchNeuralNetwork();
      }
      else if (Logic.$CHAMELEON_NEURAL_NETWORK_IMPLEMENTATION$ == Logic.KWD_TENSORFLOW) {
        Logic.ensureChameleonOntology();
        if (!(Logic.tensorflowBackendAvailableP())) {
          throw ((StellaException)(StellaException.newStellaException("create-and-link-neural-network: TensorFlow backend is not available").fillInStackTrace()));
        }
        net = TensorflowNeuralNetwork.newTensorflowNeuralNetwork();
      }
      else if (Logic.$CHAMELEON_NEURAL_NETWORK_IMPLEMENTATION$ == Logic.KWD_TENSORFLOW_BATCH) {
        Logic.ensureChameleonOntology();
        if (!(Logic.tensorflowBackendAvailableP())) {
          throw ((StellaException)(StellaException.newStellaException("create-and-link-neural-network: TensorFlow backend is not available").fillInStackTrace()));
        }
        net = TensorflowBatchNeuralNetwork.newTensorflowBatchNeuralNetwork();
      }
      else {
        { OutputStringStream stream000 = OutputStringStream.newOutputStringStream();

          stream000.nativeStream.print("`" + Logic.$CHAMELEON_NEURAL_NETWORK_IMPLEMENTATION$ + "' is not a valid case option");
          throw ((StellaException)(StellaException.newStellaException(stream000.theStringReader()).fillInStackTrace()));
        }
      }
      net.buildPropositionNetwork(prop);
      NeuralNetwork.registerNeuralNetwork(net);
    }
  }

  /** Lookup the neural network for <code>prop</code> in the global networks list.
   * @param prop
   * @return NeuralNetwork
   */
  public static NeuralNetwork lookupPropositionNeuralNetwork(Proposition prop) {
    { IntegerWrapper hashcode = IntegerWrapper.wrapInteger(Proposition.propositionHashIndex(prop, null, true));
      ...
      if (bucket != null) {
        { NeuralNetwork net = null;
          ...
          for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
            ...
            if (Proposition.equivalentPropositionsP(prop, net.getNeuralNetworkProposition(), null) &&
                Context.visibleFromP(net.getNeuralNetworkProposition().homeContext, ((Module)(Stella.$MODULE$.get())))) {
              return (net);
            }
          }
        }
  ...
  public static Stella_Object buildNetworkTree(Proposition prop, Cons propList) {
        ...
        { PartialSupport proof = null;
          ...
          for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
            ...
            { Proposition fact = proof.fact;
              ...
              if (((PropositionNeuralNetwork)(KeyValueList.dynamicSlotValue(fact.dynamicSlots, Logic.SYM_LOGIC_NEURAL_NET, null))) != null) {
                tree = Cons.cons(Cons.cons(((PropositionNeuralNetwork)(KeyValueList.dynamicSlotValue(fact.dynamicSlots, Logic.SYM_LOGIC_NEURAL_NET, null))), proofTree), tree);
              }
              else {
    ...
    else if (((PropositionNeuralNetwork)(KeyValueList.dynamicSlotValue(prop.dynamicSlots, Logic.SYM_LOGIC_NEURAL_NET, null))) != null) {
      { Cons tree = Stella.NIL;
        ...
        { Stella_Object arg = null;
          ...
          for (;index001 < length001; index001 = index001 + 1, iter002 = iter002 + 1) {
            arg = (vector001.theArray)[index001];
            i = iter002;
            KeyValueList.setDynamicSlotValue(((Proposition)(arg)).dynamicSlots, Logic.SYM_LOGIC_MATCH_SCORE, FloatWrapper.wrapFloat(((FloatWrapper)((((PropositionNeuralNetwork)(KeyValueList.dynamicSlotValue(prop.dynamicSlots, Logic.SYM_LOGIC_NEURAL_NET, null))).input.theArray)[i])).wrapperValue), Stella.NULL_FLOAT_WRAPPER);
            if (collect001 == null) {
              {
        ...
        tree = Cons.cons(((PropositionNeuralNetwork)(KeyValueList.dynamicSlotValue(prop.dynamicSlots, Logic.SYM_LOGIC_NEURAL_NET, null))), tree);
  ...
  public static void quickpropagateError(Proposition prop, double error) {
    { PropositionNeuralNetwork net = ((PropositionNeuralNetwork)(KeyValueList.dynamicSlotValue(prop.dynamicSlots, Logic.SYM_LOGIC_NEURAL_NET, null)));
  ...
  public static Justification createImplicitInferenceJustification(Proposition inferredprop, Proposition supportprop) {
    { GeneralizedSymbol inferredop = inferredprop.operator;
      ...
      if (!(inferredop == supportop)) {
        { Justification subsetjust = Logic.createSubsetOfJustification(supportop, inferredop);

          if (subsetjust != null) {
            justifications = Cons.cons(subsetjust, justifications);
          }
        }
      }
      { Stella_Object infarg = null;
        ...
        for (;(index000 < length000) &&
          ...
          { Justification equivjust = null;
            Cons iter000 = Logic.createEquivalenceJustifications(infarg, suparg);
            ...
            for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
              ...
              { boolean testValue000 = false;
                ...
                { boolean foundP000 = false;
                  ...
                  { Stella_Object just = null;
                    Cons iter001 = justifications;

                    loop002 : for (;!(iter001 == Stella.NIL); iter001 = iter001.rest) {
                      just = iter001.value;
                      if (Justification.justificationEqlP(equivjust, ((Justification)(just)))) {
                        foundP000 = true;
                        break loop002;
                      }
                    }
                ...
                testValue000 = !testValue000;
                if (testValue000) {
                  justifications = Cons.cons(equivjust, justifications);
                }
              }
            }
          }
      ...
      if (!(justifications == Stella.NIL)) {
        if (Proposition.hasSupportedForwardJustificationsP(supportprop)) {
          justifications = Cons.cons(Proposition.getOneSupportedForwardJustification(supportprop), justifications);
        }
        else {
          { PrimitiveStrategy self000 = PrimitiveStrategy.newPrimitiveStrategy();
            ...
            justifications = Cons.cons(self000, justifications);
          }
        }
        { Justification self001 = Justification.newJustification();

          self001.inferenceRule = Logic.KWD_SUBSUMPTION_REASONING;
  ...
  public static Justification getForwardAntecedentJustification(Proposition antecedent) {
    if (Proposition.hasSupportedForwardJustificationsP(antecedent)) {
      return (Proposition.getOneSupportedForwardJustification(antecedent));
    }
    else {
      { PrimitiveStrategy self000 = PrimitiveStrategy.newPrimitiveStrategy();
  ...
  public static void addForwardJustification(Proposition proposition, Justification justification) {
    if (!Stella_Object.isaP(justification, Logic.SGT_LOGIC_FORWARD_JUSTIFICATION)) {
      System.err.print("Safety violation: INTERNAL ERROR: forward justification is of the wrong type");
    }
    { List justifications = proposition.forwardJustifications().removeDeletedMembers();
  ...
  /** Return one of <code>proposition</code>s forward justifications supported in the current context.
   * @param proposition
   * @return ForwardJustification
   */
  public static ForwardJustification getOneSupportedForwardJustification(Proposition proposition) {
    { ForwardJustification value000 = null;

      { ForwardJustification just = null;
        Cons iter000 = proposition.forwardJustifications().removeDeletedMembers().theConsList;
  ...
  /** Return all of <code>proposition</code>s forward justifications supported in the current context.
   * @param proposition
   * @return List
   */
  public static List getSupportedForwardJustifications(Proposition proposition) {
    { List justifications = proposition.forwardJustifications().removeDeletedMembers();
                    ...
                    if (collect000 == null) {
                      {
                        ...
                        if (supported.theConsList == Stella.NIL) {
                          supported.theConsList = collect000;
                        }
                        else {
                          Cons.addConsToEndOfConsList(supported.theConsList, collect000);
                        }
                      }
                    }
                    else {
  ...
  public static List getForwardJustifications(Proposition proposition) {
    return (proposition.forwardJustifications().removeDeletedMembers());
  }

  /** Return TRUE if <code>proposition</code> has any forward justifications supported by the current context.
   * @param proposition
   * @return boolean
   */
  public static boolean hasSupportedForwardJustificationsP(Proposition proposition) {
    { boolean foundP000 = false;
  ...
  /** Return TRUE if <code>proposition</code> has any viable forward justifications.
   * @param proposition
   * @return boolean
   */
  public static boolean hasForwardJustificationsP(Proposition proposition) {
    return (proposition.forwardJustifications().removeDeletedMembers().nonEmptyP());
  }
  ...
  /** Return true if the truth-value of <code>self</code> satisfies <code>minimalstrength</code>.
   * @param self
   * @param minimalstrength
   * @return boolean
   */
  public static boolean propositionHasStrengthP(Proposition self, TruthValue minimalstrength) {
    if (minimalstrength == null) {
      return (true);
    }
    else if ((minimalstrength == Logic.TRUE_TRUTH_VALUE) ||
        (minimalstrength == Logic.FALSE_TRUTH_VALUE)) {
      if (!(TruthValue.strictTruthValueP(((TruthValue)(Stella_Object.accessInContext(self.truthValue, self.homeContext, false)))))) {
        return (false);
      }
    }
    else if ((minimalstrength == Logic.DEFAULT_TRUE_TRUTH_VALUE) ||
        (minimalstrength == Logic.DEFAULT_FALSE_TRUTH_VALUE)) {
      if (TruthValue.unknownTruthValueP(((TruthValue)(Stella_Object.accessInContext(self.truthValue, self.homeContext, false))))) {
        return (false);
      }
    }
    return (true);
  ...
  public static void skolemizeRule(Proposition rule) {
    if (!((rule.kind == Logic.KWD_FORALL) &&
        (((BooleanWrapper)(KeyValueList.dynamicSlotValue(rule.dynamicSlots, Logic.SYM_LOGIC_BACKWARD_ONLYp, Stella.FALSE_WRAPPER))).wrapperValue &&
         (((Proposition)((rule.arguments.theArray)[1])).kind == Logic.KWD_EXISTS)))) {
      return;
    }
    { Symbol arrow = null;
      Cons antecedent = Stella.NIL;
      Cons consequents = Stella.NIL;
      Cons antvars = Stella.NIL;
      Cons cqvars = Stella.NIL;
      Cons ruletree = Stella.NIL;
      Module module = rule.homeModule();
      Symbol skolemfnid = Symbol.internSymbolInModule(Stella.yieldUniqueGensymName("skfn", module), module, true);
      Proposition satellite = null;

      ruletree = ((Cons)(Logic.generateTerm(rule)));
      arrow = ((Symbol)(Cons.consTreeNth(ruletree, Cons.cons(IntegerWrapper.wrapInteger(2), Cons.cons(IntegerWrapper.wrapInteger(0), Stella.NIL)))));
      antvars = ((Cons)(ruletree.rest.value));
      if ((arrow.symbolName).charAt(0) == '<') {
        antecedent = ((Cons)(Cons.consTreeNth(ruletree, Cons.cons(IntegerWrapper.wrapInteger(2), Cons.cons(IntegerWrapper.wrapInteger(2), Stella.NIL)))));
        cqvars = ((Cons)(Cons.consTreeNth(ruletree, Cons.cons(IntegerWrapper.wrapInteger(2), Cons.cons(IntegerWrapper.wrapInteger(1), Cons.cons(IntegerWrapper.wrapInteger(1), Stella.NIL))))));
        consequents = ((Cons)(Cons.consTreeNth(ruletree, Cons.cons(IntegerWrapper.wrapInteger(2), Cons.cons(IntegerWrapper.wrapInteger(1), Cons.cons(IntegerWrapper.wrapInteger(2), Stella.NIL))))));
      }
      else {
        antecedent = ((Cons)(Cons.consTreeNth(ruletree, Cons.cons(IntegerWrapper.wrapInteger(2), Cons.cons(IntegerWrapper.wrapInteger(1), Stella.NIL)))));
        cqvars = ((Cons)(Cons.consTreeNth(ruletree, Cons.cons(IntegerWrapper.wrapInteger(2), Cons.cons(IntegerWrapper.wrapInteger(2), Cons.cons(IntegerWrapper.wrapInteger(1), Stella.NIL))))));
        consequents = ((Cons)(Cons.consTreeNth(ruletree, Cons.cons(IntegerWrapper.wrapInteger(2), Cons.cons(IntegerWrapper.wrapInteger(2), Cons.cons(IntegerWrapper.wrapInteger(2), Stella.NIL))))));
      }
      if (consequents.value == Logic.SYM_STELLA_AND) {
        consequents = consequents.rest;
      }
      else {
        consequents = Cons.cons(consequents, Stella.NIL);
      }
      { Stella_Object goal = null;
        Cons iter000 = consequents;

        for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
          goal = iter000.value;
          satellite = ((Proposition)(Logic.updateProposition(Logic.skolemizeRuleForGoal(((Cons)(goal)), antecedent, antvars, cqvars, skolemfnid), Logic.KWD_CONCEIVE).value));
          if (rule.satellitePropositions().emptyP()) {
            KeyValueList.setDynamicSlotValue(rule.dynamicSlots, Logic.SYM_LOGIC_SATELLITE_PROPOSITIONS, List.newList(), null);
          }
          rule.satellitePropositions().insertNew(satellite);
          KeyValueList.setDynamicSlotValue(satellite.dynamicSlots, Logic.SYM_LOGIC_MASTER_PROPOSITION, rule, null);
        }
      }
    }
  }
    ...
    { boolean createdsatellitesP = false;
        ...
        try {
          ...
          if (((BooleanWrapper)(KeyValueList.dynamicSlotValue(forallprop.dynamicSlots, Logic.SYM_LOGIC_BACKWARD_ONLYp, Stella.FALSE_WRAPPER))).wrapperValue &&
              ((goaldescription == null) &&
               Proposition.findMatchableGoals(forallprop, Logic.KWD_HEAD).emptyP())) {
            createdsatellitesP = true;
            Proposition.skolemizeRule(forallprop);
          }
          if ((!((BooleanWrapper)(KeyValueList.dynamicSlotValue(forallprop.dynamicSlots, Logic.SYM_LOGIC_BACKWARD_ONLYp, Stella.FALSE_WRAPPER))).wrapperValue) &&
              (Proposition.atomicForallArgumentP(forallprop, Logic.KWD_TAIL) ||
      ...
      if (createdsatellitesP &&
        ...
        { Object old$Context$001 = Stella.$CONTEXT$.get();
          ...
          try {
            Native.setSpecial(Stella.$CONTEXT$, ((Context)(Stella.$CONTEXT$.get())));
            Native.setSpecial(Stella.$MODULE$, ((Context)(Stella.$CONTEXT$.get())).baseModule);
...
;
  ...
  public static void overlayProposition(Proposition self, Proposition overlayingprop) {
    ...
    KeyValueList.setDynamicSlotValue(self.dynamicSlots, Logic.SYM_LOGIC_NEURAL_NET, ((NeuralNetwork)(KeyValueList.dynamicSlotValue(overlayingprop.dynamicSlots, Logic.SYM_LOGIC_NEURAL_NET, null))), null);
          ...
          if (testValue000 == Logic.KWD_AND) {
            { Cons propositions = Stella.NIL;
              ...
              if (annotations != null) {
                { Stella_Object arg = null;
                  ...
                  for (;!(iter001 == Stella.NIL); iter001 = iter001.rest) {
                    arg = iter001.value;
                    Logic.inheritPropositionAnnotations(annotations, ((Proposition)(arg)));
                  }
                }
              }
            ...
            { Stella_Object argument = (proposition.arguments.theArray)[0];
              ...
              if ((updatemode == Logic.KWD_ASSERT_TRUE) ||
                ...
                Logic.inheritPropositionAnnotations(((PropertyList)(KeyValueList.dynamicSlotValue(proposition.dynamicSlots, Logic.SYM_LOGIC_ANNOTATIONS, null))), ((Proposition)(argument)));
                Proposition.destroyRedundantProposition(proposition);
                if ((argument != null) &&
                    (!argument.deletedP())) {
      ...
      if (annotations != null) {
        { Keyword option = null;
          ...
          for (;!(iter000 == Stella.NIL); iter000 = iter000.rest.rest) {
            ...
            else if (option == Logic.KWD_SCORE) {
              { Surrogate testValue002 = Stella_Object.safePrimaryType(value);
                ...
                if (Surrogate.subtypeOfIntegerP(testValue002)) {
                  { IntegerWrapper value000 = ((IntegerWrapper)(value));
                    ...
                    { Proposition object000 = proposition;
                      FloatWrapper value002 = FloatWrapper.wrapFloat(Stella_Object.coerceToFloat(value000));
                      Stella_Object oldValue000 = KeyValueList.dynamicSlotValue(object000.dynamicSlots, Logic.SYM_LOGIC_SCORE, null);
                      Stella_Object newValue000 = Stella_Object.updateInContext(oldValue000, value002, object000.homeContext, false);

                      if (!((oldValue000 != null) &&
                          (oldValue000.primaryType() == Logic.SGT_STELLA_CS_VALUE))) {
                        KeyValueList.setDynamicSlotValue(object000.dynamicSlots, Logic.SYM_LOGIC_SCORE, newValue000, null);
                      }
                    }
                  }
                }
                  ...
                  { FloatWrapper value000 = ((FloatWrapper)(value));
                    ...
                    { Proposition object001 = proposition;
                      FloatWrapper value003 = FloatWrapper.wrapFloat(Stella_Object.coerceToFloat(value000));
                      Stella_Object oldValue001 = KeyValueList.dynamicSlotValue(object001.dynamicSlots, Logic.SYM_LOGIC_SCORE, null);
                      Stella_Object newValue001 = Stella_Object.updateInContext(oldValue001, value003, object001.homeContext, false);

                      if (!((oldValue001 != null) &&
                          (oldValue001.primaryType() == Logic.SGT_STELLA_CS_VALUE))) {
                        KeyValueList.setDynamicSlotValue(object001.dynamicSlots, Logic.SYM_LOGIC_SCORE, newValue001, null);
                      }
                    }
                  }
                }
                  ...
                  { OutputStringStream stream003 = OutputStringStream.newOutputStringStream();
                    ...
                    { Object old$PrintreadablyP$003 = Stella.$PRINTREADABLYp$.get();
                      ...
                      try {
                        Native.setBooleanSpecial(Stella.$PRINTREADABLYp$, true);
                        stream003.nativeStream.println("PARSING ERROR: Illegal value for :score option: `" + value + "'.");
              ...
              if (!(Stella_Object.runOptionHandlerP(proposition, option, value))) {
                ...
                { OutputStringStream stream004 = OutputStringStream.newOutputStringStream();
                  ...
                  { Object old$PrintreadablyP$004 = Stella.$PRINTREADABLYp$.get();
                    ...
                    try {
                      Native.setBooleanSpecial(Stella.$PRINTREADABLYp$, true);
                      stream004.nativeStream.println("PARSING ERROR: Unrecognized annotation option: `" + option + "'.");
            ...
            { Surrogate testValue001 = Stella_Object.safePrimaryType(arg);
              ...
              if (Surrogate.subtypeOfP(testValue001, Logic.SGT_LOGIC_PROPOSITION)) {
                ...
                { Skolem arg000 = ((Skolem)(arg));
                  ...
                  if (Logic.valueOf((arguments.theArray)[i]) == arg000) {
                    arg000 = ((Skolem)((arguments.theArray)[i]));
                  }
                  { Proposition definingprop = arg000.definingProposition;
                ...
                { Surrogate arg000 = ((Surrogate)(arg));
                  ...
                  if (derefsurrogatesP) {
                    argcode = arg000.surrogateValue.hashCode_();
                  }
                  else {
...
;
    ...
    if (!((proposition == Logic.TRUE_PROPOSITION) ||
      ...
      if (((Boolean)(Logic.$RECORD_JUSTIFICATIONSp$.get())).booleanValue()) {
        { Proposition negatedProposition = Proposition.conceiveInvertedProposition(proposition);
          ...
          if (Proposition.hasSupportedForwardJustificationsP(negatedProposition)) {
            antecedents = Proposition.getSupportedForwardJustifications(negatedProposition).theConsList;
          }
          else {
            { PrimitiveStrategy self000 = PrimitiveStrategy.newPrimitiveStrategy();
          ...
          if (Proposition.hasSupportedForwardJustificationsP(proposition)) {
            antecedents = Cons.append(Proposition.getSupportedForwardJustifications(proposition).theConsList, antecedents);
          }
          else {
          ...
          Proposition.addForwardJustification(proposition, Proposition.createClashJustification(proposition, antecedents, Logic.KWD_FORWARD));
          Proposition.addForwardJustification(negatedProposition, Proposition.createClashJustification(negatedProposition, Cons.copyConsList(antecedents).reverse(), Logic.KWD_FORWARD));
        }
      }
    }
    { String message = null;
  ...
  /** Return true if <code>self</code> has been asserted to be false.
   * @param self
   * @return boolean
   */
  public static boolean assertedFalseP(Proposition self) {
    { Object old$Context$000 = Stella.$CONTEXT$.get();
      Object old$Module$000 = Stella.$MODULE$.get();

      try {
        Native.setSpecial(Stella.$CONTEXT$, Logic.getWorldState(((Context)(Stella.$CONTEXT$.get()))));
        Native.setSpecial(Stella.$MODULE$, ((Context)(Stella.$CONTEXT$.get())).baseModule);
        return (Proposition.falseP(self));
  ...
  /** Return true if <code>self</code> has been asserted to be true.
   * @param self
   * @return boolean
   */
  public static boolean assertedTrueP(Proposition self) {
    { Object old$Context$000 = Stella.$CONTEXT$.get();
      Object old$Module$000 = Stella.$MODULE$.get();
  ...
  public static void assignPropositionWeight(Proposition self, double weight) {
    { TruthValue tv = ((TruthValue)(Stella_Object.accessInContext(self.truthValue, self.homeContext, false)));
      ...
      if (weight == 1.0) {
        ...
        ((TruthValue)(Stella_Object.accessInContext(self.truthValue, self.homeContext, false))).matchScore = weight;
      }
    }
  }
...
;
  ...
  public static Stella_Object accessPropositionSlotValue(Proposition self, Symbol slotname, Stella_Object value, boolean setvalueP) {
    if (slotname == Logic.SYM_LOGIC_KIND) {
      ...
      if (slotname == Logic.SYM_LOGIC_PROPOSITION_NEURAL_NETWORK) {
        slotname = Logic.SYM_LOGIC_NEURAL_NET;
      }
      else if (slotname == Logic.SYM_LOGIC_NEURAL_NETWORK) {
        slotname = Logic.SYM_LOGIC_NEURAL_NET;
      }
      else {
      }
