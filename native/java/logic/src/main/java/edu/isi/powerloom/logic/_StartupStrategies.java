  ...
  static void helpStartupStrategies1() {
    {
      ...
      Logic.KWD_INITIALIZE = ((Keyword)(GeneralizedSymbol.internRigidSymbolWrtModule("INITIALIZE", null, 2)));
  ...
  static void helpStartupStrategies2() {
    {
      ...
      Stella.defineFunctionObject("TSPP.INITIALIZE-STRATEGY", "(DEFUN (TSPP.INITIALIZE-STRATEGY ITERATOR) ((FRAME CONTROL-FRAME)))", Native.find_java_method("edu.isi.powerloom.logic.ControlFrame", "tsppDinitializeStrategy", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.ControlFrame")}), null);
      Stella.defineFunctionObject("TSPP.SPAWN-DERIVED-STRATEGIES", "(DEFUN TSPP.SPAWN-DERIVED-STRATEGIES ((FRAME CONTROL-FRAME) (STATE KEYWORD)))", Native.find_java_method("edu.isi.powerloom.logic.ControlFrame", "tsppDspawnDerivedStrategies", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.ControlFrame"), Native.find_java_class("edu.isi.stella.Keyword")}), null);
      Stella.defineFunctionObject("TSPP.SINGLE-VALUED-STRATEGY?", "(DEFUN (TSPP.SINGLE-VALUED-STRATEGY? BOOLEAN) ((FRAME CONTROL-FRAME)))", Native.find_java_method("edu.isi.powerloom.logic.ControlFrame", "tsppDsingleValuedStrategyP", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.ControlFrame")}), null);
      Stella.defineFunctionObject("TSPP.HANDLE-DEFAULT-RESULT", "(DEFUN TSPP.HANDLE-DEFAULT-RESULT ((FRAME CONTROL-FRAME)))", Native.find_java_method("edu.isi.powerloom.logic.ControlFrame", "tsppDhandleDefaultResult", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.ControlFrame")}), null);
      Stella.defineFunctionObject("TSPP.RECORD-RESULT-JUSTIFICATION", "(DEFUN TSPP.RECORD-RESULT-JUSTIFICATION ((FRAME CONTROL-FRAME)))", Native.find_java_method("edu.isi.powerloom.logic.ControlFrame", "tsppDrecordResultJustification", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.ControlFrame")}), null);
      Stella.defineFunctionObject("TSPP.PROPAGATE-RESULT-TRUTH-VALUE", "(DEFUN TSPP.PROPAGATE-RESULT-TRUTH-VALUE ((FRAME CONTROL-FRAME)))", Native.find_java_method("edu.isi.powerloom.logic.ControlFrame", "tsppDpropagateResultTruthValue", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.ControlFrame")}), null);
      ...
      Stella.defineFunctionObject("HAS-DISJOINTNESS-DISPROOF?", "(DEFUN (HAS-DISJOINTNESS-DISPROOF? BOOLEAN) ((FRAME CONTROL-FRAME)))", Native.find_java_method("edu.isi.powerloom.logic.ControlFrame", "hasDisjointnessDisproofP", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.ControlFrame")}), null);
      ...
      Stella.defineFunctionObject("HAS-MORE-ANTECEDENTS?", "(DEFUN (HAS-MORE-ANTECEDENTS? BOOLEAN) ((FRAME CONTROL-FRAME)))", Native.find_java_method("edu.isi.powerloom.logic.ControlFrame", "hasMoreAntecedentsP", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.ControlFrame")}), null);
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          Stella.defineMethodObject("(DEFMETHOD (CONTINUE-PARTIAL-FAIL-PROOF KEYWORD) ((SELF CONTROL-FRAME) (LASTMOVE KEYWORD)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.ControlFrame", "continuePartialFailProof", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Keyword")})), null);
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFGLOBAL *PARALLEL-STRATEGIES* (LIST OF KEYWORD) (LIST :DISJUNCTIVE-IMPLICATION-INTRODUCTION :UNIVERSAL-INTRODUCTION :REFUTATION) :DOCUMENTATION \"List of strategies (keywords) that fork a parallel\ncontrol stack before executing.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *FAILED-GOAL-CUTOFFS* INTEGER 0)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *SUCCEEDED-GOAL-CUTOFFS* INTEGER 0)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *PL-ANONYMOUS-MODULE* MODULE (GET-STELLA-MODULE \"PL-ANONYMOUS\" TRUE))", null);
