  ...
  static void helpStartupNeuralNetwork3() {
    {
      ...
      Stella.defineMethodObject("(DEFMETHOD FILL-ARRAY ((SELF 2_D_ARRAY) |&REST| (VALUES OBJECT)) :DOCUMENTATION \"Fill the two-dimensional array `self' in row-major-order\nfrom `values'.  Missing values will retain their old values, extraneous values\nwill be ignored.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.two_D_array", "fillArray", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons")})), null);
      Stella.defineMethodObject("(DEFMETHOD PRINT-ARRAY ((SELF 2_D_ARRAY) (STREAM NATIVE-OUTPUT-STREAM)) :DOCUMENTATION \"Print the array `self' to `stream'.\")", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.two_D_array", "printArray", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.javalib.NativeOutputStream")})), null);
    }
  }
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(7)) {
          ...
          Stella.defineMethodObject("(DEFMETHOD PRINT-VECTOR ((SELF FLOAT-VECTOR) (STREAM NATIVE-OUTPUT-STREAM)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.FloatVector", "printVector", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.javalib.NativeOutputStream")})), null);
          Stella.defineMethodObject("(DEFMETHOD (EMPTY? BOOLEAN) ((SELF FLOAT-VECTOR)) :DOCUMENTATION \"Return TRUE if 'self' has length 0.\" :GLOBALLY-INLINE? TRUE (RETURN (EQL? (ARRAY-SIZE SELF) 0)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.FloatVector", "emptyP", new java.lang.Class [] {})), null);
          Stella.defineMethodObject("(DEFMETHOD (NON-EMPTY? BOOLEAN) ((SELF FLOAT-VECTOR)) :DOCUMENTATION \"Return TRUE if 'self' has length > 0.\" :GLOBALLY-INLINE? TRUE (RETURN (> (ARRAY-SIZE SELF) 0)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.FloatVector", "nonEmptyP", new java.lang.Class [] {})), null);
          Stella.defineMethodObject("(DEFMETHOD (NTH FLOAT) ((SELF FLOAT-VECTOR) (POSITION INTEGER)) :GLOBALLY-INLINE? TRUE (RETURN (SAFE-CAST (NTH (THE-ARRAY SELF) POSITION) FLOAT-WRAPPER)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.FloatVector", "nth", new java.lang.Class [] {java.lang.Integer.TYPE})), null);
          Stella.defineMethodObject("(DEFMETHOD (NTH-SETTER FLOAT) ((SELF FLOAT-VECTOR) (VALUE FLOAT) (POSITION INTEGER)) :GLOBALLY-INLINE? TRUE (RETURN (SETF (WRAPPER-VALUE (SAFE-CAST (NTH (THE-ARRAY SELF) POSITION) FLOAT-WRAPPER)) VALUE)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.FloatVector", "nthSetter", new java.lang.Class [] {java.lang.Double.TYPE, java.lang.Integer.TYPE})), null);
          Stella.defineMethodObject("(DEFMETHOD (LENGTH INTEGER) ((SELF FLOAT-VECTOR)) :GLOBALLY-INLINE? TRUE (RETURN (ARRAY-SIZE SELF)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.FloatVector", "length", new java.lang.Class [] {})), null);
          Stella.defineMethodObject("(DEFMETHOD (MEMBER? BOOLEAN) ((SELF FLOAT-VECTOR) (OBJECT FLOAT)))", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.FloatVector", "memberP", new java.lang.Class [] {java.lang.Double.TYPE})), null);
          ...
          Stella.defineMethodObject("(DEFMETHOD FILL-ARRAY ((SELF 2_D_FLOAT-ARRAY) |&REST| (VALUES FLOAT)) :DOCUMENTATION \"Fill the two-dimensional array `self' in row-major-order\nfrom `values'.  Missing values will retain their old values, extraneous values\nwill be ignored.\" :PUBLIC? TRUE)", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.two_D_floatArray", "fillArray", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Cons")})), null);
          Stella.defineMethodObject("(DEFMETHOD PRINT-ARRAY ((SELF 2_D_FLOAT-ARRAY) (STREAM NATIVE-OUTPUT-STREAM)) :DOCUMENTATION \"Print the array `self' to `stream'.\")", MethodCodeWrapper.wrapMethodCode(Native.find_java_method("edu.isi.powerloom.logic.two_D_floatArray", "printArray", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.javalib.NativeOutputStream")})), null);
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFGLOBAL *NEURAL-NETWORK-TRAINING-METHOD* KEYWORD :BACKPROP)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *LEARNING-RATE* FLOAT 0.1)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *MOMENTUM-TERM* FLOAT 0.9)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *WEIGHT-RANGE* FLOAT 0.05)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *ERROR-CUTOFF* FLOAT 0.0)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *ERROR-PRINT-CYCLE* INTEGER 25)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *SAVE-NETWORK-CYCLE* INTEGER 10000)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *SAVE-NETWORK-FILE* STRING NULL)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *TRACE-NEURAL-NETWORK-TRAINING* BOOLEAN FALSE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *TRAIN-CACHED-NETWORKS?* BOOLEAN TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *MAX-MOVEMENT* FLOAT 1.75)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *MODE-SWITCH* FLOAT 0.0)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *SHRINK-FACTOR* FLOAT (/ *MAX-MOVEMENT* (+ 1.0 *MAX-MOVEMENT*)))", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *WEIGHT-DECAY* FLOAT -1.0e-4)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *SIGMOID-PRIME-OFFSET* FLOAT 0.1)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *MASTER-NEURAL-NETWORK-LIST* (LIST OF PROPOSITION-NEURAL-NETWORK) (NEW LIST))", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *ACTIVATED-NETWORKS* (LIST OF PROPOSITION-NEURAL-NETWORK) (NEW LIST))", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *SAVED-NET* PROPOSITION-NEURAL-NETWORK NULL)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *PARTIAL-SUPPORT-CACHE* (LIST OF INTEGER-WRAPPER) (NEW LIST))", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *LEARNING-CURVE* (VECTOR OF FLOAT-WRAPPER) NULL)", null);
        }
