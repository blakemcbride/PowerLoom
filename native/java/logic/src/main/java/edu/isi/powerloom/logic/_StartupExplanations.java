    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(9)) {
          ...
          Stella.defineGlobalVariableObject("(DEFSPECIAL *EXPLANATION-FORMAT* KEYWORD :ASCII :DOCUMENTATION \"Keyword to control the explanation format.\nValid values are :ASCII, :HTML and :XML\")", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *EXPLANATION-STYLE* KEYWORD :BRIEF :DOCUMENTATION \"Keywords that controls how detailed explanations will be.\nValid values are :VERBOSE and :BRIEF.\" :PUBLIC? TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *EXPLANATION-AUDIENCE* KEYWORD :TECHNICAL :DOCUMENTATION \"Keywords that controls the language for justifications.\nValid values are :TECHNICAL and :LAY\" :PUBLIC? TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *DEFAULT-EXPLANATION-DEPTH* INTEGER 3 :DOCUMENTATION \"Maximal explanation depth used if not otherwise specified.\" :PUBLIC? TRUE)", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *EXPLANATION-TAB-STRING* STRING \"    \")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *MAX-INLINE-LABEL-LENGTH* INTEGER 10 :DOCUMENTATION \"Maximum length of a label string for which the following\nproposition will be printed on the same line.\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *EXPLANATION-ASSERTION-MARKER* STRING \"!\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *EXPLANATION-FAILURE-MARKER* STRING \"?\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *EXPLANATION-CUTOFF-MARKER* STRING \"x\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *EXPLANATION-INFERENCE-MARKER* STRING \" \")", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *EXPLANATION-VOCABULARY* EXPLANATION-VOCABULARY NULL :DOCUMENTATION \"The currently active vocabulary lookup table\")", null);
          Stella.defineGlobalVariableObject("(DEFGLOBAL *EXPLANATION-VOCABULARIES* (KEY-VALUE-LIST OF KEYWORD EXPLANATION-VOCABULARY) (NEW KEY-VALUE-LIST) :DOCUMENTATION \"List of vocabularies with keyword keys\")", null);
          ...
          Stella.defineGlobalVariableObject("(DEFSPECIAL *CURRENTJUSTIFICATION* JUSTIFICATION NULL)", null);
          Stella.defineGlobalVariableObject("(DEFSPECIAL *MOST-RECENT-EXPLANATION-MAPPING* EXPLANATION-MAPPING NULL)", null);
        }
