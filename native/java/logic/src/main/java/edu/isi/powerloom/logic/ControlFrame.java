...
;
  ...
  public static Keyword tryScanCollectionProof(ControlFrame frame) {
    { Proposition proposition = frame.proposition;
      ...
      AssertedCollectionMembersIterator iterator = ((AssertedCollectionMembersIterator)(((Iterator)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_STELLA_ITERATOR, null)))));

      if (iterator == null) {
        { Description collection = Proposition.extractCollectionArgument(proposition);

          iterator = Logic.allAssertedCollectionMembers(collection, Description.inferableP(collection));
        ...
        if (PatternVariable.bindVariableToValueP(((PatternVariable)(memberarg)), Logic.valueOf(iterator.value), true)) {
          if (((Boolean)(Logic.$RECORD_JUSTIFICATIONSp$.get())).booleanValue()) {
            { Proposition matchingprop = iterator.proposition;
              ForwardJustification forwardjust = Proposition.getOneSupportedForwardJustification(matchingprop);
              Justification implicitjust = Proposition.createImplicitInferenceJustification(proposition, matchingprop);

              if (forwardjust != null) {
                frame.justifications.push(forwardjust);
              }
              if (implicitjust != null) {
  ...
  public static Keyword tryIsaPropositionProof(ControlFrame frame) {
    { Proposition proposition = frame.proposition;
      ...
      boolean scanisapropositionsP = (((Boolean)(Logic.$GENERATE_ALL_PROOFSp$.get())).booleanValue() ||
          ...
          (!(surrogate == Logic.SGT_STELLA_THING));
  ...
  public static boolean hasMoreAntecedentsP(ControlFrame frame) {
    { Keyword strategy = frame.currentStrategy;
      Iterator iterator = ((Iterator)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_STELLA_ITERATOR, null)));

      return ((iterator != null) &&
          (((strategy == Logic.KWD_ANTECEDENTS) ||
          (strategy == Logic.KWD_FULL_SUBQUERY)) &&
           (Stella_Object.isaP(iterator, Logic.SGT_STELLA_CONS_ITERATOR) &&
            (!iterator.emptyP()))));
    }
  }
  ...
  public static boolean hasDisjointnessDisproofP(ControlFrame frame) {
    { Proposition proposition = frame.proposition;
      boolean hasdisproofP = false;

      if (proposition.kind == Logic.KWD_ISA) {
        if (!((Boolean)(Logic.$REVERSEPOLARITYp$.get())).booleanValue()) {
          hasdisproofP = Logic.successResultP(ControlFrame.tryIsaPropositionProof(frame));
        }
        else {
      ...
      { Object old$ReversepolarityP$000 = Logic.$REVERSEPOLARITYp$.get();
        ...
        try {
          ...
          if (((((QueryIterator)(Logic.$QUERYITERATOR$.get())) != null) &&
            ...
            hasdisproofP = ControlFrame.hasDisjointnessDisproofP(frame);
          }
          if (!hasdisproofP) {
            hasdisproofP = Logic.successResultP(ControlFrame.tryScanPropositionsProof(frame));
          }
          if ((!hasdisproofP) &&
              (((Boolean)(Logic.$REVERSEPOLARITYp$.get())).booleanValue() &&
               ((proposition.kind == Logic.KWD_FUNCTION) ||
                Proposition.singleValuedPredicateP(proposition)))) {
            hasdisproofP = Logic.successResultP(ControlFrame.tryScanForValueClashProof(frame));
          }
          frame.reversePolarityP = !frame.reversePolarityP;
          if (hasdisproofP &&
              (frame.reversePolarityP &&
               (!(frame.up.state == Logic.KWD_NOT)))) {
            frame.truthValue = TruthValue.invertTruthValue(frame.truthValue);
  ...
  public static Keyword tryScanPropositionsProof(ControlFrame frame) {
    { Proposition proposition = frame.proposition;
      ...
      if (iterator == null) {
        iterator = ControlFrame.tsppDinitializeStrategy(frame);
        singlevaluedP = ControlFrame.tsppDsingleValuedStrategyP(frame);
        ControlFrame.tsppDspawnDerivedStrategies(frame, Logic.KWD_INITIALIZE);
      }
      if (iterator != null) {
        loop000 : while (iterator.nextP()) {
          if (Proposition.relationAndArgumentsUnifyP(((Proposition)(iterator.value)), proposition, true)) {
            if (singlevaluedP) {
      ...
      if (result == Logic.KWD_FAILURE) {
        ControlFrame.tsppDspawnDerivedStrategies(frame, Logic.KWD_FAILURE);
      }
      else if (!(result == Logic.KWD_FAILURE)) {
        frame.truthValue = Logic.propositionsIteratorTruthValue(iterator);
        if ((frame.truthValue == Logic.DEFAULT_TRUE_TRUTH_VALUE) ||
            (frame.truthValue == Logic.DEFAULT_FALSE_TRUTH_VALUE)) {
          ControlFrame.tsppDhandleDefaultResult(frame);
        }
        if (((Boolean)(Logic.$RECORD_JUSTIFICATIONSp$.get())).booleanValue()) {
          ControlFrame.tsppDrecordResultJustification(frame);
        }
        ControlFrame.tsppDpropagateResultTruthValue(frame);
      }
      return (result);
    }
  }

  public static void tsppDpropagateResultTruthValue(ControlFrame frame) {
    { Iterator iterator = ((Iterator)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_STELLA_ITERATOR, null)));
      TruthValue truthvalue = frame.truthValue;
  ...
  public static void tsppDrecordResultJustification(ControlFrame frame) {
    if (((Boolean)(Logic.$RECORD_JUSTIFICATIONSp$.get())).booleanValue()) {
      { Proposition proposition = frame.proposition;
        Iterator iterator = ((Iterator)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_STELLA_ITERATOR, null)));
        Proposition matchingprop = ((Proposition)(iterator.value));
  ...
  public static void tsppDhandleDefaultResult(ControlFrame frame) {
    if ((frame.truthValue == Logic.DEFAULT_TRUE_TRUTH_VALUE) ||
        (frame.truthValue == Logic.DEFAULT_FALSE_TRUTH_VALUE)) {
      { Proposition proposition = frame.proposition;
        Iterator iterator = ((Iterator)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_STELLA_ITERATOR, null)));
        ...
        { Object old$DontusedefaultknowledgeP$000 = Logic.$DONTUSEDEFAULTKNOWLEDGEp$.get();
          ...
          try {
            ...
            if (iterator.nextP()) {
              ...
              ((Iterator)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_STELLA_ITERATOR, null))).value = matchingprop;
            }
  ...
  public static boolean tsppDsingleValuedStrategyP(ControlFrame frame) {
    { Proposition proposition = frame.proposition;

      return ((Proposition.allArgumentsBoundP(proposition) ||
  ...
  public static void tsppDspawnDerivedStrategies(ControlFrame frame, Keyword state) {
    { Proposition proposition = frame.proposition;

      if ((state == Logic.KWD_INITIALIZE) &&
          (((((QueryIterator)(Logic.$QUERYITERATOR$.get())) != null) &&
          (((QueryIterator)(Logic.$QUERYITERATOR$.get())).partialMatchStrategy != null)) &&
  ...
  public static Iterator tsppDinitializeStrategy(ControlFrame frame) {
    { Proposition proposition = frame.proposition;
      Iterator iterator = ((Iterator)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_STELLA_ITERATOR, null)));
...
;
      ...
      loop000 : for (;;) {
        ...
        if ((result == Logic.KWD_CONTINUING_SUCCESS) ||
          ...
          if (((((QueryIterator)(Logic.$QUERYITERATOR$.get())) != null) &&
              ...
              (frame.partialMatchFrame.matchScore != Stella.NULL_FLOAT)))) {
            frame.partialMatchFrame.setFramePartialTruth(Logic.TRUE_TRUTH_VALUE, Stella.NULL_FLOAT, false);
          }
          if (((Boolean)(Logic.$RECORD_JUSTIFICATIONSp$.get())).booleanValue() &&
              (((Justification)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_LOGIC_JUSTIFICATION, null))) == null)) {
          ...
          if ((((QueryIterator)(Logic.$QUERYITERATOR$.get())) != null) &&
              (((QueryIterator)(Logic.$QUERYITERATOR$.get())).partialMatchStrategy != null)) {
            {
              if (!((frame.partialMatchFrame != null) &&
                  (frame.partialMatchFrame.matchScore != Stella.NULL_FLOAT))) {
                frame.partialMatchFrame.setFramePartialTruth(frame.truthValue, ((frame.truthValue != null) ? Stella.NULL_FLOAT : 0.0), frame.truthValue != null);
              }
              if (((Boolean)(Logic.$RECORD_JUSTIFICATIONSp$.get())).booleanValue() &&
                  ((((Justification)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_LOGIC_JUSTIFICATION, null))) == null) &&
    ...
    if (frame.state == Logic.KWD_ATOMIC_GOAL) {
      ...
      { Stella_Object binding = null;
        ...
        for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
          ...
          if (binding != null) {
            { Surrogate testValue000 = Stella_Object.safePrimaryType(binding);
              ...
              if (Surrogate.subtypeOfP(testValue000, Logic.SGT_LOGIC_DESCRIPTION)) {
                ...
                { Proposition binding000 = ((Proposition)(binding));
      ...
      if (((clockticks - frame.startingClockTicks) >= Logic.$CACHE_GOAL_QUANTUM$) ||
        ...
        { Keyword testValue001 = frame.proposition.kind;

          if ((testValue001 == Logic.KWD_ISA) ||
              ((testValue001 == Logic.KWD_PREDICATE) ||
               (testValue001 == Logic.KWD_FUNCTION))) {
  ...
  public static Keyword matchScoreSpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
      Stella_Object argpropvalue = Logic.argumentBoundTo((proposition.arguments.theArray)[0]);
      Stella_Object argscore = (proposition.arguments.theArray)[1];
      ScoredQueryProofAdjunct adjunct = ((ScoredQueryProofAdjunct)(((ProofAdjunct)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_LOGIC_PROOF_ADJUNCT, null)))));
      ...
      if (lastmove == Logic.KWD_DOWN) {
        if (adjunct == null) {
          ...
          { ScoredQueryProofAdjunct self001 = ScoredQueryProofAdjunct.newScoredQueryProofAdjunct();
        ...
        if (frame.down.partialMatchFrame == null) {
          frame.down.partialMatchFrame = ChameleonPartialMatch.newChameleonPartialMatch(null, frame.down);
        }
        adjunct.partialMatchStrategy = ((QueryIterator)(Logic.$QUERYITERATOR$.get())).partialMatchStrategy;
        ((QueryIterator)(Logic.$QUERYITERATOR$.get())).partialMatchStrategy = frame.down.partialMatchFrame;
        return (Logic.KWD_MOVE_DOWN);
      }
      else if (lastmove == Logic.KWD_UP_TRUE) {
        ((QueryIterator)(Logic.$QUERYITERATOR$.get())).partialMatchStrategy = adjunct.partialMatchStrategy;
        { double score = frame.result.partialMatchFrame.matchScore;

          if (Logic.bindArgumentToValueP(argscore, FloatWrapper.wrapFloat(score), true)) {
            ControlFrame.propagateFrameTruthValue(frame.result, frame);
            if ((((QueryIterator)(Logic.$QUERYITERATOR$.get())) != null) &&
                (((QueryIterator)(Logic.$QUERYITERATOR$.get())).partialMatchStrategy != null)) {
              frame.result.partialMatchFrame.propagateFramePartialTruth(frame);
            ...
            if (((Boolean)(Logic.$RECORD_JUSTIFICATIONSp$.get())).booleanValue()) {
              { Justification self003 = Justification.newJustification();
                ...
                self003.inferenceRule = Logic.KWD_MATCH_SCORE;
                self003.antecedents = Cons.cons(((Justification)(KeyValueList.dynamicSlotValue(frame.result.dynamicSlots, Logic.SYM_LOGIC_JUSTIFICATION, null))), Stella.NIL);
            ...
            return (ControlFrame.matchScoreSpecialist(frame, Logic.KWD_UP_FAIL));
          }
        }
      }
      else if (lastmove == Logic.KWD_UP_FAIL) {
        ...
        if ((((QueryIterator)(Logic.$QUERYITERATOR$.get())) != null) &&
            (((QueryIterator)(Logic.$QUERYITERATOR$.get())).partialMatchStrategy != null)) {
          frame.partialMatchFrame.setFramePartialTruth(Logic.UNKNOWN_TRUTH_VALUE, Stella.NULL_FLOAT, true);
        }
        if (((Boolean)(Logic.$RECORD_JUSTIFICATIONSp$.get())).booleanValue()) {
          ControlFrame.recordPrimitiveJustification(frame, Logic.KWD_UP_FAIL);
        }
  ...
  public static Keyword scoredQuerySpecialist(ControlFrame frame, Keyword lastmove) {
    { Proposition proposition = frame.proposition;
      Stella_Object argpropvalue = Logic.argumentBoundTo((proposition.arguments.theArray)[0]);
      Stella_Object argscorevalue = Logic.argumentBoundTo((proposition.arguments.theArray)[1]);
      ScoredQueryProofAdjunct adjunct = ((ScoredQueryProofAdjunct)(((ProofAdjunct)(KeyValueList.dynamicSlotValue(frame.dynamicSlots, Logic.SYM_LOGIC_PROOF_ADJUNCT, null)))));
      ...
      if (lastmove == Logic.KWD_DOWN) {
        ...
        if ((argscorevalue == null) ||
            (!Stella_Object.isaP(argscorevalue, Logic.SGT_STELLA_NUMBER_WRAPPER))) {
          return (ControlFrame.scoredQuerySpecialist(frame, Logic.KWD_UP_FAIL));
        }
        ((QueryIterator)(Logic.$QUERYITERATOR$.get())).partialMatchStrategy = adjunct.partialMatchStrategy;
        ControlFrame.propagateFrameTruthValue(frame.result, frame);
        if ((((QueryIterator)(Logic.$QUERYITERATOR$.get())) != null) &&
            (((QueryIterator)(Logic.$QUERYITERATOR$.get())).partialMatchStrategy != null)) {
          frame.partialMatchFrame.setFramePartialTruth(frame.result.truthValue, Stella_Object.coerceToFloat(argscorevalue), true);
        }
        if (((Boolean)(Logic.$RECORD_JUSTIFICATIONSp$.get())).booleanValue()) {
          { Justification self002 = Justification.newJustification();

            self002.inferenceRule = Logic.KWD_SCORED_QUERY;
    ...
    { Proposition proposition = frame.proposition;
      ...
      if (!(result == Logic.KWD_FAILURE)) {
        { PartialMatchFrame pmf = frame.partialMatchFrame;
          ...
          pmf.setFramePartialTruth(Logic.UNKNOWN_TRUTH_VALUE, score, true);
        }
      }
      return (result);
    }
  ...
  public boolean definedFramePartialTruthP() {
    { ControlFrame self = this;
      ...
      return ((self.partialMatchFrame != null) &&
          (self.partialMatchFrame.matchScore != Stella.NULL_FLOAT));
    }
  }
        ...
        { Proposition goal = ControlFrame.extractSubgoalOfFrame(frame);
          ...
          { Justification self001 = Justification.newJustification();
            ...
            { PrimitiveStrategy self002 = PrimitiveStrategy.newPrimitiveStrategy();
              ...
              self002.matchScore = ((TruthValue)(Stella_Object.accessInContext(rule.truthValue, rule.homeContext, false))).matchScore;
      ...
      { Keyword strategy = ((lastmove == Logic.KWD_UP_FAIL) ? Logic.KWD_FAILURE : frame.currentStrategy);
        ...
        if ((frame.justifications != null) &&
            ((!frame.justifications.emptyP()) &&
             Stella_Object.isaP(frame.justifications.first(), Logic.SGT_LOGIC_JUSTIFICATION))) {
          ...
          if (((Justification)(KeyValueList.dynamicSlotValue(frame.result.dynamicSlots, Logic.SYM_LOGIC_JUSTIFICATION, null))) != null) {
            { PrimitiveStrategy self000 = PrimitiveStrategy.newPrimitiveStrategy();
              ...
              Proposition.hasSupportedForwardJustificationsP(frame.result.proposition)) {
            justification = Proposition.getOneSupportedForwardJustification(frame.result.proposition);
          }
        }
        else if ((frame.proposition != null) &&
            Proposition.hasSupportedForwardJustificationsP(frame.proposition)) {
          Stella.STANDARD_OUTPUT.nativeStream.println("RECORD-PRIMITIVE-JUSTIFICATION:  Test to see if clause needed.");
          justification = Proposition.getOneSupportedForwardJustification(frame.proposition);
        }
        else {
        }
        if (justification == null) {
