...
;
  ...
  public static Cons getSupportingEquivalencePropositions(Skolem x, Stella_Object y) {
    y = y;
    { Cons equivterms = Cons.cons(x, Logic.getAllEquivalentValues(x));
      Cons equivprops = Stella.NIL;
      Cons explicitequivprops = Stella.NIL;
      ...
      { Stella_Object term = null;
        ...
        for (;!(iter000 == Stella.NIL); iter000 = iter000.rest) {
          ...
          { Proposition prop = null;
            Iterator iter001 = Logic.unfilteredDependentPropositions(term, Logic.SGT_PL_KERNEL_KB_EQUIVALENT).allocateIterator();
            ...
            while (iter001.nextP()) {
              ...
              if ((prop.operator == Logic.SGT_PL_KERNEL_KB_EQUIVALENT) &&
                ...
                { Vector args = prop.arguments;
                  Stella_Object arg1 = (args.theArray)[0];
                  Stella_Object arg2 = (args.theArray)[1];

                  if ((Stella_Object.eqlP(arg1, term) &&
                      equivterms.memberP(arg2)) ||
                      (Stella_Object.eqlP(arg2, term) &&
                       equivterms.memberP(arg1))) {
                    equivprops = Cons.cons(prop, equivprops);
                  }
                }
              }
            }
      ...
      { Stella_Object prop = null;
        ...
        loop002 : for (;!(iter002 == Stella.NIL); iter002 = iter002.rest) {
          prop = iter002.value;
          if (Proposition.hasSupportedForwardJustificationsP(((Proposition)(prop)))) {
            explicitequivprops = Cons.cons(prop, explicitequivprops);
            continue loop002;
          }
          { Object old$Context$000 = Stella.$CONTEXT$.get();
            ...
            try {
              Native.setSpecial(Stella.$CONTEXT$, worldstate);
              Native.setSpecial(Stella.$MODULE$, ((Context)(Stella.$CONTEXT$.get())).baseModule);
              if ((!((Proposition)(prop)).deletedP()) &&
                  ((((Boolean)(Logic.$REVERSEPOLARITYp$.get())).booleanValue() ? Proposition.falseP(((Proposition)(prop))) : (Proposition.trueP(((Proposition)(prop))) ||
                  Proposition.functionWithDefinedValueP(((Proposition)(prop))))))) {
                explicitequivprops = Cons.cons(prop, explicitequivprops);
                continue loop002;
              }
      ...
      if (!(explicitequivprops == Stella.NIL)) {
        equivprops = explicitequivprops;
      }
      return (Logic.findEquivalencePropositionPath(equivprops, x, y));
    }
  }
...
;
  ...
  public static void bindSkolemToValue(Skolem fromskolem, Stella_Object tovalue, boolean toplevelupdateP) {
    Skolem.verifySkolemAndValueTypes(fromskolem, tovalue);
    ...
    { Surrogate testValue000 = Stella_Object.safePrimaryType(tovalue);
      ...
      if (Surrogate.subtypeOfP(testValue000, Logic.SGT_LOGIC_SKOLEM)) {
        { Skolem tovalue000 = ((Skolem)(tovalue));
          ...
          if (Logic.skolemWithVariableValueCycleP(tovalue000)) {
          ...
          Skolem.synchronizeVariableValueInferenceCaches(fromskolem, tovalue000);
  ...
  public static void synchronizeVariableValueInferenceCaches(Skolem fromskolem, Skolem tovalue) {
    if (Logic.justInTimeInferenceCacheP(((Context)(Stella.$CONTEXT$.get())))) {
      { Object old$Context$000 = Stella.$CONTEXT$.get();
        Object old$Module$000 = Stella.$MODULE$.get();

        try {
          Native.setSpecial(Stella.$CONTEXT$, Logic.getInferenceCache(Logic.getWorldState(((Context)(Stella.$CONTEXT$.get()))), Logic.KWD_META));
          Native.setSpecial(Stella.$MODULE$, ((Context)(Stella.$CONTEXT$.get())).baseModule);
          { Skolem object000 = fromskolem;
            Stella_Object value000 = tovalue;
            Stella_Object oldValue000 = object000.variableValue;
          ...
          if (!(tovalue.variableValueInverse().membP(fromskolem))) {
            { Skolem object001 = tovalue;
              Cons value001 = Cons.cons(fromskolem, tovalue.variableValueInverse());
              Stella_Object oldValue001 = object001.variableValueInverse;
              Stella_Object newValue001 = Stella_Object.updateInContext(oldValue001, value001, object001.homeContext, false);
    ...
    else if (Logic.metaInferenceCacheP(((Context)(Stella.$CONTEXT$.get())))) {
      { Object old$Context$001 = Stella.$CONTEXT$.get();
        Object old$Module$001 = Stella.$MODULE$.get();

        try {
          Native.setSpecial(Stella.$CONTEXT$, Logic.getInferenceCache(Logic.getWorldState(((Context)(Stella.$CONTEXT$.get()))), Logic.KWD_JUST_IN_TIME));
          Native.setSpecial(Stella.$MODULE$, ((Context)(Stella.$CONTEXT$.get())).baseModule);
          { Skolem object002 = fromskolem;
            Stella_Object value002 = tovalue;
          ...
          { Cons inverses = ((Cons)(Stella_Object.accessInContext(tovalue.variableValueInverse, tovalue.homeContext, true)));
            ...
            if (!(inverses.membP(fromskolem))) {
              { Skolem object003 = tovalue;
                Cons value003 = Cons.cons(fromskolem, inverses);
                Stella_Object oldValue004 = object003.variableValueInverse;
  ...
  public static void verifySkolemAndValueTypes(Skolem fromskolem, Stella_Object tovalue) {
