...
;; ACL 5.0, for example, doesn't allow :wild as a version value:
...
;; for now make them synonyms, but they have to become separate:
(setf (logical-pathname-translations "ST") (copy-tree (logical-pathname-translations "PL")))
